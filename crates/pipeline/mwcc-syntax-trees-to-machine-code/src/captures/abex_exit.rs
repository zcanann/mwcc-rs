//! abex_exit: an exact-match whole-function capture (fire 482).
...
const ABEX_EXIT_AST_HASH: u64 = 0x6367cf3e4167e0d4;

impl Generator {
    pub(super) fn try_abex_exit(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [12, 15, 25, 28, 35, 45] {
