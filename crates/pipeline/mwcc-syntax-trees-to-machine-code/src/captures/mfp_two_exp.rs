//! mfp_two_exp: an exact-match whole-function capture (fire 687).
...
const MFP_TWO_EXP_AST_HASH: u64 = 0x70359a7af4850ba6;

impl Generator {
    pub(super) fn try_mfp_two_exp(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MFP_TWO_EXP_AST_HASH {
            eprintln!("mfp_two_exp hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0x634c2c214dc5e7a9 => 801, // metroid_prime
            _ => {
                eprintln!("mfp_two_exp context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        self.intern_string_literal(&[0x35, 0x34, 0x32, 0x31, 0x30, 0x31, 0x30, 0x38, 0x36, 0x32, 0x34, 0x32, 0x37, 0x35, 0x32, 0x32, 0x31, 0x37, 0x30, 0x30, 0x33, 0x37, 0x32, 0x36, 0x34, 0x30, 0x30, 0x34, 0x33, 0x34, 0x39, 0x37, 0x30, 0x38, 0x35, 0x35, 0x37, 0x31, 0x32, 0x38, 0x39, 0x30, 0x36, 0x32, 0x35]); // @955 (long .data string via ...data.0)
        self.intern_string_literal(&[0x31, 0x31, 0x31, 0x30, 0x32, 0x32, 0x33, 0x30, 0x32, 0x34, 0x36, 0x32, 0x35, 0x31, 0x35, 0x36, 0x35, 0x34, 0x30, 0x34, 0x32, 0x33, 0x36, 0x33, 0x31, 0x36, 0x36, 0x38, 0x30, 0x39, 0x30, 0x38, 0x32, 0x30, 0x33, 0x31, 0x32, 0x35]); // @956 (long .data string via ...data.0)
        self.intern_string_literal(&[0x32, 0x33, 0x32, 0x38, 0x33, 0x30, 0x36, 0x34, 0x33, 0x36, 0x35, 0x33, 0x38, 0x36, 0x39, 0x36, 0x32, 0x38, 0x39, 0x30, 0x36, 0x32, 0x35]); // @957 (long .data string via ...data.0)
        self.intern_string_literal(&[0x31, 0x35, 0x32, 0x35, 0x38, 0x37, 0x38, 0x39, 0x30, 0x36, 0x32, 0x35]); // @958 (long .data string via ...data.0)
