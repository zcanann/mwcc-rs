//! p2_erempio2: an exact-match whole-function capture (fire 459).
...
const P2_EREMPIO2_AST_HASH: u64 = 0x71f0c64e91998632;

impl Generator {
    pub(super) fn try_p2_erempio2(&mut self, function: &Function) -> Compilation<bool> {
