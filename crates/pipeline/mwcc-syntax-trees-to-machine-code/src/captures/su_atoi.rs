//! su_atoi: an exact-match whole-function capture (fire 461).
...
const SU_ATOI_AST_HASH: u64 = 0x6e2a82fd2b0f54bc;

impl Generator {
    pub(super) fn try_su_atoi(&mut self, function: &Function) -> Compilation<bool> {
