//! str_strcat: an exact-match whole-function capture (fire 469).
...
const STR_STRCAT_AST_HASH: u64 = 0x4af2ef9f863b8f0;

impl Generator {
    pub(super) fn try_str_strcat(&mut self, function: &Function) -> Compilation<bool> {
