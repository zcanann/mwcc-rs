    ...
    pub fn encode(&self) -> u32 {
        match *self {
            ...
            Instruction::SubtractFromZeroExtended { d, a } => {
                (31 << 26) | ((d as u32) << 21) | ((a as u32) << 16) | (200 << 1)
            }
            ...
            Instruction::AddToZeroExtended { d, a } => {
                (31 << 26) | ((d as u32) << 21) | ((a as u32) << 16) | (202 << 1)
            }
            ...
            Instruction::RotateAndMaskVariable {
                a,
                s,
                b,
                begin,
            ...
            Instruction::FloatNegativeMultiplySubtractSingle { d, a, c, b } => {
                a_form(59, d, a, b, c, 30)
            }
            Instruction::FloatNegativeMultiplyAddSingle { d, a, c, b } => {
                a_form(59, d, a, b, c, 31)
            }
            ...
            Instruction::FloatNegativeMultiplySubtractDouble { d, a, c, b } => {
                a_form(63, d, a, b, c, 30)
            }
            Instruction::RoundToSingle { d, b } => {
                (63 << 26) | ((d as u32) << 21) | ((b as u32) << 11) | (12 << 1)
            }
            Instruction::FloatMove { d, b } => {
                (63 << 26) | ((d as u32) << 21) | ((b as u32) << 11) | (72 << 1)
            }
            // frsqrte: opcode 63, A-form xo 26 (fc 40 08 34 = frsqrte f2,f1)
            Instruction::FloatReciprocalSqrtEstimate { d, b } => {
                (63 << 26) | ((d as u32) << 21) | ((b as u32) << 11) | (26 << 1)
            }
            Instruction::FloatNegate { d, b } => {
                (63 << 26) | ((d as u32) << 21) | ((b as u32) << 11) | (40 << 1)
            }
            Instruction::FloatAbsolute { d, b } => {
                (63 << 26) | ((d as u32) << 21) | ((b as u32) << 11) | (264 << 1)
            }
            Instruction::ConvertToIntegerWordZero { d, b } => {
                (63 << 26) | ((d as u32) << 21) | ((b as u32) << 11) | (15 << 1)
            }
            ...
            Instruction::LoadFloatDoubleWithUpdate { d, a, offset } => {
                d_form(51, d, a, offset as u16)
            }
            Instruction::LoadFloatSingleWithUpdate { d, a, offset } => {
                d_form(49, d, a, offset as u16)
            }
            Instruction::StoreFloatSingleWithUpdate { s, a, offset } => {
                d_form(53, s, a, offset as u16)
            }
            Instruction::StoreFloatDoubleWithUpdate { s, a, offset } => {
                d_form(55, s, a, offset as u16)
            }
            ...
            Instruction::FloatCompareOrdered { a, b } => {
                (63 << 26) | ((a as u32) << 16) | ((b as u32) << 11) | (32 << 1)
            }
            Instruction::FloatCompareUnordered { a, b } => {
                (63 << 26) | ((a as u32) << 16) | ((b as u32) << 11)
            }
            Instruction::FloatCompareUnorderedField { crf, a, b } => {
                (63 << 26) | ((crf as u32) << 23) | ((a as u32) << 16) | ((b as u32) << 11)
            }
            Instruction::MoveFromConditionRegister { d } => {
                (31 << 26) | ((d as u32) << 21) | (19 << 1)
            }
            ...
            Instruction::ConditionRegisterClear { d } => {
                0x4C00_0182 | ((d as u32) << 21) | ((d as u32) << 16) | ((d as u32) << 11)
            }
            Instruction::CompareWordImmediate { a, immediate } => {
                (11 << 26) | ((a as u32) << 16) | (immediate as u16 as u32)
            }
            Instruction::CompareWordImmediateField { crf, a, immediate } => {
                (11 << 26) | ((crf as u32) << 23) | ((a as u32) << 16) | (immediate as u16 as u32)
            }
            Instruction::CompareWordField { crf, a, b } => {
                (31 << 26) | ((crf as u32) << 23) | ((a as u32) << 16) | ((b as u32) << 11)
            }
            Instruction::CompareWord { a, b } => {
                (31 << 26) | ((a as u32) << 16) | ((b as u32) << 11)
            }
            Instruction::CompareLogicalWordImmediate { a, immediate } => {
                (10 << 26) | ((a as u32) << 16) | (immediate as u32)
            }
            Instruction::CompareLogicalWord { a, b } => {
                (31 << 26) | ((a as u32) << 16) | ((b as u32) << 11) | (32 << 1)
            }
