...
impl Generator {
    pub(super) fn try_pfa_double2hex(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            14, 35, 39, 47, 50, 52, 65, 69, 77, 80, 82, 113, 116, 121, 133, 138, 143, 144, 147,
            153, 155, 163, 165, 173, 179, 183, 184,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(7, 100));
        self.output.instructions.push(Instruction::StoreByte {
            s: 9,
            a: 1,
            offset: 48,
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 3, s: 0 });
        self.output.instructions.push(Instruction::StoreByte {
            s: 9,
            a: 1,
            offset: 49,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 112));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 4,
            a: 3,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 80));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 4,
            a: 3,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 5, b: 8 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Xor { a: 0, s: 0, b: 5 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 3,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 7, a: 6, b: 3 });
        self.output
            .instructions
            .push(Instruction::SubtractFromRecord { d: 0, a: 5, b: 0 });
        self.output.instructions.push(Instruction::RotateAndMask {
            a: 0,
            s: 7,
            shift: 28,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(3, 49));
        self.output.instructions.push(Instruction::StoreByte {
            s: 3,
            a: 4,
            offset: -1,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 88));
        self.output
            .instructions
            .push(Instruction::StoreByteWithUpdate {
                s: 0,
