...
impl Generator {
    pub(super) fn try_crt_async(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(3, -12));
        ...
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 0, a: 27, b: 4 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 0, a: 0, b: 4 });
        self.output
            .instructions
            .push(Instruction::SubtractFromRecord { d: 0, a: 0, b: 27 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 24, a: 31, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(30, 23));
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__CARDCompareFileName".to_string(),
        });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate { a: 3, immediate: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, -7));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, -8));
        self.record_relocation(RelocationKind::Rel24, "__CARDPutControlBlock");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__CARDPutControlBlock".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 0, a: 3, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, -9));
        self.record_relocation(RelocationKind::Rel24, "__CARDPutControlBlock");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__CARDPutControlBlock".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(0, 29));
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 31, b: 0 });
        self.output
            .instructions
            .push(Instruction::move_register(4, 26));
        self.output.instructions.push(Instruction::LoadWord {
        ...
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 0, a: 27, b: 0 });
        self.output.instructions.push(Instruction::StoreHalfword {
            s: 0,
            a: 7,
            offset: 56,
        ...
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 4, a: 27, b: 0 });
        self.record_relocation(RelocationKind::Rel24, "__CARDAllocBlock");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__CARDAllocBlock".to_string(),
        });
        self.output
            .instructions
