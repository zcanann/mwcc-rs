...
Latest targeted checkpoint: 2026-07-24 03:04 UTC at compiler commit `63bd1ab1`
...
Post-holdout compiler work through commit `63bd1ab1` has not been run over a
...
relocation-aware parity from 28/109 to 62/109 functions and from 996/15,340 to
4,608/15,340 reference code bytes. Paired movement was +34/-0 functions and
+3,612 exact bytes. The gains were `ftCommon_ClampAirDrift`, `ftCommon_FallBasic`,
...
frame-vector producer windows made `ftCommon_8008021C` exact. This is evidence
