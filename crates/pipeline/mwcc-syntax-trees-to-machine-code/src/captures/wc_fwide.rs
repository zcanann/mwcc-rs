//! wc_fwide: an exact-match whole-function capture (fire 475).
...
const WC_FWIDE_AST_HASH: u64 = 0xb3b4c723e6e2210a;

impl Generator {
    pub(super) fn try_wc_fwide(&mut self, function: &Function) -> Compilation<bool> {
