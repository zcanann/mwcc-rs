...
impl Generator {
    pub(super) fn try_suac_impl_str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                784, 196, 356, 784, 428, 784, 784, 784, 508, 784, 784, 784, 784, 784, 784, 784, 508,
            ],
        ...
        for target in [
            26, 28, 36, 41, 64, 75, 87, 93, 105, 111, 122, 125, 130, 134, 147, 150, 156, 159, 162,
            166, 168, 172, 175, 176, 180, 186, 196, 202, 207, 208,
        ] {
