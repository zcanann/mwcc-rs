//! uc7_init: an exact-match whole-function capture (fire 491).
...
const UC7_INIT_AST_HASH: u64 = 1; // DISARMED fire 491: needs output.static_locals (initialized$N) — see memory

impl Generator {
    pub(super) fn try_uc7_init(&mut self, function: &Function) -> Compilation<bool> {
