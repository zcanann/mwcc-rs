...
impl Generator {
    pub(super) fn try_wcs_wcstoul_i(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                884, 196, 384, 884, 460, 884, 884, 884, 544, 884, 884, 884, 884, 884, 884, 884, 544,
            ],
        ...
        for target in [
            26, 28, 36, 41, 58, 59, 70, 82, 94, 100, 113, 120, 131, 134, 139, 143, 152, 153, 163,
            166, 175, 176, 182, 186, 189, 193, 195, 199, 203, 210, 221, 228, 233, 234,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 3, a: 5, b: 3 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 26, a: 3, b: 29 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 3, a: 3, b: 5 });
        self.output.instructions.push(Instruction::RotateAndMask {
            a: 3,
            s: 3,
            shift: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 27, a: 27, b: 0 });
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
