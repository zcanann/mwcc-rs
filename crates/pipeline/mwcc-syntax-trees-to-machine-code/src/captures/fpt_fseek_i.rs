...
impl Generator {
    pub(super) fn try_fpt_fseek_i(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [15, 19, 35, 45, 48, 52, 57, 66, 72, 77, 78, 81, 93, 100, 105, 118, 122, 144, 149, 150] {
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 7, a: 30, offset: 28 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 30, offset: 52 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 5, immediate: -2 });
        ...
        self.output.instructions.push(Instruction::SubtractFromRecord { d: 0, a: 4, b: 6 });
