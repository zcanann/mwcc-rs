...
impl Generator {
    pub(super) fn try_dvd_convert(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::load_immediate(3, 254));
        self.output.instructions.push(Instruction::BranchToLinkRegister);
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 6, s: 3, clear: 8 });
        ...
        self.output.instructions.push(Instruction::CompareLogicalWord { a: 6, b: 3 });
