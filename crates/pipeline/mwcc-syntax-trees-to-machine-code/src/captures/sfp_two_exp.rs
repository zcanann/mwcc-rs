...
impl Generator {
    pub(super) fn try_sfp_two_exp(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 4, immediate: 40 });
        ...
        self.output.instructions.push(Instruction::load_immediate(5, 0));
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 31, offset: 2 });
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 4, immediate: 128 });
        self.output.instructions.push(Instruction::StoreByte { s: 5, a: 31, offset: 0 });
        ...
        self.output.instructions.push(Instruction::load_immediate(5, 0));
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 31, offset: 2 });
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 4, immediate: 152 });
        self.output.instructions.push(Instruction::StoreByte { s: 5, a: 31, offset: 0 });
