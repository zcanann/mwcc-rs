...
impl Generator {
    pub(super) fn try_als_block_subblock(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadWordIndexed { d: 5, a: 3, b: 0 });
        ...
        self.output.instructions.push(Instruction::move_register(7, 0));
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 5, offset: 0 });
        self.output.instructions.push(Instruction::AndContiguousMask { a: 0, s: 0, begin: 0, end: 28 });
        self.output.instructions.push(Instruction::CompareLogicalWord { a: 7, b: 0 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 7, a: 3, offset: 8 });
        self.output.instructions.push(Instruction::load_immediate(3, 0));
        self.output.instructions.push(Instruction::BranchToLinkRegister);
        ...
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 80 });
        self.emit_branch_conditional_to(12, 0, labels[&86]); // blt
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 5, offset: 4 });
        self.output.instructions.push(Instruction::Add { d: 8, a: 5, b: 4 });
        self.output.instructions.push(Instruction::LoadWord { d: 9, a: 5, offset: 0 });
        self.output.instructions.push(Instruction::AndContiguousMask { a: 0, s: 0, begin: 0, end: 30 });
        self.output.instructions.push(Instruction::OrImmediate { a: 10, s: 0, immediate: 1 });
        self.output.instructions.push(Instruction::RotateAndMask { a: 0, s: 9, shift: 0, begin: 30, end: 30 });
        self.output.instructions.push(Instruction::StoreWord { s: 10, a: 5, offset: 4 });
        self.output.instructions.push(Instruction::CountLeadingZeros { a: 6, s: 0 });
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 7, s: 6, shift: 5 });
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 0, s: 9, shift: 0, begin: 29, end: 29 });
        self.output.instructions.push(Instruction::CountLeadingZeros { a: 6, s: 7 });
        self.output.instructions.push(Instruction::StoreWord { s: 4, a: 5, offset: 0 });
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 6, s: 6, shift: 5 });
        ...
        self.output.instructions.push(Instruction::AndContiguousMask { a: 9, s: 9, begin: 0, end: 28 });
        self.emit_branch_conditional_to(12, 2, labels[&58]); // beq
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 5, offset: 0 });
        self.output.instructions.push(Instruction::OrImmediate { a: 0, s: 0, immediate: 2 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 5, offset: 0 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 10, a: 8, offset: 4 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 4, a: 4, b: 9 });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 6, immediate: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 4, a: 8, offset: 0 });
        ...
        self.output.instructions.push(Instruction::OrImmediate { a: 0, s: 0, immediate: 2 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 8, offset: 0 });
        self.output.instructions.push(Instruction::LoadWordIndexed { d: 0, a: 8, b: 4 });
        self.output.instructions.push(Instruction::OrImmediate { a: 0, s: 0, immediate: 4 });
        self.output.instructions.push(Instruction::StoreWordIndexed { s: 0, a: 8, b: 4 });
        ...
        self.output.instructions.push(Instruction::StoreWordIndexed { s: 4, a: 8, b: 0 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 8, offset: 12 });
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 8, offset: 12 });
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 4, offset: 8 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 3, offset: 12 });
        self.output.instructions.push(Instruction::LoadWord { d: 6, a: 5, offset: 12 });
        self.output.instructions.push(Instruction::AndContiguousMask { a: 4, s: 0, begin: 0, end: 28 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 4, immediate: -4 });
        ...
        self.output.instructions.push(Instruction::OrImmediate { a: 0, s: 4, immediate: 2 });
        self.output.instructions.push(Instruction::AndContiguousMask { a: 4, s: 4, begin: 0, end: 28 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 5, offset: 0 });
        self.output.instructions.push(Instruction::LoadWordIndexed { d: 0, a: 5, b: 4 });
        self.output.instructions.push(Instruction::OrImmediate { a: 0, s: 0, immediate: 4 });
        self.output.instructions.push(Instruction::StoreWordIndexed { s: 0, a: 5, b: 4 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 3, offset: 12 });
        self.output.instructions.push(Instruction::AndContiguousMask { a: 4, s: 0, begin: 0, end: 28 });
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 4, immediate: -4 });
        self.output.instructions.push(Instruction::LoadWordIndexed { d: 0, a: 3, b: 4 });
        self.output.instructions.push(Instruction::CompareLogicalWord { a: 0, b: 5 });
        self.emit_branch_conditional_to(4, 2, labels[&106]); // bne
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 5, offset: 12 });
        self.output.instructions.push(Instruction::StoreWordIndexed { s: 0, a: 3, b: 4 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 5, offset: 8 });
