//! sldexp_str: an exact-match whole-function capture (fire 456).
...
const SLDEXP_STR_AST_HASH: u64 = 0x6ba9265fd05d745b;

impl Generator {
    pub(super) fn try_sldexp_str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        let bump: u32 = match context {
            0x4c0074f426dac8c9 => 35, // strikers: pools @118 (ours @83)
            _ => return Ok(false),
        };
