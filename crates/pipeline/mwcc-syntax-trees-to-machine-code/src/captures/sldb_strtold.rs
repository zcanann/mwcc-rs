...
impl Generator {
    pub(super) fn try_sldb_strtold(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            66, 79, 82, 88, 91, 100, 103, 111, 124, 135, 138, 141, 143, 154, 164, 174, 176, 187,
            197, 205, 209, 216, 218, 225, 227, 235, 245, 253, 257, 260, 269, 279, 283, 284, 291,
            293, 301, 303, 315, 321, 338, 340, 342, 353, 355, 371, 373, 382, 383, 392, 398, 400,
            406, 413, 419, 420, 429, 443, 445, 456, 468, 470, 476, 488, 490, 501, 503, 509, 516,
            525, 537, 540, 546, 549, 569, 580, 582, 598, 600, 613, 614, 625, 639, 648, 654, 666,
            667, 678, 692, 701, 716, 718, 724, 733, 743, 749, 762, 764, 770, 778, 787, 794, 800,
            804, 816, 821, 822, 828, 837, 842, 844, 852, 859, 862, 876, 885, 893, 895, 905, 913,
            945, 954, 961, 963, 964,
        ] {
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "_savegpr_14".to_string(),
        });
        self.record_target(
            RelocationKind::Addr16Ha,
            mwcc_machine_code::RelocationTarget::AnonymousRodataAt(0),
        );
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::move_register(31, 7));
        self.output.instructions.push(Instruction::LoadWord {
            d: 4,
            a: 22,
            offset: 12,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(12, 29));
        self.output.instructions.push(Instruction::LoadWord {
            d: 5,
            a: 22,
            offset: 16,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 1));
        self.output.instructions.push(Instruction::LoadWord {
            d: 10,
            a: 22,
            offset: 28,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(22, 0));
        self.output.instructions.push(Instruction::StoreWord {
            s: 6,
            a: 1,
            offset: 12,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(14, 0));
        self.output.instructions.push(Instruction::StoreWord {
            s: 19,
            a: 1,
            offset: 44,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(18, 0));
        self.output.instructions.push(Instruction::StoreWord {
            s: 4,
            a: 1,
            offset: 56,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(26, 1));
        self.output
            .instructions
            .push(Instruction::BranchToCountRegisterAndLink);
        self.output
            .instructions
            .push(Instruction::move_register(24, 3));
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 15, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 16384));
        self.output
            .instructions
            .push(Instruction::move_register(24, 3));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 8192));
        self.output
            .instructions
            .push(Instruction::move_register(24, 3));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 2));
        self.emit_branch_to(labels[&787]); // b
        self.bind_label(labels[&176]);
        self.record_target(
            RelocationKind::Addr16Ha,
            mwcc_machine_code::RelocationTarget::AnonymousRodataAt(1),
        );
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(16, 1));
        self.output.instructions.push(Instruction::LoadWord {
            d: 4,
            a: 5,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 16, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 25, b: 0 });
        self.output.instructions.push(Instruction::StoreWord {
            s: 0,
            a: 3,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 4096));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 0));
        self.output.instructions.push(Instruction::StoreByte {
            s: 0,
            a: 1,
            offset: 20,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 16, b: 15 });
        self.output
            .instructions
            .push(Instruction::StoreFloatDouble {
                s: 1,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 24, b: 17 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 16));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 1));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 15,
            a: 3,
            immediate: -32768,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 4));
        self.emit_branch_to(labels[&787]); // b
        self.bind_label(labels[&340]);
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 8));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 32));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 64));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 24, a: 3, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 128));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 2048));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 256));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 512));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(15, 1024));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 23, a: 24, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 23,
            a: 23,
            immediate: -48,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(20, 2));
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 2));
        self.output.instructions.push(Instruction::StoreByte {
            s: 0,
            a: 1,
            offset: 25,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 4));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 8));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 16));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 0, b: 20 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 14,
            a: 14,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 16, a: 21, b: 0 });
        self.record_relocation(RelocationKind::Rel24, "toupper");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "toupper".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::Xor { a: 3, s: 0, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromRecord { d: 3, a: 4, b: 3 });
        self.output
            .instructions
            .push(Instruction::ClearLeftImmediate {
                a: 3,
        ...
        self.output
            .instructions
            .push(Instruction::Or { a: 0, s: 16, b: 0 });
        self.output
            .instructions
            .push(Instruction::ClearLeftImmediate {
                a: 5,
        ...
        self.output
            .instructions
            .push(Instruction::Or { a: 0, s: 16, b: 3 });
        self.output
            .instructions
            .push(Instruction::ClearLeftImmediate {
                a: 5,
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 5, a: 21, b: 0 });
        self.output
            .instructions
            .push(Instruction::load_immediate(5, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 32));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 64));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 128));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 256));
        self.emit_branch_to(labels[&787]); // b
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 24, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 3,
            immediate: -48,
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 18, s: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 26, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 26, b: 25 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 3,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 23, a: 23 });
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 0, a: 3, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 0, a: 18 });
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 18, s: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 0, b: 20 });
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 18, b: 5 });
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 18, s: 0 });
        self.load_double_constant(1, 0x0000000000000000);
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 0, b: 19 });
        self.output.instructions.push(Instruction::StoreHalfword {
            s: 4,
            a: 1,
            offset: 24,
