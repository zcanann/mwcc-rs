...
impl Generator {
    pub(super) fn try_bfp_dec2num(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            15, 16, 18, 25, 28, 34, 35, 37, 44, 45, 47, 58, 66, 73, 75, 83, 87, 90, 97, 99, 103,
            111, 113, 145, 173, 174, 179, 198, 207, 213, 241, 242, 247, 261, 263, 265, 280, 291,
            305, 310, 312, 314, 319, 321, 323, 324, 334, 340, 345, 355, 359, 366, 371, 377, 385,
            388, 396, 398, 403, 413, 419, 425, 429, 433, 441, 446, 448, 450, 455, 460, 476, 478,
            483, 493, 499, 505, 509, 513, 521, 526, 528, 530, 535, 558, 563, 565, 567, 572, 574,
            576, 577, 581, 585, 627, 632, 634, 636, 641, 643, 645, 646, 650, 652, 660, 662, 667,
            677, 683, 689, 693, 697, 705, 710, 713, 715, 720, 748, 756, 758, 763, 773, 779, 785,
            789, 793, 801, 806, 808, 810, 815, 820, 833, 867, 875, 877, 882, 892, 898, 904, 908,
            912, 920, 925, 928, 930, 935, 963, 971, 973, 978, 988, 994, 1000, 1004, 1008, 1016,
            1021, 1023, 1025, 1030, 1034, 1040, 1041,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 14));
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 29, a: 31, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(28, 1));
        ...
        self.output
            .instructions
            .push(Instruction::CountLeadingZeros { a: 0, s: 27 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 26,
            a: 26,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(27, 0));
        self.bind_label(labels[&103]);
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 26, b: 25 });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(25, 30));
        self.output.instructions.push(Instruction::StoreWord {
            s: 0,
            a: 1,
            offset: 420,
