...
impl Generator {
    pub(super) fn try_cop_open(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.frame_size = 16;
        self.non_leaf = true;
        self.output.symbol_order = ["_savegpr_25", "__CARDGetControlBlock", "__CARDGetDirBlock", "__CARDDiskNone", "memcmp", "__CARDPutControlBlock", "_restgpr_25"].into_iter().map(String::from).collect();
        let mut labels: std::collections::HashMap<usize, mwcc_vreg::Label> = std::collections::HashMap::new();
        for target in [15, 21, 25, 30, 47, 49, 50, 56, 66, 70, 77, 78, 83, 88, 101, 103, 109, 112] {
        ...
        self.output.instructions.push(Instruction::load_immediate(26, -3));
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 29, offset: 268 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 30, immediate: 8 });
        ...
        self.output.instructions.push(Instruction::move_register(28, 31));
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 30, a: 30, immediate: 64 });
        ...
        self.output.instructions.push(Instruction::load_immediate(26, -4));
        ...
        self.record_relocation(RelocationKind::Rel24, "__CARDGetDirBlock");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__CARDGetDirBlock".to_string() });
        self.output.instructions.push(Instruction::ShiftLeftImmediate { a: 0, s: 28, shift: 6 });
        self.output.instructions.push(Instruction::Add { d: 5, a: 3, b: 0 });
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 4, a: 5, offset: 54 });
        ...
        self.output.instructions.push(Instruction::load_immediate(26, -6));
        self.emit_branch_to(labels[&109]); // b
        self.bind_label(labels[&103]);
        self.output.instructions.push(Instruction::StoreWord { s: 25, a: 27, offset: 0 });
        self.output.instructions.push(Instruction::load_immediate(0, 0));
        self.output.instructions.push(Instruction::StoreWord { s: 28, a: 27, offset: 4 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 8 });
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 0, a: 5, offset: 54 });
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 27, offset: 16 });
