...
Latest targeted checkpoint: 2026-07-24 00:02 UTC at compiler commit `df7631fd`
...
Post-holdout compiler work through commit `df7631fd` has not been run over a
...
relocation-aware parity from 28/109 to 33/109 functions and from 996/15,340 to
1,488/15,340 reference code bytes. The paired gain was +5/-0 functions and +492
exact bytes: `ftCommon_ClampAirDrift`, `ftCommon_FallBasic`, and
`ftCommon_CalcHitlag`, `ftCommon_8007DB58`, and `ftCommon_SetAccessory`. This is
