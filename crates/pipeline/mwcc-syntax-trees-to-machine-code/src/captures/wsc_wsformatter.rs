...
impl Generator {
    pub(super) fn try_wsc_wsformatter(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            13, 17, 22, 23, 41, 62, 65, 80, 81, 94, 97, 103, 106, 117, 120, 126, 131, 133, 134,
            149, 158, 161, 163, 165, 166, 167, 169, 171, 173, 174, 189, 198, 201, 203, 205, 206,
            207, 209, 235, 238, 241, 243, 244, 245, 247, 252, 257, 263, 269, 272, 287, 293, 296,
            299, 314, 317, 320, 321, 342, 344, 352, 360, 370, 376, 382, 387, 390, 413, 423, 428,
            432, 435, 458, 468, 469, 478, 480, 489, 492, 494, 496, 497, 508, 521, 522,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(23, 6));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 27, a: 27, b: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate { a: 0, immediate: 6 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 5, a: 22, b: 5 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 0, s: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::AndRecord { a: 0, s: 5, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 4, a: 22, b: 4 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 0, s: 3, b: 0 });
        self.output
