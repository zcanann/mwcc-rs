...
impl Generator {
    pub(super) fn try_cdd_update(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 31, a: 30, offset: 132 });
        self.output.instructions.push(Instruction::load_immediate(4, 8188));
        self.output.instructions.push(Instruction::LoadHalfwordAlgebraic { d: 7, a: 31, offset: 8186 });
        self.output.instructions.push(Instruction::move_register(3, 31));
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 31, immediate: 8188 });
        self.output.instructions.push(Instruction::AddImmediate { d: 6, a: 31, immediate: 8190 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 7, immediate: 1 });
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 31, offset: 8186 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 29, a: 30, offset: 216 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 30, offset: 128 });
        ...
        self.output.instructions.push(Instruction::SubtractFrom { d: 0, a: 0, b: 31 });
