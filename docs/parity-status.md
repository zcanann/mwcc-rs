...
Latest targeted checkpoint: 2026-07-24 02:16 UTC at compiler commit `04255c5c`
...
Post-holdout compiler work through commit `04255c5c` has not been run over a
...
relocation-aware parity from 28/109 to 54/109 functions and from 996/15,340 to
3,320/15,340 reference code bytes. Paired movement was +26/-0 functions and
+2,324 exact bytes. The gains were `ftCommon_ClampAirDrift`, `ftCommon_FallBasic`,
...
The retained derived-member lifetime also made `ftCommon_8007D60C` exact. This
is evidence of local forward movement, not a corpus-level percentage.
