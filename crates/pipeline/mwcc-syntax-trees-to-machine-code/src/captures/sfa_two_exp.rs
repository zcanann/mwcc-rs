...
impl Generator {
    pub(super) fn try_sfa_two_exp(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![72, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 312, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 552, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 792, 5096, 5096, 5096, 5096, 5096, 5096, 5096, 1032, 1272, 1512, 1752, 1992, 2232, 2472, 2712, 2952, 3188, 3424, 3660, 3896, 4136, 4376, 4616, 4856],
        ...
        for target in [24, 30, 35, 44, 48, 55, 60, 66, 74, 84, 90, 95, 104, 108, 115, 120, 126, 134, 144, 150, 155, 164, 168, 175, 180, 186, 194, 204, 210, 215, 224, 228, 235, 240, 246, 254, 264, 270, 275, 284, 288, 295, 300, 306, 314, 324, 330, 335, 344, 348, 355, 360, 366, 374, 384, 390, 395, 404, 408, 415, 420, 426, 434, 444, 450, 455, 464, 468, 475, 480, 486, 494, 504, 510, 515, 524, 528, 535, 540, 546, 554, 564, 570, 575, 584, 588, 595, 600, 606, 614, 624, 630, 635, 644, 648, 655, 660, 666, 674, 684, 690, 695, 704, 708, 715, 720, 726, 734, 743, 749, 754, 763, 767, 774, 779, 785, 793, 802, 808, 813, 822, 826, 833, 838, 844, 852, 861, 867, 872, 881, 885, 892, 897, 903, 911, 920, 926, 931, 940, 944, 951, 956, 962, 970, 980, 986, 991, 1000, 1004, 1011, 1016, 1022, 1030, 1040, 1046, 1051, 1060, 1064, 1071, 1076, 1082, 1090, 1100, 1106, 1111, 1120, 1124, 1131, 1136, 1142, 1150, 1160, 1166, 1171, 1180, 1184, 1191, 1196, 1202, 1210, 1220, 1226, 1231, 1240, 1244, 1251, 1256, 1262, 1270, 1274, 1316, 1322, 1327, 1336, 1340, 1347, 1352, 1358, 1366, 1369, 1374, 1381, 1387, 1392, 1401, 1405, 1412, 1417, 1423, 1431, 1434, 1438] {
            labels.insert(target, self.fresh_label());
        }
        self.output.instructions.push(Instruction::StoreWordWithUpdate { s: 1, a: 1, offset: -192 });
        self.output.instructions.push(Instruction::MoveFromLinkRegister { d: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 1, offset: 196 });
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 1, offset: 188 });
        self.output.instructions.push(Instruction::move_register(31, 3));
        self.output.instructions.push(Instruction::StoreWord { s: 30, a: 1, offset: 184 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 196 });
        self.output.instructions.push(Instruction::LoadWord { d: 31, a: 1, offset: 188 });
        self.output.instructions.push(Instruction::LoadWord { d: 30, a: 1, offset: 184 });
        self.output.instructions.push(Instruction::MoveToLinkRegister { s: 0 });
        self.output.instructions.push(Instruction::AddImmediate { d: 1, a: 1, immediate: 192 });
