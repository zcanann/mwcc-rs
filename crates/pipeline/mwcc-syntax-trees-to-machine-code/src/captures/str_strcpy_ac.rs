//! str_strcpy_ac: an exact-match whole-function capture (fire 472).
...
const STR_STRCPY_AC_AST_HASH: u64 = 0xfc14874176fa1a95;

impl Generator {
    pub(super) fn try_str_strcpy_ac(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != STR_STRCPY_AC_AST_HASH {
            return Ok(false);
        }
        ...
        self.output.instructions.push(Instruction::load_immediate_shifted(5, -32639));
        self.output.instructions.push(Instruction::AddImmediate { d: 6, a: 5, immediate: -32640 });
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 5, a: 8, immediate: -257 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 5, immediate: -257 });
