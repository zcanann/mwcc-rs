...
impl Generator {
    pub(super) fn try_crd_seek(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 4, a: 5, b: 4 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, -128));
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 3, b: 30 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, -11));
        self.record_relocation(RelocationKind::Rel24, "__CARDPutControlBlock");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__CARDPutControlBlock".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWordImmediate { a: 5, immediate: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::AndComplement { a: 0, s: 30, b: 0 });
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 5, b: 0 });
