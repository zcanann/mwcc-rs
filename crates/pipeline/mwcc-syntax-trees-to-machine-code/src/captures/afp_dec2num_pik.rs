...
impl Generator {
    pub(super) fn try_afp_dec2num_pik(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            17, 19, 27, 30, 35, 40, 48, 64, 67, 72, 83, 85, 98, 104, 107, 111, 123, 126, 127, 129,
            140, 142, 154, 157, 158, 162, 163,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 31, s: 31 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::AddRecord { d: 28, a: 0, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::Xor { a: 5, s: 0, b: 30 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 5, a: 0, b: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatDivideDouble { d: 0, a: 1, b: 2 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatDivideDouble { d: 31, a: 31, b: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 31, a: 31, c: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatNegate { d: 1, b: 31 });
        self.emit_branch_to(labels[&163]); // b
