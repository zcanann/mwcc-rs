...
impl Generator {
    pub(super) fn try_afp_num2dec_i(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            ...
            118, 120, 125, 129, 132, 141, 147, 149, 154, 158, 160, 161, 188, 191, 208, 218, 223,
            229, 234,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 26, s: 3 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 26, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 1,
            immediate: 56,
