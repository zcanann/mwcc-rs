...
impl Generator {
    pub(super) fn try_rt_va_arg(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(12, 4));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(11, 32));
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 7, s: 7 });
        self.output
            .instructions
            .push(Instruction::load_immediate(12, 8));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(5, 7));
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 7, b: 10 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 5,
            a: 3,
            offset: 8,
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 3, a: 7, b: 12 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 11, b: 3 });
        self.output
            .instructions
