//! su_strtol: an exact-match whole-function capture (fire 461).
...
const SU_STRTOL_AST_HASH: u64 = 0xe0952b894e845b7f;

impl Generator {
    pub(super) fn try_su_strtol(&mut self, function: &Function) -> Compilation<bool> {
