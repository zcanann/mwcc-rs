//! sldx: an exact-match whole-function capture (fire 490).
...
impl Generator {
    pub(super) fn try_sldx(&mut self, function: &Function) -> Compilation<bool> {
        ...
        let bump: u32 = match context {
            0xb61776ae26f47f0e => 33, // BfBB: pool @58 (ours @25)
            0xb4626ed660a00a79 => 33, // pikmin2: pool @95 (ours @62)
            0xbceeda89e0a55f64 => 33, // wind_waker: pool @66 (ours @33)
            _ => return Ok(false),
        };
