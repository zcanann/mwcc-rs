//! mem_memrchr_mp4: an exact-match whole-function capture (fire 486).
...
const MEM_MEMRCHR_MP4_AST_HASH: u64 = 0xe792381dcf009877;

impl Generator {
    pub(super) fn try_mem_memrchr_mp4(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MEM_MEMRCHR_MP4_AST_HASH {
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0xbd60acb658c79e45 => 0, // marioparty4
            _ => return Ok(false),
        };
