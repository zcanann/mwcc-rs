// flags: -sym on -opt off -inline off -Cpp_exceptions off -pragma "cats off"
/* Unoptimized symbol ranges reuse the final argument register as address scratch. */
...
void install_unoptimized_vector(void) {
