...
impl Generator {
    pub(super) fn try_pfp_dec2num(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [15, 16, 18, 25, 28, 34, 35, 37, 44, 45, 47, 58, 66, 73, 80, 87, 91, 94, 96, 99, 106, 108, 113, 119, 121, 153, 181, 182, 187, 206, 215, 221, 249, 250, 255, 269, 271, 273, 288, 299, 313, 318, 320, 322, 327, 329, 331, 332, 342, 348, 353, 363, 367, 374, 379, 385, 393, 396, 404, 406, 411, 421, 427, 433, 437, 441, 449, 454, 456, 458, 463, 468, 484, 486, 491, 501, 507, 513, 517, 521, 529, 534, 536, 538, 543, 566, 571, 573, 575, 580, 582, 584, 585, 589, 593, 635, 640, 642, 644, 649, 651, 653, 654, 658, 660, 668, 670, 675, 685, 691, 697, 701, 705, 713, 718, 721, 723, 728, 756, 764, 766, 771, 781, 787, 793, 797, 801, 809, 814, 816, 818, 823, 828, 841, 875, 883, 885, 890, 900, 906, 912, 916, 920, 928, 933, 936, 938, 943, 971, 979, 981, 986, 996, 1002, 1008, 1012, 1016, 1024, 1029, 1031, 1033, 1038, 1042, 1048, 1049] {
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 1, offset: 492 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 30, a: 1, offset: 488 });
        self.output.instructions.push(Instruction::StoreWord { s: 29, a: 1, offset: 484 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 7, a: 1, immediate: 57 });
        ...
        self.output.instructions.push(Instruction::move_register(31, 30));
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 31, a: 1, offset: 492 });
        self.output.instructions.push(Instruction::LoadWord { d: 30, a: 1, offset: 488 });
        self.output.instructions.push(Instruction::LoadWord { d: 29, a: 1, offset: 484 });
