//! uc8_write: an exact-match whole-function capture (fire 491).
...
const UC8_WRITE_AST_HASH: u64 = 1; // DISARMED f492: static-local $N base needs the skipped-inline bump-count model (ours 35 vs mwcc 30)
