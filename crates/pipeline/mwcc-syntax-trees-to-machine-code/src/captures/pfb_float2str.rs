...
impl Generator {
    pub(super) fn try_pfb_float2str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != PFB_FLOAT2STR_AST_HASH
            && hash != 0xd3e54f2b12d2118f
            && hash != 0x835237086d7940cc
        {
        ...
        let bump: u32 = match context {
            0x6ff29e48ce03ae67 => 187, // pikmin
            0x33b138778391aadc => 187, // sunshine
        ...
        for target in [
            17, 20, 25, 37, 43, 49, 56, 59, 62, 70, 74, 76, 82, 100, 103, 107, 113, 119, 126, 129,
            135, 138, 145, 153, 160, 166, 170, 183, 197, 205, 206, 208, 211, 213, 221, 223, 231,
            237, 242, 248, 261, 265, 270, 275, 277, 283, 286, 291, 298, 309, 310, 312, 318, 320,
            325, 327, 337, 356, 357, 361, 363, 369, 375, 379, 380,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 7, b: 0 });
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 4, b: 0 });
