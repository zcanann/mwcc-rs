//! strm_strchr: an exact-match whole-function capture (fire 472).
...
const STRM_STRCHR_AST_HASH: u64 = 0x33c8369a8b3d9fa3;

impl Generator {
    pub(super) fn try_strm_strchr(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadByteZeroWithUpdate { d: 4, a: 3, offset: 1 });
