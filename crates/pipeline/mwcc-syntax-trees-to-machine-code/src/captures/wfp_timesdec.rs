//! wfp_timesdec: an exact-match whole-function capture (fire 684).
...
const WFP_TIMESDEC_AST_HASH: u64 = 0x71a0393c04ee049d;

impl Generator {
    pub(super) fn try_wfp_timesdec(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != WFP_TIMESDEC_AST_HASH {
            eprintln!("wfp_timesdec hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0x5a0dc0a7a888f50b => 0, // marioparty4 (bump TBD from refctx @N diff)
            _ => {
                eprintln!("wfp_timesdec context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        for target in [
            19, 25, 34, 40, 77, 78, 85, 93, 105, 107, 112, 116, 128, 133, 136, 141, 147, 155, 158,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(7, -13107));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 29,
            a: 12,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 8, b: 6 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 7, a: 8, b: 29 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 11, a: 7, b: 31 });
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 10, b: 11 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 28,
            a: 7,
            immediate: 5,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 28, a: 4, b: 28 });
        self.output
            .instructions
            .push(Instruction::Add { d: 27, a: 5, b: 27 });
        self.emit_branch_conditional_to(4, 1, labels[&34]); // ble
        self.output
            .instructions
            .push(Instruction::move_register(10, 11));
        ...
        self.output
            .instructions
            .push(Instruction::move_register(8, 10));
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 7, a: 11, b: 10 });
        self.output.instructions.push(Instruction::LoadByteZero {
            d: 11,
            a: 28,
            offset: 1,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 30, a: 30, b: 7 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 7, a: 11, b: 10 });
        self.output.instructions.push(Instruction::LoadByteZero {
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWordUnsigned { d: 8, a: 9, b: 30 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 29,
            a: 29,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(7, 8));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 8, a: 8, b: 30 });
        self.output
            .instructions
            .push(Instruction::ShiftRightLogicalImmediate {
                a: 30,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 4, a: 7, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 5, a: 3, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 4, a: 5, b: 0 });
        self.output
            .instructions
