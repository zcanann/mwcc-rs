...
impl Generator {
    pub(super) fn try_osm_send(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 31, s: 30, clear: 31 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 6, a: 28, offset: 20 });
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 28, offset: 28 });
        self.output.instructions.push(Instruction::CompareWord { a: 6, b: 4 });
        self.emit_branch_conditional_to(4, 1, labels[&14]); // ble
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 28, offset: 24 });
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 28, immediate: 8 });
        self.output.instructions.push(Instruction::LoadWord { d: 5, a: 28, offset: 16 });
        self.output.instructions.push(Instruction::Add { d: 4, a: 0, b: 4 });
        self.output.instructions.push(Instruction::DivideWord { d: 0, a: 4, b: 6 });
        self.output.instructions.push(Instruction::MultiplyLow { d: 0, a: 0, b: 6 });
        ...
        self.output.instructions.push(Instruction::StoreWordIndexed { s: 29, a: 5, b: 0 });
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 28, offset: 28 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 4, immediate: 1 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 28, offset: 28 });
