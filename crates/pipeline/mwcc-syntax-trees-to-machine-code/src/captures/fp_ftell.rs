//! fp_ftell: an exact-match whole-function capture (fire 458).
...
const FP_FTELL_AST_HASH: u64 = 0x9d64e2d1f74c92b9;

impl Generator {
    pub(super) fn try_fp_ftell(&mut self, function: &Function) -> Compilation<bool> {
