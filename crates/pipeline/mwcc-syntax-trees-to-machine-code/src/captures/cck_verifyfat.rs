...
impl Generator {
    pub(super) fn try_cck_verifyfat(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 7, b: 6 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Nor { a: 0, s: 8, b: 8 });
        self.output
            .instructions
            .push(Instruction::Add { d: 9, a: 9, b: 8 });
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZero {
                d: 8,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 10, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(9, 5));
        ...
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 0, a: 7, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 4, s: 6 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 4, a: 7, b: 4 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftImmediate {
                a: 0,
