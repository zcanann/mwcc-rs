//! mem_memchr_mel: an exact-match whole-function capture (fire 486).
...
const MEM_MEMCHR_MEL_AST_HASH: u64 = 0x5c5e7366a0760f34;

impl Generator {
    pub(super) fn try_mem_memchr_mel(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MEM_MEMCHR_MEL_AST_HASH {
            return Ok(false);
        }
