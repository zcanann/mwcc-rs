...
impl Generator {
    pub(super) fn try_pfb_parse_format(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                928, 1152, 908, 1152, 1152, 1152, 1152, 1152, 1152, 1152, 1152, 1152, 1152, 1152,
                1152, 1152, 1152, 1152, 1152, 780, 1152, 1152, 1152, 1152, 1152, 1152, 1152, 1152,
                1152, 1152, 1028, 780, 928, 852, 908, 1152, 780, 1152, 1152, 1152, 1152, 1128, 780,
                992, 1152, 1152, 1084, 1152, 780, 1152, 1152, 780,
            ],
        ...
        for target in [
            ...
            180, 181, 185, 201, 207, 218, 221, 232, 239, 242, 263, 268, 277, 288, 290, 299,
        ] {
