...
impl Generator {
    pub(super) fn try_pfa_longlong2str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != PFA_LONGLONG2STR_AST_HASH && hash != 0xfdb2cc3c10a5f433 {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                252, 268, 268, 268, 268, 268, 268, 268, 268, 268, 268, 268, 156, 268, 268, 268,
                268, 156, 268, 268, 268, 268, 268, 212, 268, 268, 268, 268, 268, 232, 268, 268,
                252,
            ],
        ...
        for target in [
            27, 29, 67, 84, 89, 90, 111, 121, 124, 136, 143, 150, 161, 162, 164, 177, 182, 188,
            192, 193,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(23, 5));
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 0));
        self.output
            .instructions
            .push(Instruction::Xor { a: 5, s: 4, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Xor { a: 0, s: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::move_register(24, 6));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 0, a: 0, b: 4 });
        self.output
            .instructions
            .push(Instruction::load_immediate(29, 0));
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 3, b: 5 });
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 5, b: 5 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromZeroExtended { d: 31, a: 31 });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(6, 28));
        ...
        self.output
            .instructions
            .push(Instruction::Xor { a: 3, s: 30, b: 4 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 26,
            a: 26,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::Xor { a: 0, s: 31, b: 4 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Xor { a: 0, s: 29, b: 4 });
        self.output
            .instructions
            .push(Instruction::Xor { a: 3, s: 28, b: 3 });
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 0, s: 3, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(3, 16));
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::Xor { a: 0, s: 29, b: 0 });
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 0, s: 3, b: 0 });
        self.emit_branch_conditional_to(4, 2, labels[&136]); // bne
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 27, b: 23 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 26, b: 3 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 26, b: 3 });
        self.output
            .instructions
