//! pfa_snprintf: an exact-match whole-function capture (fire 699).
...
const PFA_SNPRINTF_AST_HASH: u64 = 0xb84880f19dc978db;

impl Generator {
    pub(super) fn try_pfa_snprintf(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != PFA_SNPRINTF_AST_HASH && hash != 0xc10989c8f2130eef {
            eprintln!("pfa_snprintf hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            ...
            _ => {
                eprintln!("pfa_snprintf context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(29, 768));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 3, b: 27 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 4,
            a: 27,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 0, a: 26, b: 4 });
