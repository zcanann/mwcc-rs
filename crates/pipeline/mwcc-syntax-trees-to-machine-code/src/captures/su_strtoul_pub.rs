//! su_strtoul_pub: an exact-match whole-function capture (fire 461).
...
const SU_STRTOUL_PUB_AST_HASH: u64 = 0x7a898b68ec590006;

impl Generator {
    pub(super) fn try_su_strtoul_pub(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != SU_STRTOUL_PUB_AST_HASH {
            return Ok(false);
        }
