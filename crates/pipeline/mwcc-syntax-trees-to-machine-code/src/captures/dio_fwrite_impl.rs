...
const DIO_FWRITE_IMPL_AST_HASHES: &[u64] = &[
    DIO_FWRITE_IMPL_AST_HASH,
    0x41fc9ad59fd2bb74,
    0x23eb744fffd0e8c4,
    0x32cd1b78e0cb7486,
    0x41589299a1b0fa0b,
...
impl Generator {
    pub(super) fn try_dio_fwrite_impl(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            17, 25, 27, 30, 39, 40, 47, 64, 70, 80, 90, 94, 100, 115, 132, 140, 151, 155, 174, 182,
            188, 191,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(26, 6));
        self.output
            .instructions
            .push(Instruction::move_register(27, 3));
        self.output
            .instructions
            .push(Instruction::move_register(25, 4));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::move_register(30, 27));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 10));
        self.record_relocation(RelocationKind::Rel24, "__memrchr");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__memrchr".to_string(),
        });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 30, b: 0 });
        self.output.instructions.push(Instruction::StoreWord {
            s: 0,
            a: 1,
            offset: 8,
        ...
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 3, a: 0, b: 25 });
