...
impl Generator {
    pub(super) fn try_ansif_find_unopened(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 3, offset: 236 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 3, offset: 76 });
        ...
        self.output.instructions.push(Instruction::load_immediate(3, 80));
        ...
        self.output.instructions.push(Instruction::load_immediate(5, 80));
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 31, offset: 12 });
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 30, offset: 76 });
        self.emit_branch_to(labels[&30]); // b
