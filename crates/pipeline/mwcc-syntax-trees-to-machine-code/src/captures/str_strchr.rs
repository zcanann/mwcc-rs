//! str_strchr: an exact-match whole-function capture (fire 469).
...
const STR_STRCHR_AST_HASH: u64 = 0x6419208723fcad5d;

impl Generator {
    pub(super) fn try_str_strchr(&mut self, function: &Function) -> Compilation<bool> {
