...
impl Generator {
    pub(super) fn try_pfb_pformatter(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != PFB_PFORMATTER_AST_HASH && hash != 0xb346a9c303023d64 && hash != 0x441b4584de90205e {
        ...
        for target in [15, 34, 46, 64, 67, 73, 76, 85, 88, 94, 102, 110, 114, 119, 123, 133, 139, 141, 149, 157, 161, 166, 170, 180, 186, 188, 197, 207, 214, 218, 221, 234, 246, 250, 261, 265, 267, 269, 271, 275, 283, 288, 302, 304, 312, 319, 332, 335, 345, 346, 349, 361, 366, 377, 378, 381, 382, 385, 386] {
            labels.insert(target, self.fresh_label());
        }
        self.output.instructions.push(Instruction::StoreWordWithUpdate { s: 1, a: 1, offset: -608 });
        self.output.instructions.push(Instruction::MoveFromLinkRegister { d: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 1, offset: 612 });
        self.output.instructions.push(Instruction::AddImmediate { d: 11, a: 1, immediate: 608 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 22, a: 1, immediate: 540 });
        self.output.instructions.push(Instruction::AddImmediate { d: 21, a: 1, immediate: 539 });
        ...
        self.output.instructions.push(Instruction::Add { d: 29, a: 29, b: 5 });
        ...
        self.record_relocation(RelocationKind::Rel24, "__va_arg");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__va_arg".to_string() });
        self.output.instructions.push(Instruction::LoadWord { d: 23, a: 3, offset: 0 });
        self.output.instructions.push(Instruction::LoadWord { d: 24, a: 3, offset: 4 });
        self.emit_branch_to(labels[&114]); // b
        ...
        self.output.instructions.push(Instruction::ExtendSignHalfword { a: 0, s: 28 });
        ...
        self.output.instructions.push(Instruction::ExtendSignByte { a: 0, s: 28 });
        self.output.instructions.push(Instruction::move_register(28, 0));
        ...
        self.output.instructions.push(Instruction::move_register(5, 22));
        self.output.instructions.push(Instruction::AddImmediate { d: 6, a: 1, immediate: 12 });
        ...
        self.output.instructions.push(Instruction::move_register(4, 22));
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 1, immediate: 12 });
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 28, clear: 16 });
        self.output.instructions.push(Instruction::move_register(28, 0));
        self.bind_label(labels[&166]);
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 3, immediate: 1 });
        self.emit_branch_conditional_to(4, 2, labels[&170]); // bne
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 28, clear: 24 });
        self.output.instructions.push(Instruction::move_register(28, 0));
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 1, immediate: 28 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 20, a: 1, immediate: 28 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 1, offset: 15 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 1, offset: 14 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 25, a: 1, offset: 24 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 29, a: 3, offset: 0 });
        self.emit_branch_to(labels[&382]); // b
        self.bind_label(labels[&267]);
        self.output.instructions.push(Instruction::StoreHalfword { s: 29, a: 3, offset: 0 });
        self.emit_branch_to(labels[&382]); // b
        self.bind_label(labels[&269]);
        self.output.instructions.push(Instruction::StoreWord { s: 29, a: 3, offset: 0 });
        self.emit_branch_to(labels[&382]); // b
        self.bind_label(labels[&271]);
        self.output.instructions.push(Instruction::StoreWord { s: 29, a: 3, offset: 4 });
        ...
        self.output.instructions.push(Instruction::Add { d: 29, a: 29, b: 19 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 612 });
        self.output.instructions.push(Instruction::MoveToLinkRegister { s: 0 });
        self.output.instructions.push(Instruction::AddImmediate { d: 1, a: 1, immediate: 608 });
