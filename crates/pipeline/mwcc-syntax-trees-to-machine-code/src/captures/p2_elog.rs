...
impl Generator {
    pub(super) fn try_p2_elog(&mut self, function: &Function) -> Compilation<bool> {
        ...
        let bump: u32 = match context {
            0xb61776ae26f47f0e => 35, // BfBB post-fold (f524)
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(8, -54));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 4, b: 8 });
        ...
        self.output
            .instructions
            .push(Instruction::Or { a: 4, s: 6, b: 3 });
        self.output
            .instructions
            .push(Instruction::ClearLeftImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 8, b: 3 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 2, a: 2, b: 3 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 0, a: 0, c: 2 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 5, a: 2, c: 1 });
        self.emit_branch_conditional_to(4, 2, labels[&80]); // bne
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 1, a: 0, b: 5 });
        self.emit_branch_to(labels[&157]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 7));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 2, a: 12, c: 2 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 3, a: 11, c: 3 });
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 5, a: 9, b: 10 });
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 3, a: 3, b: 2 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 2, a: 2, c: 0 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 6, a: 2, c: 0 });
        self.emit_branch_conditional_to(4, 2, labels[&136]); // bne
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 2, a: 6, b: 3 });
        self.output
            .instructions
            .push(Instruction::FloatNegativeMultiplySubtractDouble {
                d: 1,
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 1, a: 0, b: 1 });
        self.emit_branch_to(labels[&157]); // b
        self.bind_label(labels[&136]);
        self.load_double_constant(2, 0x3dea39ef35793c76);
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 3, a: 6, b: 3 });
        self.load_double_constant(4, 0x3fe62e42fee00000);
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 2, a: 2, c: 5 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplyAddDouble {
                d: 1,
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 1, a: 6, b: 1 });
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 0, a: 1, b: 0 });
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 2, a: 0, b: 3 });
        self.output
            .instructions
            .push(Instruction::FloatNegativeMultiplySubtractDouble {
                d: 1,
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 3, a: 0, b: 3 });
        self.load_double_constant(4, 0x3fe62e42fee00000);
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 2, a: 2, c: 5 });
