//! Top-level item parsing: declarations, types, struct/enum/union bodies,
//! inline handling, and the translation unit. Statement parsing lives in
//! `statements`; global initializer and static-data parsing in `initializers`.
//!
