...
impl Generator {
    pub(super) fn try_mbs_wcstombs_ac(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 4, a: 29, offset: 0 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 4, immediate: 0 });
        self.emit_branch_conditional_to(4, 2, labels[&21]); // bne
        self.output.instructions.push(Instruction::load_immediate(0, 0));
        self.output.instructions.push(Instruction::StoreByteIndexed { s: 0, a: 27, b: 30 });
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "unicode_to_UTF8".to_string() });
        self.output.instructions.push(Instruction::move_register(31, 3));
        self.output.instructions.push(Instruction::Add { d: 0, a: 30, b: 31 });
        self.output.instructions.push(Instruction::CompareLogicalWord { a: 0, b: 28 });
        self.emit_branch_conditional_to(12, 1, labels[&35]); // bgt
        self.output.instructions.push(Instruction::move_register(5, 31));
        self.output.instructions.push(Instruction::Add { d: 3, a: 27, b: 30 });
        ...
        self.output.instructions.push(Instruction::Add { d: 30, a: 30, b: 31 });
        self.bind_label(labels[&33]);
        self.output.instructions.push(Instruction::CompareLogicalWord { a: 30, b: 28 });
