...
impl Generator {
    pub(super) fn try_oal_callback(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "OSLoadContext".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 0, a: 5, b: 28 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 0, a: 5, b: 6 });
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 3, b: 4 });
        self.output
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "OSClearContext".to_string(),
        });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 1,
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "OSSetCurrentContext".to_string(),
        });
        self.output
            .instructions
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__OSReschedule".to_string(),
        });
        self.output
            .instructions
            .push(Instruction::move_register(3, 29));
