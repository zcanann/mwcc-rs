//! satan_pik: an exact-match whole-function capture (fire 451).
...
const SATAN_PIK_AST_HASH: u64 = 0x4d8407fd74bc0106;

impl Generator {
    pub(super) fn try_satan_pik(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 29, s: 31, clear: 1 });
        self.output.instructions.push(Instruction::CompareWord { a: 29, b: 0 });
        ...
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 0, a: 29, immediate: -32752 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 30, immediate: 0 });
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 30, immediate: 32 });
        ...
        self.output.instructions.push(Instruction::FloatAddDouble { d: 0, a: 3, b: 1 });
        self.output.instructions.push(Instruction::FloatMultiplySubtractDouble { d: 1, a: 3, c: 1, b: 2 });
        ...
        self.output.instructions.push(Instruction::FloatDivideDouble { d: 0, a: 2, b: 0 });
        self.output.instructions.push(Instruction::StoreFloatDouble { s: 0, a: 1, offset: 8 });
        self.emit_branch_to(labels[&94]); // b
        ...
        self.load_double_constant(0, 0x3ff0000000000000);
        self.output.instructions.push(Instruction::FloatSubtractDouble { d: 2, a: 1, b: 3 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 30, immediate: 64 });
        ...
        self.output.instructions.push(Instruction::LoadFloatDouble { d: 4, a: 30, offset: 64 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 30, immediate: 0 });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 31, immediate: 0 });
        ...
        // @N: measured via objprobe — the real pools start at @44 (ours @5).
