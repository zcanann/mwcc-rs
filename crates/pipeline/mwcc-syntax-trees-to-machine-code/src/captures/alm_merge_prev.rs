...
impl Generator {
    pub(super) fn try_alm_merge_prev(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 6, a: 3, offset: -4 });
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 0, s: 6, shift: 0, begin: 30, end: 30 });
        self.output.instructions.push(Instruction::BranchConditionalToLinkRegister { options: 4, condition_bit: 2 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 7, a: 6, b: 3 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 3, offset: 0 });
        self.output.instructions.push(Instruction::AndContiguousMask { a: 0, s: 0, begin: 0, end: 28 });
        self.output.instructions.push(Instruction::Add { d: 5, a: 6, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 5, immediate: -4 });
        self.output.instructions.push(Instruction::StoreWordIndexed { s: 5, a: 7, b: 0 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 5, a: 3, offset: 12 });
        self.output.instructions.push(Instruction::move_register(3, 7));
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 5, offset: 8 });
