...
impl Generator {
    pub(super) fn try_mf_copy_ral(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::Add { d: 7, a: 3, b: 5 });
        self.output.instructions.push(Instruction::Add { d: 6, a: 4, b: 5 });
        self.output.instructions.push(Instruction::ClearLeftImmediateRecord { a: 3, s: 7, clear: 30 });
        ...
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 4, s: 5, shift: 27, begin: 5, end: 31 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 7, offset: -4 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 6, offset: -12 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 7, offset: -8 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 6, offset: -16 });
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 7, offset: -12 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 6, offset: -20 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 7, offset: -16 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 6, offset: -24 });
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 7, offset: -20 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 6, offset: -28 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 7, offset: -24 });
        self.output.instructions.push(Instruction::LoadWordWithUpdate { d: 0, a: 6, offset: -32 });
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 7, offset: -28 });
        self.output.instructions.push(Instruction::StoreWordWithUpdate { s: 0, a: 7, offset: -32 });
        ...
        self.output.instructions.push(Instruction::AddImmediateCarryingRecord { d: 3, a: 3, immediate: -1 });
        self.output.instructions.push(Instruction::StoreWordWithUpdate { s: 0, a: 7, offset: -4 });
