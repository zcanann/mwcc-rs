...
impl Generator {
    pub(super) fn try_pfa_pformatter(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != PFA_PFORMATTER_AST_HASH && hash != 0x58776023245dc547 && hash != 0x5626b19a36d52bdf && hash != 0x5d8590e5c9269fd0 {
        ...
        for target in [15, 34, 46, 64, 69, 75, 78, 89, 92, 98, 101, 109, 117, 121, 126, 130, 148, 162, 164, 172, 180, 184, 189, 193, 211, 225, 227, 235, 239, 254, 262, 266, 281, 291, 298, 302, 305, 318, 330, 334, 345, 349, 351, 353, 355, 359, 367, 372, 386, 388, 396, 405, 418, 421, 431, 432, 435, 447, 452, 463, 464, 467, 468, 471, 472] {
            labels.insert(target, self.fresh_label());
        }
        self.output.instructions.push(Instruction::StoreWordWithUpdate { s: 1, a: 1, offset: -704 });
        self.output.instructions.push(Instruction::MoveFromLinkRegister { d: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 1, offset: 708 });
        self.output.instructions.push(Instruction::AddImmediate { d: 11, a: 1, immediate: 704 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 24, a: 1, immediate: 636 });
        self.output.instructions.push(Instruction::AddImmediate { d: 21, a: 1, immediate: 635 });
        ...
        self.output.instructions.push(Instruction::load_immediate(4, 37));
        self.record_relocation(RelocationKind::Rel24, "strchr");
        self.output.instructions.push(Instruction::BranchAndLink { target: "strchr".to_string() });
        self.output.instructions.push(Instruction::OrRecord { a: 25, s: 3, b: 3 });
        ...
        self.output.instructions.push(Instruction::OrRecord { a: 5, s: 3, b: 3 });
        self.output.instructions.push(Instruction::Add { d: 27, a: 27, b: 5 });
        ...
        self.output.instructions.push(Instruction::SubtractFromRecord { d: 5, a: 26, b: 25 });
        self.output.instructions.push(Instruction::Add { d: 27, a: 27, b: 5 });
        ...
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 65 });
        ...
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 116 });
        self.emit_branch_conditional_to(12, 2, labels[&372]); // beq
        self.emit_branch_conditional_to(4, 0, labels[&92]); // bge
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 111 });
        self.emit_branch_conditional_to(12, 2, labels[&164]); // beq
        ...
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 106 });
        self.emit_branch_conditional_to(4, 0, labels[&372]); // bge
        self.emit_branch_to(labels[&101]); // b
        ...
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 118 });
        self.emit_branch_conditional_to(4, 0, labels[&372]); // bge
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 1, offset: 112 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 29, a: 3, offset: 0 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 23, a: 3, offset: 4 });
        self.emit_branch_to(labels[&121]); // b
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 3, a: 1, offset: 112 });
        ...
        self.output.instructions.push(Instruction::ExtendSignHalfword { a: 0, s: 29 });
        self.output.instructions.push(Instruction::move_register(29, 0));
        self.bind_label(labels[&126]);
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 3, immediate: 1 });
        self.emit_branch_conditional_to(4, 2, labels[&130]); // bne
        self.output.instructions.push(Instruction::ExtendSignByte { a: 0, s: 29 });
        self.output.instructions.push(Instruction::move_register(29, 0));
        self.bind_label(labels[&130]);
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 3, immediate: 4 });
        self.emit_branch_conditional_to(4, 2, labels[&148]); // bne
        self.output.instructions.push(Instruction::LoadWord { d: 9, a: 1, offset: 108 });
        self.output.instructions.push(Instruction::move_register(4, 23));
        self.output.instructions.push(Instruction::LoadWord { d: 8, a: 1, offset: 112 });
        self.output.instructions.push(Instruction::move_register(3, 22));
        self.output.instructions.push(Instruction::LoadWord { d: 7, a: 1, offset: 116 });
        self.output.instructions.push(Instruction::move_register(5, 24));
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::AddImmediate { d: 6, a: 1, immediate: 92 });
        self.output.instructions.push(Instruction::StoreWord { s: 9, a: 1, offset: 92 });
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 1, offset: 96 });
        self.output.instructions.push(Instruction::StoreWord { s: 7, a: 1, offset: 100 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 1, offset: 104 });
        self.record_relocation(RelocationKind::Rel24, "longlong2str");
        self.output.instructions.push(Instruction::BranchAndLink { target: "longlong2str".to_string() });
        self.output.instructions.push(Instruction::OrRecord { a: 20, s: 3, b: 3 });
        self.emit_branch_conditional_to(12, 2, labels[&372]); // beq
        self.emit_branch_to(labels[&162]); // b
        self.bind_label(labels[&148]);
        self.output.instructions.push(Instruction::LoadWord { d: 8, a: 1, offset: 108 });
        self.output.instructions.push(Instruction::move_register(3, 29));
        self.output.instructions.push(Instruction::LoadWord { d: 7, a: 1, offset: 112 });
        self.output.instructions.push(Instruction::move_register(4, 24));
        self.output.instructions.push(Instruction::LoadWord { d: 6, a: 1, offset: 116 });
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 1, immediate: 76 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 1, offset: 76 });
        self.output.instructions.push(Instruction::StoreWord { s: 7, a: 1, offset: 80 });
        self.output.instructions.push(Instruction::StoreWord { s: 6, a: 1, offset: 84 });
        ...
        self.output.instructions.push(Instruction::SubtractFrom { d: 25, a: 20, b: 21 });
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 29, clear: 24 });
        self.output.instructions.push(Instruction::move_register(29, 0));
        ...
        self.output.instructions.push(Instruction::move_register(5, 24));
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::AddImmediate { d: 6, a: 1, immediate: 60 });
        self.output.instructions.push(Instruction::StoreWord { s: 9, a: 1, offset: 60 });
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 1, offset: 64 });
        self.output.instructions.push(Instruction::StoreWord { s: 7, a: 1, offset: 68 });
        ...
        self.output.instructions.push(Instruction::move_register(4, 24));
        self.output.instructions.push(Instruction::LoadWord { d: 6, a: 1, offset: 116 });
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 1, immediate: 44 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 1, offset: 44 });
        self.output.instructions.push(Instruction::StoreWord { s: 7, a: 1, offset: 48 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 7, a: 1, offset: 108 });
        self.output.instructions.push(Instruction::move_register(3, 24));
        self.output.instructions.push(Instruction::LoadWord { d: 6, a: 1, offset: 112 });
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 1, immediate: 28 });
        self.output.instructions.push(Instruction::LoadWord { d: 5, a: 1, offset: 116 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::StoreWord { s: 7, a: 1, offset: 28 });
        self.output.instructions.push(Instruction::StoreWord { s: 6, a: 1, offset: 32 });
        self.output.instructions.push(Instruction::StoreWord { s: 5, a: 1, offset: 36 });
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "float2str".to_string() });
        self.output.instructions.push(Instruction::OrRecord { a: 20, s: 3, b: 3 });
        self.emit_branch_conditional_to(12, 2, labels[&372]); // beq
        self.output.instructions.push(Instruction::SubtractFrom { d: 25, a: 20, b: 21 });
        self.emit_branch_to(labels[&388]); // b
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 6, a: 1, offset: 16 });
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "double2hex".to_string() });
        self.output.instructions.push(Instruction::OrRecord { a: 20, s: 3, b: 3 });
        self.emit_branch_conditional_to(12, 2, labels[&372]); // beq
        self.output.instructions.push(Instruction::SubtractFrom { d: 25, a: 20, b: 21 });
        self.emit_branch_to(labels[&388]); // b
        ...
        self.record_relocation(RelocationKind::Rel24, "__va_arg");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__va_arg".to_string() });
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 3, offset: 0 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 1, immediate: 124 });
        self.output.instructions.push(Instruction::load_immediate(5, 512));
        self.record_relocation(RelocationKind::Rel24, "wcstombs");
        self.output.instructions.push(Instruction::BranchAndLink { target: "wcstombs".to_string() });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 20, a: 1, immediate: 124 });
        ...
        self.record_relocation(RelocationKind::EmbSda21, &format!("@@str{index}"));
        self.output.instructions.push(Instruction::AddImmediate { d: 20, a: 0, immediate: 0 });
        self.bind_label(labels[&305]);
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 1, offset: 111 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 1, offset: 110 });
        self.output.instructions.push(Instruction::LoadByteZero { d: 25, a: 20, offset: 0 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::CompareWord { a: 25, b: 0 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 25, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::move_register(3, 20));
        self.output.instructions.push(Instruction::load_immediate(4, 0));
        self.output.instructions.push(Instruction::move_register(5, 25));
        self.record_relocation(RelocationKind::Rel24, "memchr");
        self.output.instructions.push(Instruction::BranchAndLink { target: "memchr".to_string() });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 3, immediate: 0 });
        self.emit_branch_conditional_to(12, 2, labels[&388]); // beq
        self.output.instructions.push(Instruction::SubtractFrom { d: 25, a: 20, b: 3 });
        self.emit_branch_to(labels[&388]); // b
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 27, a: 3, offset: 0 });
        self.emit_branch_to(labels[&468]); // b
        self.bind_label(labels[&351]);
        self.output.instructions.push(Instruction::StoreHalfword { s: 27, a: 3, offset: 0 });
        self.emit_branch_to(labels[&468]); // b
        self.bind_label(labels[&353]);
        self.output.instructions.push(Instruction::StoreWord { s: 27, a: 3, offset: 0 });
        self.emit_branch_to(labels[&468]); // b
        self.bind_label(labels[&355]);
        self.output.instructions.push(Instruction::StoreWord { s: 27, a: 3, offset: 4 });
        self.output.instructions.push(Instruction::ShiftRightAlgebraicImmediate { a: 0, s: 27, shift: 31 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 1, offset: 124 });
        self.emit_branch_to(labels[&388]); // b
        self.bind_label(labels[&367]);
        self.output.instructions.push(Instruction::load_immediate(0, 37));
        self.output.instructions.push(Instruction::AddImmediate { d: 20, a: 1, immediate: 124 });
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 1, offset: 124 });
        self.output.instructions.push(Instruction::load_immediate(25, 1));
        self.emit_branch_to(labels[&388]); // b
        ...
        self.output.instructions.push(Instruction::move_register(12, 31));
        self.output.instructions.push(Instruction::move_register(3, 30));
        self.output.instructions.push(Instruction::move_register(4, 25));
        self.output.instructions.push(Instruction::MoveToCountRegister { s: 12 });
        self.output.instructions.push(Instruction::BranchToCountRegisterAndLink);
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 3, immediate: 0 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 1, offset: 108 });
        self.output.instructions.push(Instruction::move_register(19, 25));
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 0 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 1, offset: 9 });
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 20, offset: 0 });
        ...
        self.emit_branch_conditional_to(12, 2, labels[&405]); // beq
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 32 });
        self.emit_branch_conditional_to(4, 2, labels[&432]); // bne
        self.bind_label(labels[&405]);
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 1, offset: 9 });
        ...
        self.output.instructions.push(Instruction::move_register(12, 31));
        self.output.instructions.push(Instruction::move_register(3, 30));
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 1, immediate: 9 });
        self.output.instructions.push(Instruction::load_immediate(5, 1));
        self.output.instructions.push(Instruction::MoveToCountRegister { s: 12 });
        self.output.instructions.push(Instruction::BranchToCountRegisterAndLink);
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 3, immediate: 0 });
        ...
        self.output.instructions.push(Instruction::CompareWord { a: 19, b: 0 });
        ...
        self.output.instructions.push(Instruction::load_immediate(20, 32));
        self.emit_branch_to(labels[&464]); // b
        self.bind_label(labels[&452]);
        self.output.instructions.push(Instruction::move_register(12, 31));
        self.output.instructions.push(Instruction::move_register(3, 30));
        self.output.instructions.push(Instruction::StoreByte { s: 20, a: 1, offset: 8 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 708 });
        self.output.instructions.push(Instruction::MoveToLinkRegister { s: 0 });
        self.output.instructions.push(Instruction::AddImmediate { d: 1, a: 1, immediate: 704 });
