...
impl Generator {
    pub(super) fn try_pfa_long2str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                168, 180, 180, 180, 180, 180, 180, 180, 180, 180, 180, 180, 112, 180, 180, 180,
                180, 112, 180, 180, 180, 180, 180, 136, 180, 180, 180, 180, 180, 152, 180, 180,
                168,
            ],
        ...
        for target in [
            16, 18, 45, 46, 54, 58, 59, 75, 85, 88, 96, 103, 110, 121, 122, 124, 133, 138, 144, 148,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(9, 0));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 9, a: 9, b: 10 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 10, a: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 10, a: 10, b: 0 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 10, a: 10, b: 3 });
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 3, a: 3, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 8 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 6, b: 4 });
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 9, b: 3 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 3,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 7, b: 9 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 4, a: 7, b: 9 });
        self.output
            .instructions
            .push(Instruction::load_immediate(7, 48));
