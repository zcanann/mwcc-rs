...
impl Generator {
    pub(super) fn try_sfb_num2dec(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            26, 36, 41, 43, 45, 50, 52, 54, 55, 72, 77, 79, 81, 86, 88, 90, 91, 95, 97, 100, 126,
            133, 139, 144, 153, 158, 161,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 28, s: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByteRecord { a: 0, s: 28 });
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 0, s: 31 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 36));
        self.bind_label(labels[&133]);
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 28, s: 31 });
        self.output
            .instructions
            .push(Instruction::move_register(3, 30));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 5, a: 30, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 3, a: 30, b: 4 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 3,
            immediate: 48,
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 0, a: 30, b: 4 });
