...
impl Generator {
    pub(super) fn try_scc_sformatter(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            13, 17, 23, 24, 43, 64, 67, 82, 83, 94, 107, 110, 116, 119, 131, 134, 140, 143, 145,
            146, 159, 171, 184, 186, 188, 193, 194, 203, 207, 209, 211, 213, 215, 217, 218, 220,
            222, 224, 225, 238, 250, 263, 264, 274, 278, 280, 282, 284, 286, 288, 289, 291, 317,
            320, 323, 325, 326, 327, 329, 334, 339, 349, 351, 354, 367, 373, 376, 379, 394, 397,
            400, 401, 422, 424, 432, 440, 452, 458, 467, 469, 472, 496, 507, 514, 516, 518, 522,
            525, 549, 560, 561, 571, 573, 583, 587, 589, 591, 593, 595, 598, 601, 613, 614,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(18, 6));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::move_register(21, 24));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::move_register(20, 0));
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 4, a: 19, b: 4 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 0, s: 3, b: 0 });
        self.output
