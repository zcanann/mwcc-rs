//! sfp_ull2dec: an exact-match whole-function capture (fire 681).
...
const SFP_ULL2DEC_AST_HASH: u64 = 0x5ce44f06de61a77b;

impl Generator {
    pub(super) fn try_sfp_ull2dec(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != SFP_ULL2DEC_AST_HASH {
            eprintln!("sfp_ull2dec hash candidate: {hash:#x}");
            return Ok(false);
        }
