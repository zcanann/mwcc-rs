//! str_strncpy: an exact-match whole-function capture (fire 469).
...
const STR_STRNCPY_AST_HASH: u64 = 0x14a11df242e23155;

impl Generator {
    pub(super) fn try_str_strncpy(&mut self, function: &Function) -> Compilation<bool> {
