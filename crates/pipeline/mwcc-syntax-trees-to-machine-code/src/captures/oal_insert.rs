...
impl Generator {
    pub(super) fn try_oal_insert(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 0, a: 8, b: 0 });
        self.output
            .instructions
            .push(Instruction::move_register(30, 5));
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 3, b: 4 });
        self.output
            .instructions
            .push(Instruction::move_register(29, 6));
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 4, b: 4 });
        self.output
            .instructions
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__OSGetSystemTime".to_string(),
        });
        self.output.instructions.push(Instruction::LoadWord {
            d: 7,
            a: 28,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(30, 7));
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 0, a: 4, b: 8 });
        self.output
            .instructions
            .push(Instruction::move_register(29, 8));
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 5, a: 5, b: 6 });
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 5, a: 6, b: 6 });
        self.output
            .instructions
            .push(Instruction::NegateRecord { d: 5, a: 5 });
        self.emit_branch_conditional_to(12, 2, labels[&52]); // beq
        self.output.instructions.push(Instruction::LoadWord {
            d: 27,
            a: 28,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 4, a: 8, b: 4 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 26,
            a: 28,
            offset: 28,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 7, b: 3 });
        self.output
            .instructions
            .push(Instruction::move_register(5, 27));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWordUnsigned { d: 0, a: 26, b: 4 });
        self.output
            .instructions
            .push(Instruction::AddExtended { d: 6, a: 3, b: 5 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 3, a: 27, b: 4 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 5, a: 26, b: 4 });
        self.output
            .instructions
            .push(Instruction::Add { d: 4, a: 0, b: 3 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 3, a: 26, b: 6 });
        self.output
            .instructions
            .push(Instruction::AddCarrying { d: 0, a: 29, b: 5 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::AddExtended { d: 0, a: 30, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 0, a: 5, b: 29 });
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 3, b: 4 });
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 8, a: 4, b: 6 });
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 0, a: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::XorImmediateShifted {
                a: 6,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromCarrying { d: 0, a: 7, b: 8 });
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 5, a: 5, b: 6 });
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 3, b: 6 });
        self.output
            .instructions
            .push(Instruction::SubtractFromExtended { d: 3, a: 6, b: 6 });
        self.output
            .instructions
            .push(Instruction::NegateRecord { d: 3, a: 3 });
