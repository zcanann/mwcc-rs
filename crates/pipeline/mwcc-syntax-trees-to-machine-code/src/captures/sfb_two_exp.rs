...
impl Generator {
    pub(super) fn try_sfb_two_exp(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![72, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 88, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 104, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 408, 120, 408, 408, 408, 408, 408, 408, 408, 136, 152, 168, 184, 200, 216, 232, 248, 264, 280, 296, 312, 328, 344, 360, 376, 392],
            anonymous_offset: 0, // real @196 (offset TBD)
        });
        self.intern_string_literal(&[0x35, 0x34, 0x32, 0x31, 0x30, 0x31, 0x30, 0x38, 0x36, 0x32, 0x34, 0x32, 0x37, 0x35, 0x32, 0x32, 0x31, 0x37, 0x30, 0x30, 0x33, 0x37, 0x32, 0x36, 0x34, 0x30, 0x30, 0x34, 0x33, 0x34, 0x39, 0x37, 0x30, 0x38, 0x35, 0x35, 0x37, 0x31, 0x32, 0x38, 0x39, 0x30, 0x36, 0x32, 0x35]); // @175 long .data string
        self.intern_string_literal(&[0x31, 0x31, 0x31, 0x30, 0x32, 0x32, 0x33, 0x30, 0x32, 0x34, 0x36, 0x32, 0x35, 0x31, 0x35, 0x36, 0x35, 0x34, 0x30, 0x34, 0x32, 0x33, 0x36, 0x33, 0x31, 0x36, 0x36, 0x38, 0x30, 0x39, 0x30, 0x38, 0x32, 0x30, 0x33, 0x31, 0x32, 0x35]); // @176 long .data string
        self.intern_string_literal(&[0x32, 0x33, 0x32, 0x38, 0x33, 0x30, 0x36, 0x34, 0x33, 0x36, 0x35, 0x33, 0x38, 0x36, 0x39, 0x36, 0x32, 0x38, 0x39, 0x30, 0x36, 0x32, 0x35]); // @177 long .data string
        self.intern_string_literal(&[0x31, 0x35, 0x32, 0x35, 0x38, 0x37, 0x38, 0x39, 0x30, 0x36, 0x32, 0x35]); // @178 long .data string
        ...
        self.output.instructions.push(Instruction::load_immediate(5, -20));
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 5, immediate: 48 });
        self.output.instructions.push(Instruction::load_immediate(5, -16));
        self.record_relocation(RelocationKind::Rel24, "__str2dec");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__str2dec".to_string() });
        self.emit_branch_to(labels[&150]); // b
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 5, immediate: 88 });
        self.output.instructions.push(Instruction::load_immediate(5, -10));
        self.record_relocation(RelocationKind::Rel24, "__str2dec");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__str2dec".to_string() });
        self.emit_branch_to(labels[&150]); // b
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 5, immediate: 112 });
        self.output.instructions.push(Instruction::load_immediate(5, -5));
        self.record_relocation(RelocationKind::Rel24, "__str2dec");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__str2dec".to_string() });
        self.emit_branch_to(labels[&150]); // b
