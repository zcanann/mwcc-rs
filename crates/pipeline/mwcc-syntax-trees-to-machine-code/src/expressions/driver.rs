...
impl Generator {
    ...
    pub(crate) fn evaluate_general(
        ...
        match expression {
            ...
            // Constant rows fold into one r1-relative add; variable rows scale
            // by the retained source stride before adding the frame base.
            // A one-dim frame array's m[k] is a VALUE and falls through to the
            // general Index handling below.
