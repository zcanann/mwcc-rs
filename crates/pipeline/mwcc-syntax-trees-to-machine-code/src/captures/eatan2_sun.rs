//! eatan2_sun: an exact-match whole-function capture (fire 455).
...
const EATAN2_SUN_AST_HASH: u64 = 0xfdd3dfcd95cb8c62;

impl Generator {
    pub(super) fn try_eatan2_sun(&mut self, function: &Function) -> Compilation<bool> {
        ...
        let bump: u32 = match context {
            0xbd60acb658c79e45 => 51, // sunshine: pools @56 (ours @5)
            _ => return Ok(false),
        };
