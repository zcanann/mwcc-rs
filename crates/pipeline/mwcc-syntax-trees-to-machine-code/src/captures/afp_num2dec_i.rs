//! afp_num2dec_i: an exact-match whole-function capture (fire 678).
...
const AFP_NUM2DEC_I_AST_HASH: u64 = 0x682e21fab11f855e;

impl Generator {
    pub(super) fn try_afp_num2dec_i(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != AFP_NUM2DEC_I_AST_HASH {
            eprintln!("afp_num2dec_i hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0x583729950621373 => 0, // marioparty4 (bump TBD from refctx @N diff)
            _ => {
                eprintln!("afp_num2dec_i context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        for target in [21, 31, 36, 38, 40, 45, 47, 49, 50, 68, 73, 75, 77, 82, 84, 86, 87, 91, 93, 97, 112, 118, 120, 125, 129, 132, 141, 147, 149, 154, 158, 160, 161, 188, 191, 208, 218, 223, 229, 234] {
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 11, a: 1, immediate: 168 });
        self.output.instructions.push(Instruction::StoreFloatDouble { s: 31, a: 1, offset: 168 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 31, a: 30, offset: 0 });
        ...
        self.output.instructions.push(Instruction::FloatNegate { d: 0, b: 1 });
        ...
        self.output.instructions.push(Instruction::load_immediate(5, 16));
        self.output.instructions.push(Instruction::load_immediate(6, 32));
        ...
        self.output.instructions.push(Instruction::AndRecord { a: 0, s: 8, b: 3 });
        self.emit_branch_conditional_to(4, 2, labels[&118]); // bne
        self.output.instructions.push(Instruction::Add { d: 7, a: 7, b: 4 });
        self.output.instructions.push(Instruction::ShiftRightWord { a: 8, s: 8, b: 4 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 6, a: 4, b: 6 });
        ...
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 0, s: 5, shift: 31 });
        ...
        self.output.instructions.push(Instruction::ShiftRightWord { a: 3, s: 3, b: 5 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 4, a: 5, b: 4 });
        ...
        self.output.instructions.push(Instruction::load_immediate(6, 32));
        self.output.instructions.push(Instruction::move_register(4, 5));
        self.output.instructions.push(Instruction::OrImmediateShifted { a: 8, s: 0, immediate: 16 });
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 3, immediate: -1 });
        self.output.instructions.push(Instruction::load_immediate(7, 0));
        ...
        self.output.instructions.push(Instruction::SubtractFromImmediate { d: 3, a: 7, immediate: 53 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 1, offset: 16 });
        self.output.instructions.push(Instruction::ExtendSignHalfword { a: 26, s: 3 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 0, a: 26, b: 0 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 28, a: 1, offset: 100 });
        self.output.instructions.push(Instruction::Xor { a: 3, s: 26, b: 28 });
        self.output.instructions.push(Instruction::Xor { a: 0, s: 27, b: 28 });
        self.output.instructions.push(Instruction::OrRecord { a: 0, s: 3, b: 0 });
        self.emit_branch_conditional_to(4, 2, labels[&188]); // bne
        self.output.instructions.push(Instruction::load_immediate(0, 1));
        self.output.instructions.push(Instruction::StoreHalfword { s: 28, a: 1, offset: 102 });
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 1, offset: 104 });
        self.output.instructions.push(Instruction::StoreByte { s: 28, a: 1, offset: 105 });
        self.emit_branch_to(labels[&229]); // b
        self.bind_label(labels[&188]);
        self.output.instructions.push(Instruction::StoreByte { s: 28, a: 1, offset: 104 });
        self.output.instructions.push(Instruction::AddImmediate { d: 29, a: 1, immediate: 100 });
        ...
        self.output.instructions.push(Instruction::load_immediate(6, 10));
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 8, a: 1, offset: 104 });
        self.output.instructions.push(Instruction::move_register(3, 27));
        self.output.instructions.push(Instruction::load_immediate(5, 0));
        self.output.instructions.push(Instruction::load_immediate(6, 10));
        self.output.instructions.push(Instruction::AddImmediate { d: 7, a: 8, immediate: 1 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 8, immediate: 5 });
        self.output.instructions.push(Instruction::StoreByte { s: 7, a: 1, offset: 104 });
        self.output.instructions.push(Instruction::StoreByteIndexed { s: 4, a: 29, b: 0 });
        self.output.instructions.push(Instruction::move_register(4, 26));
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 3, a: 1, offset: 104 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 1, immediate: 100 });
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 1, immediate: 105 });
        ...
        self.emit_branch_conditional_to(12, 0, labels[&218]); // blt
        self.output.instructions.push(Instruction::LoadByteZero { d: 3, a: 1, offset: 104 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 3, immediate: -1 });
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 1, offset: 102 });
        self.bind_label(labels[&229]);
        self.output.instructions.push(Instruction::move_register(3, 30));
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 1, immediate: 100 });
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 1, immediate: 56 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 11, a: 1, immediate: 168 });
        self.output.instructions.push(Instruction::LoadFloatDouble { d: 31, a: 1, offset: 168 });
