...
impl Generator {
    pub(super) fn try_suac_impl_bfbb(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                740, 200, 352, 740, 424, 740, 740, 740, 504, 740, 740, 740, 740, 740, 740, 740, 504,
            ],
        ...
        for target in [
            27, 29, 37, 42, 63, 74, 86, 92, 104, 110, 121, 124, 129, 133, 144, 147, 156, 160, 162,
            165, 169, 175, 185, 191, 197, 200,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(19, 3));
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 19, b: 28 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 19, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(4, 19));
        self.output
            .instructions
