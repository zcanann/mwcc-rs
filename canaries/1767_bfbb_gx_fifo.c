...
#define SET_REG_FIELD(line, reg, size, shift, val) ((reg) = __rlwimi((reg), (val), (shift), 32-(shift)-(size), 31-(shift)))
                      ...
                      GXIndTexAlphaSel alpha_sel)
{
    ...
    ((volatile Fifo*)0xCC008000)->byte = 97;
    ((volatile Fifo*)0xCC008000)->word = reg;
