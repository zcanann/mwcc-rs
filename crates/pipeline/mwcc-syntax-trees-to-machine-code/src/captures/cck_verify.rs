...
impl Generator {
    pub(super) fn try_cck_verify(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            14, 16, 21, 37, 40, 48, 50, 69, 94, 120, 121, 124, 128, 140, 156, 159, 168, 171, 197,
            207, 209, 211, 212,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWordUnsigned { d: 7, a: 29, b: 4 });
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 0));
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 12345));
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 9, a: 30, b: 4 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 11, a: 29, b: 4 });
        self.output
            .instructions
            .push(Instruction::Add { d: 10, a: 7, b: 9 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 9, a: 29, b: 0 });
        self.output
            .instructions
            .push(Instruction::AddCarrying { d: 7, a: 11, b: 27 });
        ...
        self.output
            .instructions
            .push(Instruction::And { a: 29, s: 8, b: 6 });
        self.output
            .instructions
            .push(Instruction::And { a: 30, s: 7, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(3, -13));
        self.emit_branch_to(labels[&121]); // b
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 4, b: 3 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Nor { a: 0, s: 3, b: 3 });
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 6, b: 3 });
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZero {
                d: 3,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 3, a: 6, b: 0 });
        self.output.instructions.push(Instruction::XorImmediate {
            a: 0,
            s: 4,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 4, a: 6, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 31, b: 3 });
        self.output
            .instructions
