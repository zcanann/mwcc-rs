//! epow_ww: an exact-match whole-function capture (fire 453).
...
const EPOW_WW_AST_HASH: u64 = 0x96e8c59bc2c6c3f6;

impl Generator {
    pub(super) fn try_epow_ww(&mut self, function: &Function) -> Compilation<bool> {
