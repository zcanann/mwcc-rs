...
impl Generator {
    pub(super) fn try_mbs_mbtowc_bfbb(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [4, 8, 11, 16, 21, 32, 34, 36, 51, 53, 59, 61, 63, 65, 66, 70, 76, 81, 86, 90, 94, 98, 102, 103, 107, 110, 111] {
        ...
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 0, s: 7, shift: 0, begin: 24, end: 24 });
        self.emit_branch_conditional_to(4, 2, labels[&21]); // bne
        self.output.instructions.push(Instruction::load_immediate(5, 1));
        self.emit_branch_to(labels[&66]); // b
        self.bind_label(labels[&21]);
        self.output.instructions.push(Instruction::RotateAndMask { a: 0, s: 7, shift: 0, begin: 24, end: 26 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 4, offset: 1 });
        ...
        self.output.instructions.push(Instruction::RotateAndMask { a: 0, s: 7, shift: 0, begin: 24, end: 27 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 4, offset: 2 });
        self.output.instructions.push(Instruction::RotateAndMask { a: 0, s: 0, shift: 0, begin: 24, end: 24 });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 128 });
        self.emit_branch_conditional_to(4, 2, labels[&51]); // bne
        ...
        self.output.instructions.push(Instruction::RotateAndMask { a: 6, s: 0, shift: 6, begin: 22, end: 25 });
        self.bind_label(labels[&81]);
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 4, offset: 0 });
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 4, immediate: 1 });
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 0, clear: 26 });
        self.output.instructions.push(Instruction::Or { a: 0, s: 6, b: 0 });
        self.output.instructions.push(Instruction::RotateAndMask { a: 6, s: 0, shift: 6, begin: 16, end: 25 });
        self.bind_label(labels[&86]);
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 4, offset: 0 });
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 0, clear: 25 });
        self.output.instructions.push(Instruction::Or { a: 0, s: 6, b: 0 });
        ...
        self.output.instructions.push(Instruction::CompareWord { a: 0, b: 5 });
        ...
        self.output.instructions.push(Instruction::StoreHalfword { s: 6, a: 3, offset: 0 });
