//! mem_memcmp_mp4: an exact-match whole-function capture (fire 486).
...
const MEM_MEMCMP_MP4_AST_HASH: u64 = 0xd93277198c9ea2a2;

impl Generator {
    pub(super) fn try_mem_memcmp_mp4(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MEM_MEMCMP_MP4_AST_HASH {
            return Ok(false);
        }
