...
const SU_STRTOULL_IMPL_AST_HASH: u64 = 0x3fd7d5c87f149a4a;
...
impl Generator {
    pub(super) fn try_su_strtoull_impl(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_table = Some(mwcc_machine_code::JumpTable {
            entries: vec![880, 224, 384, 880, 456, 880, 880, 880, 536, 880, 880, 880, 880, 880, 880, 880, 536],
        ...
        for target in [28, 30, 38, 48, 71, 82, 94, 100, 112, 118, 129, 132, 137, 150, 163, 166, 173, 177, 179, 182, 189, 207, 220, 226, 232, 233] {
        ...
        self.output.instructions.push(Instruction::move_register(18, 8));
        self.output.instructions.push(Instruction::move_register(19, 4));
        ...
        self.output.instructions.push(Instruction::move_register(17, 7));
        ...
        self.output.instructions.push(Instruction::CompareWord { a: 29, b: 19 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 29, a: 17, offset: 0 });
