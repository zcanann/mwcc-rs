...
impl Generator {
    pub(super) fn try_cst_updateicon(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [9, 18, 23, 28, 31, 37, 46, 50, 53, 54, 64, 68, 71, 72, 81, 83] {
            labels.insert(target, self.fresh_label());
        }
        self.output.instructions.push(Instruction::LoadWord { d: 8, a: 3, offset: 44 });
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 0, a: 8, immediate: 1 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 4, offset: 46 });
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 4, offset: 52 });
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 4, offset: 54 });
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 0, clear: 30 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 4, offset: 60 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 8, immediate: 3072 });
        self.output.instructions.push(Instruction::AddImmediate { d: 8, a: 8, immediate: 3584 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 4, offset: 64 });
        self.emit_branch_to(labels[&31]); // b
        self.bind_label(labels[&23]);
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 4, offset: 60 });
        self.output.instructions.push(Instruction::load_immediate(0, -1));
        self.output.instructions.push(Instruction::AddImmediate { d: 8, a: 8, immediate: 6144 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 4, offset: 64 });
        self.emit_branch_to(labels[&31]); // b
        self.bind_label(labels[&28]);
        self.output.instructions.push(Instruction::load_immediate(0, -1));
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 4, offset: 60 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 4, offset: 64 });
        ...
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 0, a: 3, offset: 48 });
        self.output.instructions.push(Instruction::ShiftRightAlgebraicWord { a: 0, s: 0, b: 6 });
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 0, clear: 30 });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 2 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 7, offset: 68 });
        self.output.instructions.push(Instruction::load_immediate(9, 1));
        self.output.instructions.push(Instruction::AddImmediate { d: 8, a: 8, immediate: 1024 });
        self.emit_branch_to(labels[&54]); // b
        self.bind_label(labels[&50]);
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 7, offset: 68 });
        self.output.instructions.push(Instruction::AddImmediate { d: 8, a: 8, immediate: 2048 });
        self.emit_branch_to(labels[&54]); // b
        self.bind_label(labels[&53]);
        self.output.instructions.push(Instruction::StoreWord { s: 5, a: 7, offset: 68 });
        self.bind_label(labels[&54]);
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 0, a: 3, offset: 48 });
        self.output.instructions.push(Instruction::AddImmediate { d: 6, a: 6, immediate: 2 });
        self.output.instructions.push(Instruction::ShiftRightAlgebraicWord { a: 0, s: 0, b: 6 });
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 0, clear: 30 });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 2 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 7, offset: 72 });
        self.output.instructions.push(Instruction::load_immediate(9, 1));
        self.output.instructions.push(Instruction::AddImmediate { d: 8, a: 8, immediate: 1024 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 5, a: 7, offset: 72 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 4, offset: 100 });
        self.output.instructions.push(Instruction::AddImmediate { d: 8, a: 8, immediate: 512 });
        self.emit_branch_to(labels[&83]); // b
        self.bind_label(labels[&81]);
        self.output.instructions.push(Instruction::load_immediate(0, -1));
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 4, offset: 100 });
        self.bind_label(labels[&83]);
        self.output.instructions.push(Instruction::StoreWord { s: 8, a: 4, offset: 104 });
