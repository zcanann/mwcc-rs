...
impl Generator {
    pub(super) fn try_cck_verifyid(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 29, a: 3, offset: 128 });
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 0, a: 29, offset: 32 });
        ...
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 3, a: 29, offset: 34 });
        ...
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 4, a: 3, offset: 0 });
        ...
        self.output.instructions.push(Instruction::Add { d: 0, a: 6, b: 0 });
        ...
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 6, immediate: 65535 });
        self.emit_branch_conditional_to(4, 2, labels[&42]); // bne
        self.output.instructions.push(Instruction::load_immediate(6, 0));
        self.bind_label(labels[&42]);
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 3, a: 29, offset: 508 });
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 5, clear: 16 });
        self.output.instructions.push(Instruction::CompareLogicalWord { a: 3, b: 0 });
        self.emit_branch_conditional_to(4, 2, labels[&50]); // bne
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 3, a: 29, offset: 510 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 31, a: 29, offset: 12 });
        self.output.instructions.push(Instruction::LoadWord { d: 30, a: 29, offset: 16 });
        ...
        self.output.instructions.push(Instruction::MultiplyHighWordUnsigned { d: 7, a: 30, b: 4 });
        self.output.instructions.push(Instruction::load_immediate(0, 0));
        self.output.instructions.push(Instruction::load_immediate(28, 12345));
        ...
        self.output.instructions.push(Instruction::MultiplyLow { d: 9, a: 31, b: 4 });
        self.output.instructions.push(Instruction::MultiplyLow { d: 11, a: 30, b: 4 });
        self.output.instructions.push(Instruction::Add { d: 10, a: 7, b: 9 });
        self.output.instructions.push(Instruction::MultiplyLow { d: 9, a: 30, b: 0 });
        self.output.instructions.push(Instruction::AddCarrying { d: 7, a: 11, b: 28 });
        ...
        self.output.instructions.push(Instruction::And { a: 30, s: 8, b: 6 });
        self.output.instructions.push(Instruction::And { a: 31, s: 7, b: 0 });
        ...
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 5, a: 29, offset: 36 });
        ...
        self.output.instructions.push(Instruction::SubtractFrom { d: 4, a: 3, b: 5 });
        ...
        self.output.instructions.push(Instruction::And { a: 3, s: 0, b: 3 });
