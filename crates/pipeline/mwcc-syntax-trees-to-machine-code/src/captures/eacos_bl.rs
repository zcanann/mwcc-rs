//! eacos_bl: the sqrt-extern variant of __ieee754_acos (two real bl
//! sqrt calls, callee-saved f31, 48-byte frame) — BfBB/pikmin2's
//! context (see easin_bl for the pattern).
...
/// Skipped-set fingerprints -> measured @N bumps for the known contexts.
/// (pikmin2's e_acos is decompctx-blocked — no measured bump, so its
/// context is NOT registered and defers honestly.)
const CONTEXT_BFBB: u64 = 0xb61776ae26f47f0e;

impl Generator {
    pub(super) fn try_eacos_bl(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if super::ast_hash(function) != super::eacos::EACOS_AST_HASH {
            return Ok(false);
        }
        let context = super::skipped_context_fingerprint(&self.skipped_inline_names);
        let bump = match context {
            CONTEXT_BFBB => 20, // pools @45 (ours @25 unbumped)
            _ => return Ok(false),
        };
        ...
        self.output.instructions.push(Instruction::FloatAddDouble { d: 0, a: 0, b: 1 });
        self.output.instructions.push(Instruction::FloatMultiplyDouble { d: 31, a: 2, c: 0 });
        ...
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 4, a: 3, c: 31, b: 2 });
        ...
        self.load_double_constant(7, 0xbfd4d61203eb6f7d);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 8, a: 31, c: 4, b: 0 });
        self.load_double_constant(0, 0x40002ae59c598ac8);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 2, a: 3, c: 31, b: 2 });
        self.load_double_constant(6, 0x3fc5555555555555);
        self.load_double_constant(4, 0xc0033a271c8a2d4b);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 8, a: 31, c: 8, b: 5 });
        self.load_double_constant(3, 0x3ff0000000000000);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 5, a: 31, c: 2, b: 0 });
        self.load_double_constant(2, 0x3c91a62633145c07);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 7, a: 31, c: 8, b: 7 });
        ...
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 5, a: 31, c: 7, b: 6 });
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 3, a: 31, c: 4, b: 3 });
        self.output.instructions.push(Instruction::FloatMultiplyDouble { d: 4, a: 31, c: 5 });
        self.output.instructions.push(Instruction::FloatDivideDouble { d: 3, a: 4, b: 3 });
        self.output.instructions.push(Instruction::FloatMultiplySubtractDouble { d: 2, a: 3, c: 1, b: 2 });
        self.output.instructions.push(Instruction::FloatAddDouble { d: 1, a: 1, b: 2 });
        self.output.instructions.push(Instruction::FloatNegativeMultiplySubtractDouble { d: 1, a: 8, c: 1, b: 0 });
        self.emit_branch_to(labels[&137]); // b
        ...
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 3, a: 2, c: 31, b: 0 });
        self.load_double_constant(0, 0xbfa48228b5688f3b);
        ...
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 5, a: 31, c: 3, b: 0 });
        self.load_double_constant(4, 0x3fb3b8c5b12e9282);
        self.load_double_constant(0, 0xbfe6066c1b8d0159);
        self.output.instructions.push(Instruction::FloatNegativeMultiplySubtractDouble { d: 3, a: 9, c: 9, b: 31 });
        self.load_double_constant(7, 0xbfd4d61203eb6f7d);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 8, a: 31, c: 5, b: 2 });
        self.load_double_constant(2, 0x40002ae59c598ac8);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 5, a: 4, c: 31, b: 0 });
        self.load_double_constant(6, 0x3fc5555555555555);
        self.load_double_constant(0, 0xc0033a271c8a2d4b);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 7, a: 31, c: 8, b: 7 });
        self.load_double_constant(4, 0x3ff0000000000000);
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 5, a: 31, c: 5, b: 2 });
        ...
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 5, a: 31, c: 5, b: 0 });
        self.output.instructions.push(Instruction::FloatAddDouble { d: 0, a: 1, b: 9 });
        self.output.instructions.push(Instruction::FloatMultiplyDouble { d: 6, a: 31, c: 6 });
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 4, a: 31, c: 5, b: 4 });
        self.output.instructions.push(Instruction::FloatDivideDouble { d: 0, a: 3, b: 0 });
        self.output.instructions.push(Instruction::FloatDivideDouble { d: 3, a: 6, b: 4 });
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 0, a: 3, c: 1, b: 0 });
        self.output.instructions.push(Instruction::FloatAddDouble { d: 0, a: 9, b: 0 });
