...
impl Generator {
    pub(super) fn try_ivt_atan2f(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::RoundToSingle { d: 0, b: 2 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatCompareUnordered { a: 2, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatDivideSingle { d: 1, a: 0, b: 2 });
        self.record_relocation(RelocationKind::Rel24, "atanf");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "atanf".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::FloatAddSingle { d: 1, a: 0, b: 1 });
        self.emit_branch_to(labels[&50]); // b
