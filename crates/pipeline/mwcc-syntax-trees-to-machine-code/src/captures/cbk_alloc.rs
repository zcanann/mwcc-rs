...
impl Generator {
    pub(super) fn try_cbk_alloc(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(3, -9));
        self.emit_branch_to(labels[&63]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(6, 1));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(10, 5));
        ...
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 0, a: 9, b: 7 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::StoreHalfwordIndexed { s: 10, a: 9, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(12, 10));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 6,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::StoreHalfwordIndexed { s: 0, a: 9, b: 7 });
