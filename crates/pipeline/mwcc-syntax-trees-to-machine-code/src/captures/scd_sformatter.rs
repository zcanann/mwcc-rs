...
impl Generator {
    pub(super) fn try_scd_sformatter(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.frame_size = 144;
        self.non_leaf = true;
        for bits in [0x4330000080000000u64] {
            self.output.intern_constant(bits, 8);
        }
        let mut labels: std::collections::HashMap<usize, mwcc_vreg::Label> =
            std::collections::HashMap::new();
        for target in [
            15, 21, 28, 29, 48, 69, 72, 87, 88, 99, 112, 115, 121, 124, 136, 139, 145, 148, 150,
            151, 164, 176, 189, 191, 193, 198, 199, 208, 212, 214, 216, 218, 220, 222, 223, 225,
            227, 229, 230, 243, 255, 268, 269, 279, 283, 285, 287, 289, 291, 293, 294, 296, 322,
            325, 328, 330, 331, 332, 334, 339, 344, 354, 356, 359, 372, 378, 381, 384, 399, 402,
            404, 407, 408, 429, 431, 441, 449, 460, 466, 475, 477, 480, 504, 515, 522, 524, 526,
            530, 533, 557, 568, 569, 579, 581, 591, 595, 597, 599, 601, 603, 606, 609, 621, 622,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(17, 6));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 0, a: 18, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 0, a: 16, b: 0 });
        self.output
            .instructions
            .push(Instruction::RotateAndMaskRecord {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 4, s: 4 });
        self.output
            .instructions
            .push(Instruction::MoveToCountRegister { s: 12 });
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 4, s: 3 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(16, 10));
        self.emit_branch_to(labels[&151]); // b
        self.bind_label(labels[&150]);
        self.output
            .instructions
            .push(Instruction::load_immediate(16, 0));
        ...
        self.output
            .instructions
            .push(Instruction::move_register(3, 16));
        self.output
            .instructions
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "__strtoull".to_string(),
        });
        self.output
            .instructions
            .push(Instruction::move_register(23, 3));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 29, a: 29, b: 0 });
        self.output
            .instructions
            .push(Instruction::CompareLogicalWordImmediate { a: 4, immediate: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromZeroExtended { d: 0, a: 24 });
        self.emit_branch_to(labels[&191]); // b
        self.bind_label(labels[&189]);
        self.output
            .instructions
            .push(Instruction::move_register(21, 23));
        self.output
            .instructions
            .push(Instruction::move_register(0, 24));
        self.bind_label(labels[&191]);
        self.output
            .instructions
            .push(Instruction::move_register(19, 0));
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 3, a: 25 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(16, 8));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(16, 16));
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 29, a: 29, b: 3 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate { a: 0, immediate: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromZeroExtended { d: 24, a: 24 });
        self.emit_branch_to(labels[&269]); // b
        self.bind_label(labels[&268]);
        self.output
            .instructions
            .push(Instruction::Negate { d: 25, a: 25 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 7 });
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 4, s: 0 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 4,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 4, a: 16, b: 4 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 4, a: 20, b: 4 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 0, s: 3, b: 0 });
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByteRecord { a: 16, s: 0 });
