...
impl Generator {
    pub(super) fn try_mth_frexp(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 4, a: 3, offset: 0 });
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 4, s: 5, clear: 1 });
        ...
        self.output.instructions.push(Instruction::OrRecord { a: 0, s: 4, b: 6 });
        ...
        self.output.instructions.push(Instruction::load_immediate(0, -54));
        ...
        self.output.instructions.push(Instruction::RotateAndMask { a: 0, s: 5, shift: 0, begin: 12, end: 0 });
        self.output.instructions.push(Instruction::LoadWord { d: 5, a: 3, offset: 0 });
        self.output.instructions.push(Instruction::ShiftRightAlgebraicImmediate { a: 4, s: 4, shift: 20 });
        self.output.instructions.push(Instruction::OrImmediateShifted { a: 0, s: 0, immediate: 16352 });
