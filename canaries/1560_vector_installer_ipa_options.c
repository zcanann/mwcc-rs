...
// flags: -sym on -Cpp_exceptions off -ipa file -pragma "cats off"
/* The SDK command-line catalog option isolates IPA debug numbering. */
...
void install_ipa_option_vector(void) {
