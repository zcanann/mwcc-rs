...
impl Generator {
    pub(super) fn try_sup2_strtoull_impl(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                924, 228, 388, 924, 460, 924, 924, 924, 540, 924, 924, 924, 924, 924, 924, 924, 540,
            ],
        ...
        for target in [
            29, 31, 39, 49, 72, 83, 95, 101, 113, 119, 130, 133, 138, 151, 164, 167, 173, 176, 179,
            183, 185, 189, 192, 193, 200, 218, 231, 237, 244, 247,
        ] {
