...
impl Generator {
    pub(super) fn try_dio_fread_impl_str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [17, 25, 27, 36, 47, 57, 69, 77, 91, 99, 110, 116, 123, 139, 146, 148, 153, 171, 192, 199, 207, 208] {
        ...
        self.output.instructions.push(Instruction::move_register(25, 5));
        ...
        self.output.instructions.push(Instruction::MultiplyLowRecord { d: 29, a: 26, b: 25 });
        self.emit_branch_conditional_to(12, 2, labels[&25]); // beq
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 27, offset: 10 });
        ...
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 0, a: 27, offset: 4 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 3, a: 27, offset: 8 });
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 0, s: 3, shift: 27, begin: 29, end: 31 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 3, a: 27, offset: 8 });
        self.output.instructions.push(Instruction::load_immediate(0, 0));
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 40 });
        self.bind_label(labels[&47]);
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 27, offset: 8 });
        ...
        self.output.instructions.push(Instruction::load_immediate(0, 0));
        self.output.instructions.push(Instruction::StoreByte { s: 3, a: 27, offset: 10 });
        self.output.instructions.push(Instruction::load_immediate(3, 0));
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 40 });
        self.emit_branch_to(labels[&208]); // b
        self.bind_label(labels[&57]);
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 27, offset: 4 });
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 0, s: 0, shift: 31, begin: 31, end: 31 });
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "__flush_line_buffered_output_files".to_string() });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 3, immediate: 0 });
        self.emit_branch_conditional_to(12, 2, labels[&69]); // beq
        self.output.instructions.push(Instruction::load_immediate(3, 1));
        self.output.instructions.push(Instruction::load_immediate(0, 0));
        ...
        self.output.instructions.push(Instruction::move_register(30, 28));
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 29, a: 29, immediate: -2 });
        self.output.instructions.push(Instruction::RotateAndMask { a: 3, s: 0, shift: 28, begin: 28, end: 30 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 3, immediate: 12 });
        self.output.instructions.push(Instruction::LoadHalfwordZeroIndexed { d: 0, a: 27, b: 0 });
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 30, offset: 0 });
        ...
        self.output.instructions.push(Instruction::RotateAndMask { a: 3, s: 0, shift: 27, begin: 29, end: 31 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 3, immediate: 12 });
        self.output.instructions.push(Instruction::LoadByteZeroIndexed { d: 0, a: 27, b: 0 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 4, a: 27, offset: 8 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 29, immediate: 0 });
        self.output.instructions.push(Instruction::RotateAndMask { a: 3, s: 4, shift: 27, begin: 29, end: 31 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 4, a: 27, offset: 8 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 27, offset: 48 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 40 });
        self.bind_label(labels[&116]);
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 29, immediate: 0 });
        self.emit_branch_conditional_to(12, 2, labels[&171]); // beq
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 27, offset: 40 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 0 });
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "__load_buffer".to_string() });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 3, immediate: 0 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 3, a: 27, offset: 8 });
        self.output.instructions.push(Instruction::load_immediate(4, 0));
        self.output.instructions.push(Instruction::RotateAndMaskInsert { a: 3, s: 4, shift: 5, begin: 24, end: 26 });
        self.output.instructions.push(Instruction::load_immediate(0, 1));
        self.output.instructions.push(Instruction::StoreByte { s: 3, a: 27, offset: 8 });
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 27, offset: 9 });
        self.output.instructions.push(Instruction::StoreWord { s: 4, a: 27, offset: 40 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 27, offset: 36 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 27, offset: 36 });
        self.output.instructions.push(Instruction::SubtractFromRecord { d: 29, a: 3, b: 29 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 36 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 1, offset: 8 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 27, offset: 40 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 31, a: 27, offset: 28 });
        self.output.instructions.push(Instruction::move_register(3, 27));
        self.output.instructions.push(Instruction::LoadWord { d: 25, a: 27, offset: 32 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 30, a: 27, offset: 28 });
        self.output.instructions.push(Instruction::StoreWord { s: 29, a: 27, offset: 32 });
        self.record_relocation(RelocationKind::Rel24, "__load_buffer");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__load_buffer".to_string() });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 3, immediate: 0 });
        ...
        self.output.instructions.push(Instruction::move_register(3, 27));
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 27, offset: 28 });
        self.output.instructions.push(Instruction::Add { d: 28, a: 28, b: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 25, a: 27, offset: 32 });
        ...
        self.output.instructions.push(Instruction::DivideWordUnsigned { d: 3, a: 28, b: 26 });
