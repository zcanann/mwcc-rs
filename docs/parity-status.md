...
Latest targeted checkpoint: 2026-07-24 02:47 UTC at compiler commit `74f9ee38`
...
Post-holdout compiler work through commit `74f9ee38` has not been run over a
...
relocation-aware parity from 28/109 to 61/109 functions and from 996/15,340 to
4,352/15,340 reference code bytes. Paired movement was +33/-0 functions and
+3,356 exact bytes. The gains were `ftCommon_ClampAirDrift`, `ftCommon_FallBasic`,
...
`ftCommon_ApplyGroundMovement` exact. This is evidence of local forward
