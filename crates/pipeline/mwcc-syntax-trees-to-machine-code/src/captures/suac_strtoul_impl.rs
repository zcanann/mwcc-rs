//! suac_strtoul_impl: an exact-match whole-function capture (fire 462).
...
const SUAC_STRTOUL_IMPL_AST_HASH: u64 = 0xfdc0a076e68813b;
/// Cosmetic AST variants with IDENTICAL instruction streams (content-diffed): ww f503.
const SUAC_STRTOUL_IMPL_AST_HASHES: &[u64] = &[SUAC_STRTOUL_IMPL_AST_HASH, 0x8be0e0a83e1e698a];

impl Generator {
    pub(super) fn try_suac_strtoul_impl(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if !SUAC_STRTOUL_IMPL_AST_HASHES.contains(&hash) {
            return Ok(false);
        }
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                788, 200, 360, 788, 432, 788, 788, 788, 512, 788, 788, 788, 788, 788, 788, 788, 512,
            ],
            anonymous_offset: 80, // measured: table @85 (ours @5 unadjusted)
        });
        let mut labels: std::collections::HashMap<usize, mwcc_vreg::Label> =
            std::collections::HashMap::new();
        for target in [
            27, 29, 37, 42, 65, 76, 88, 94, 106, 112, 123, 126, 131, 135, 148, 151, 157, 160, 163,
            167, 169, 173, 176, 177, 181, 187, 197, 203, 209, 212,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(24, 9));
        self.output
            .instructions
            .push(Instruction::move_register(21, 8));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::move_register(20, 7));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 64));
        ...
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 26, a: 0, b: 29 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 4));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 8));
        self.emit_branch_to(labels[&197]); // b
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(29, 16));
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 8));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(29, 8));
        self.bind_label(labels[&126]);
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 16));
        self.emit_branch_to(labels[&197]); // b
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(29, 10));
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 4, b: 29 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 32));
        self.emit_branch_to(labels[&197]); // b
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 27, b: 26 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 27, a: 27, b: 4 });
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 16));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 31, b: 22 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 31, b: 23 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 3,
            immediate: -1,
