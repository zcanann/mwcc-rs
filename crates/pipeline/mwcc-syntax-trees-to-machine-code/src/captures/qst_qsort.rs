...
impl Generator {
    pub(super) fn try_qst_qsort(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 3, s: 4, shift: 1 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 4, immediate: -1 });
        self.output.instructions.push(Instruction::AddImmediate { d: 28, a: 3, immediate: 1 });
        self.output.instructions.push(Instruction::move_register(27, 4));
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 28, immediate: -1 });
        self.output.instructions.push(Instruction::MultiplyLow { d: 3, a: 30, b: 3 });
        self.output.instructions.push(Instruction::MultiplyLow { d: 0, a: 30, b: 0 });
        self.output.instructions.push(Instruction::Add { d: 25, a: 29, b: 3 });
        self.output.instructions.push(Instruction::Add { d: 24, a: 29, b: 0 });
        self.bind_label(labels[&19]);
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 28, immediate: 1 });
        self.emit_branch_conditional_to(4, 1, labels[&24]); // ble
        self.output.instructions.push(Instruction::SubtractFrom { d: 25, a: 30, b: 25 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 24, immediate: -1 });
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 25, immediate: -1 });
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 30, immediate: 1 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 6, a: 3, offset: 1 });
        ...
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 27, immediate: 1 });
        self.emit_branch_conditional_to(12, 2, labels[&87]); // beq
        self.output.instructions.push(Instruction::SubtractFrom { d: 24, a: 30, b: 24 });
        self.bind_label(labels[&41]);
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 28, immediate: -1 });
        self.output.instructions.push(Instruction::move_register(26, 28));
        self.output.instructions.push(Instruction::MultiplyLow { d: 0, a: 30, b: 0 });
        self.output.instructions.push(Instruction::Add { d: 22, a: 29, b: 0 });
        self.emit_branch_to(labels[&83]); // b
        self.bind_label(labels[&46]);
        self.output.instructions.push(Instruction::ShiftLeftImmediate { a: 26, s: 26, shift: 1 });
        self.output.instructions.push(Instruction::move_register(23, 22));
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 26, immediate: -1 });
        self.output.instructions.push(Instruction::MultiplyLow { d: 0, a: 30, b: 0 });
        self.output.instructions.push(Instruction::CompareLogicalWord { a: 26, b: 27 });
        self.output.instructions.push(Instruction::Add { d: 22, a: 29, b: 0 });
        self.emit_branch_conditional_to(4, 0, labels[&63]); // bge
        self.output.instructions.push(Instruction::Add { d: 21, a: 22, b: 30 });
        ...
        self.emit_branch_conditional_to(4, 0, labels[&63]); // bge
        self.output.instructions.push(Instruction::move_register(22, 21));
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 22, immediate: -1 });
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 23, immediate: -1 });
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 30, immediate: 1 });
        ...
        self.output.instructions.push(Instruction::ShiftLeftImmediate { a: 0, s: 26, shift: 1 });
