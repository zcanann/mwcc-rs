...
impl Generator {
    pub(super) fn try_krem_p2(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            25, 38, 42, 48, 53, 56, 72, 122, 131, 139, 142, 156, 167, 203, 204, 222, 252, 259, 264,
            274, 283, 285, 287, 295, 302, 308, 317, 331, 351, 352, 356, 360, 361, 372, 398, 448,
            456, 464, 467, 471, 480, 483, 487, 521, 527, 545, 586, 587, 599, 608, 613, 620, 624,
            628, 635, 644, 664, 665, 669, 672, 673, 675, 684, 704, 705, 709, 713, 714, 729, 748,
            756, 760, 763, 764, 766, 775, 806, 807, 815, 822, 853, 854, 862, 869, 889, 890, 894,
            902, 910,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(9, 10923));
        self.output
            .instructions
            .push(Instruction::move_register(23, 7));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 5,
            immediate: -3,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(10, 0));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 7,
            a: 9,
            immediate: -21845,
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWord { d: 0, a: 7, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 28, a: 7, b: 9 });
        self.output
            .instructions
            .push(Instruction::move_register(21, 3));
        self.output
            .instructions
            .push(Instruction::move_register(22, 4));
        self.output
            .instructions
            .push(Instruction::move_register(24, 8));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::AddRecord { d: 29, a: 0, b: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::AddRecord { d: 7, a: 30, b: 28 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 6, a: 30, b: 29 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 26, a: 4, b: 5 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 7,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 4, a: 24, b: 3 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 5,
            a: 1,
            immediate: 408,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate { a: 0, immediate: 8 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 30, b: 7 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 1,
            immediate: 408,
        ...
        self.output
            .instructions
            .push(Instruction::MoveToCountRegister { s: 8 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 8, a: 6, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 9,
            a: 6,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 0, a: 3, b: 10 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 9, a: 9, b: 0 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftImmediate {
                a: 10,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 9, a: 8, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 8,
            a: 6,
            immediate: 3,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 8, a: 8, b: 0 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplyAddDouble {
                d: 4,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 0, a: 3, b: 9 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 8,
            a: 6,
            immediate: 4,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 2, a: 3, b: 9 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 6,
            a: 6,
            immediate: 8,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 0, a: 3, b: 8 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 4,
            a: 4,
            immediate: 64,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 6, b: 0 });
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 30, b: 7 });
        self.output
            .instructions
            .push(Instruction::Add { d: 4, a: 21, b: 3 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 1,
            immediate: 408,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 6, b: 30 });
        self.emit_branch_conditional_to(12, 1, labels[&139]); // bgt
        self.bind_label(labels[&131]);
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 6, b: 8 });
        self.output.instructions.push(Instruction::LoadFloatDouble {
            d: 1,
            a: 4,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 7, b: 28 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(19, 17200));
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 5, b: 0 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 31,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(4, 16));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 3, a: 26, c: 1 });
        self.output.instructions.push(Instruction::StoreWord {
            s: 19,
            a: 1,
            offset: 576,
        ...
        self.output
            .instructions
            .push(Instruction::ConvertToIntegerWordZero { d: 2, b: 3 });
        self.output
            .instructions
            .push(Instruction::StoreFloatDouble {
                s: 2,
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 3, a: 2, b: 27 });
        self.output.instructions.push(Instruction::StoreWord {
            s: 19,
            a: 1,
            offset: 576,
        ...
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 1, a: 3, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatMove { d: 25, b: 1 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 1, a: 29, c: 25 });
        self.record_relocation(RelocationKind::Rel24, "floor");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "floor".to_string(),
        });
        self.output
            .instructions
            .push(Instruction::FloatNegativeMultiplySubtractDouble {
        ...
        self.output
            .instructions
            .push(Instruction::ConvertToIntegerWordZero { d: 0, b: 25 });
        self.output
            .instructions
            .push(Instruction::StoreFloatDouble {
                s: 0,
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 0, a: 0, b: 27 });
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 25, a: 25, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 3, a: 4, b: 5 });
        self.output
            .instructions
            .push(Instruction::ShiftRightAlgebraicWord { a: 6, s: 3, b: 18 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 0, s: 6, b: 18 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 0, b: 3 });
        self.output
            .instructions
            .push(Instruction::Add { d: 27, a: 27, b: 6 });
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 0, a: 4, b: 5 });
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 0, a: 4, b: 5 });
        self.output
            .instructions
            .push(Instruction::ShiftRightAlgebraicWord { a: 25, s: 0, b: 17 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatCompareOrdered { a: 25, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(25, 2));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(5, 256));
        self.output
            .instructions
            .push(Instruction::move_register(6, 16));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::MoveToCountRegister { s: 31 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 31,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 3, b: 5 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 3, a: 5, b: 4 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 3, a: 5, b: 4 });
        self.emit_branch_to(labels[&308]); // b
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 25, a: 1, b: 25 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 25, a: 25, b: 1 });
        self.bind_label(labels[&317]);
        self.output
            .instructions
            .push(Instruction::FloatCompareUnordered { a: 31, b: 25 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 3, b: 28 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 28, b: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::Or { a: 5, s: 5, b: 0 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 0,
            a: 4,
            offset: -4,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 10, b: 28 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 0, a: 16, b: 0 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate { a: 0, immediate: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 31, b: 10 });
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 5, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 29, b: 9 });
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 30, b: 9 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 3, a: 24, b: 0 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 30,
        ...
        self.output
            .instructions
            .push(Instruction::StoreFloatDoubleIndexed { s: 0, a: 20, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 11, a: 8, b: 7 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 8,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 0, a: 3, b: 12 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 0, b: 7 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 11,
            a: 8,
            immediate: 2,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 12, a: 11, b: 7 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 11, a: 11, b: 7 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftImmediate {
                a: 12,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 0, a: 3, b: 25 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 11, a: 0, b: 7 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 8,
            immediate: 5,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 2, a: 3, b: 11 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 4, a: 21, b: 4 });
        self.output
            .instructions
            .push(Instruction::MoveToCountRegister { s: 0 });
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 8, b: 30 });
        self.emit_branch_conditional_to(12, 1, labels[&464]); // bgt
        self.bind_label(labels[&456]);
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 8, b: 7 });
        self.output.instructions.push(Instruction::LoadFloatDouble {
            d: 1,
            a: 4,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::FloatCompareUnordered { a: 0, b: 25 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatMove { d: 1, b: 25 });
        self.output
            .instructions
            .push(Instruction::Negate { d: 3, a: 26 });
        self.record_relocation(RelocationKind::Rel24, "ldexp");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "ldexp".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::FloatCompareOrdered { a: 1, b: 3 });
        self.output
            .instructions
            .push(Instruction::ConditionRegisterOr { d: 2, a: 1, b: 2 });
        ...
        self.output
            .instructions
            .push(Instruction::ConvertToIntegerWordZero { d: 1, b: 1 });
        self.output
            .instructions
            .push(Instruction::StoreFloatDouble {
                s: 0,
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 6, a: 4, b: 5 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 6, b: 0 });
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 7, b: 8 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 31,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 3, a: 4, b: 5 });
        self.output
            .instructions
            .push(Instruction::XorImmediateShifted {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 2, a: 1, c: 3 });
        self.output.instructions.push(Instruction::LoadFloatDouble {
            d: 4,
            a: 1,
            offset: 592,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 7, a: 9, b: 31 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 9, b: 10 });
        self.output.instructions.push(Instruction::LoadFloatDouble {
            d: 1,
            a: 6,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 0, a: 4, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 10,
            a: 10,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 10, b: 28 });
        self.emit_branch_conditional_to(12, 1, labels[&624]); // bgt
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 10, b: 7 });
        ...
        self.output
            .instructions
            .push(Instruction::StoreFloatDoubleIndexed { s: 2, a: 3, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 6, a: 0, b: 2 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 6, a: 6, b: 1 });
        self.output.instructions.push(Instruction::LoadFloatDouble {
            d: 5,
            a: 4,
            offset: 16,
        ...
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 6, a: 6, b: 0 });
        self.output.instructions.push(Instruction::LoadFloatDouble {
            d: 2,
            a: 4,
            offset: 40,
        ...
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 6, a: 6, b: 5 });
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 6, a: 6, b: 4 });
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 6, a: 6, b: 3 });
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 6, a: 6, b: 2 });
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 6, a: 6, b: 1 });
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 5, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 5, b: 31 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatNegate { d: 6, b: 6 });
        ...
        self.output
            .instructions
            .push(Instruction::StoreFloatDoubleWithUpdate {
                s: 2,
                a: 4,
                offset: -32,
            });
        ...
        self.output
            .instructions
            .push(Instruction::FloatAddDouble { d: 3, a: 3, b: 0 });
        self.output.instructions.push(Instruction::LoadFloatDouble {
            d: 0,
            a: 5,
            offset: -8,
        ...
        self.output
            .instructions
            .push(Instruction::FloatNegate { d: 0, b: 3 });
        self.output.instructions.push(Instruction::LoadFloatDouble {
            d: 1,
            a: 1,
            offset: 256,
