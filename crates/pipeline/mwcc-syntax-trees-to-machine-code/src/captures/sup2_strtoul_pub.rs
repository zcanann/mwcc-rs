//! sup2_strtoul_pub: an exact-match whole-function capture (fire 463).
...
const SUP2_STRTOUL_PUB_AST_HASH: u64 = 0x51dd3e801ae5ef5b;

impl Generator {
    pub(super) fn try_sup2_strtoul_pub(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != SUP2_STRTOUL_PUB_AST_HASH {
            return Ok(false);
        }
