...
impl Generator {
    pub(super) fn try_mfp_dec2num(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            17, 18, 20, 27, 30, 36, 37, 39, 46, 47, 49, 60, 68, 75, 82, 89, 93, 96, 98, 101, 108,
            110, 115, 121, 123, 155, 183, 184, 189, 208, 217, 223, 251, 252, 257, 271, 273, 275,
            290, 301, 315, 320, 322, 324, 329, 331, 333, 334, 344, 350, 355, 364, 368, 375, 380,
            386, 394, 397, 405, 407, 412, 422, 428, 434, 438, 442, 450, 455, 457, 459, 464, 469,
            485, 487, 492, 502, 508, 514, 518, 522, 530, 535, 537, 539, 544, 561, 566, 568, 570,
            575, 577, 579, 580, 584, 591, 627, 632, 634, 636, 641, 643, 645, 646, 650, 653, 661,
            663, 668, 678, 684, 690, 694, 698, 706, 711, 714, 716, 721, 748, 756, 758, 763, 773,
            779, 785, 789, 793, 801, 806, 808, 810, 815, 819, 830, 860, 868, 870, 875, 885, 891,
            897, 901, 905, 913, 918, 921, 923, 928, 955, 963, 965, 970, 980, 986, 992, 996, 1000,
            1008, 1013, 1015, 1017, 1022, 1025, 1031, 1032,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(29, 31));
        self.output.instructions.push(Instruction::StoreWord {
            s: 0,
            a: 1,
            offset: 404,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 31, b: 0 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 10,
            a: 3,
            offset: 16,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 4, a: 31, b: 0 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 7,
            a: 3,
            offset: 28,
