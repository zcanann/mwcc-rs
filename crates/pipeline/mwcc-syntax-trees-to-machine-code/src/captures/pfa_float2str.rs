...
impl Generator {
    pub(super) fn try_pfa_float2str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != PFA_FLOAT2STR_AST_HASH
            && hash != 0x3144f2b16fcf7aa9
            && hash != 0xc3569d4b7645ecd3
        {
        ...
        for target in [
            16, 27, 33, 39, 46, 49, 52, 66, 70, 81, 84, 86, 100, 104, 115, 118, 120, 138, 141, 145,
            151, 157, 164, 167, 173, 176, 183, 191, 198, 204, 208, 221, 235, 243, 244, 246, 249,
            251, 259, 261, 269, 275, 280, 286, 299, 303, 308, 317, 328, 329, 331, 333, 336, 341,
            348, 359, 360, 362, 368, 370, 375, 377, 387, 406, 407, 411, 413, 419, 425, 429, 430,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 31, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatCompareOrdered { a: 31, b: 0 });
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "round_decimal".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 4, b: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 101));
        self.output.instructions.push(Instruction::StoreByte {
            s: 0,
            a: 29,
            offset: 5,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 69));
        self.output.instructions.push(Instruction::StoreByte {
            s: 0,
            a: 29,
            offset: 5,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromRecord { d: 0, a: 3, b: 0 });
        self.output.instructions.push(Instruction::StoreWord {
            s: 0,
            a: 29,
            offset: 12,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(8, 43));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 6, a: 6 });
        self.output
            .instructions
            .push(Instruction::load_immediate(8, 45));
        self.bind_label(labels[&204]);
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 26214));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWord { d: 0, a: 5, b: 6 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 7,
            a: 7,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 4, a: 4, b: 6 });
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 0, b: 3 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 4,
            immediate: 48,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate { a: 7, immediate: 2 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 30, b: 28 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 4, a: 31, b: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 46));
        self.output
            .instructions
            .push(Instruction::StoreByteWithUpdate {
                s: 0,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 45));
        self.output
            .instructions
            .push(Instruction::StoreByteWithUpdate {
                s: 0,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 43));
        self.output
            .instructions
            .push(Instruction::StoreByteWithUpdate {
                s: 0,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 0, b: 4 });
        self.output
            .instructions
            .push(Instruction::AddImmediateCarryingRecord {
                d: 7,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::AddImmediateCarryingRecord {
                d: 7,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 6, b: 7 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 48));
        self.output.instructions.push(Instruction::LoadByteZero {
            d: 5,
            a: 1,
            offset: 16,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromRecord { d: 3, a: 7, b: 0 });
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 31, b: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 3, b: 7 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 3, b: 7 });
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 48));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(3, 48));
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 0, b: 6 });
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 4, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 4, b: 6 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 4, b: 6 });
