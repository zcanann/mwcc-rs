...
impl Generator {
    pub(super) fn try_pfa_printf(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 11, a: 11, immediate: 0 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 31, a: 11, immediate: 80 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 6, a: 1, immediate: 104 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 5, a: 1, offset: 108 });
