...
Latest targeted checkpoint: 2026-07-24 01:26 UTC at compiler commit `2a405bb6`
...
Post-holdout compiler work through commit `2a405bb6` has not been run over a
...
relocation-aware parity from 28/109 to 45/109 functions and from 996/15,340 to
2,452/15,340 reference code bytes. The paired gain was +17/-0 functions and +1,456
...
`ftCommon_ApplyGroundMovementNoSlide`, `ftCommon_ApplyFrictionAir`, and
`ftCommon_8007EF5C`. This is evidence of local forward movement, not a
