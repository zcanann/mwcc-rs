...
impl Generator {
    pub(super) fn try_pfa_parse_format(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![908, 1212, 1212, 1212, 988, 852, 968, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 780, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 1212, 908, 1212, 1088, 780, 988, 852, 968, 1212, 780, 1212, 1212, 1212, 1212, 1188, 780, 1052, 1212, 1212, 1144, 1212, 780, 1212, 1212, 780],
            anonymous_offset: 1, // @160 = @159 + 1
        });
        let mut labels: std::collections::HashMap<usize, mwcc_vreg::Label> = std::collections::HashMap::new();
        for target in [31, 62, 63, 68, 81, 84, 87, 94, 98, 112, 129, 132, 135, 142, 146, 153, 156, 166, 177, 180, 181, 185, 201, 207, 218, 221, 232, 239, 247, 254, 257, 278, 283, 292, 303, 305, 314] {
        ...
        self.record_target(RelocationKind::Addr16Ha, mwcc_machine_code::RelocationTarget::JumpTableAt(0));
        ...
        self.record_target(RelocationKind::Addr16Lo, mwcc_machine_code::RelocationTarget::JumpTableAt(0));
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 6, immediate: -65 });
        self.output.instructions.push(Instruction::StoreByte { s: 6, a: 1, offset: 13 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 55 });
        ...
        self.output.instructions.push(Instruction::load_immediate(0, 13));
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 1, offset: 20 });
