...
impl Generator {
    pub(super) fn try_cck_checkexasync(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            14, 20, 29, 31, 36, 52, 55, 63, 65, 84, 109, 135, 136, 141, 147, 159, 175, 178, 187,
            191, 218, 223, 226, 236, 250, 265, 279, 291, 300, 314, 318, 323, 330, 337, 341, 346,
            357, 359, 363, 368, 369, 381, 391, 416, 421, 436, 440, 446, 452, 466, 467,
        ] {
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "_savegpr_22".to_string(),
        });
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 27, s: 4, b: 4 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, -6));
        ...
        self.output
            .instructions
            .push(Instruction::Nor { a: 0, s: 6, b: 6 });
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 5, b: 6 });
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZero {
                d: 6,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 0, b: 24 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 5,
            a: 5,
            immediate: 30841,
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWord { d: 5, a: 5, b: 0 });
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 12));
        self.output
            .instructions
            .push(Instruction::move_register(6, 25));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 4,
            a: 4,
            immediate: 20077,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 5, b: 7 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWordUnsigned { d: 8, a: 22, b: 4 });
        self.output
            .instructions
            .push(Instruction::load_immediate(3, 0));
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 12345));
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 10, a: 23, b: 4 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 12, a: 22, b: 4 });
        self.output
            .instructions
            .push(Instruction::Add { d: 11, a: 8, b: 10 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 10, a: 22, b: 3 });
        self.output
            .instructions
            .push(Instruction::AddCarrying { d: 8, a: 12, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 11, b: 10 });
        self.output
            .instructions
            .push(Instruction::AddExtended { d: 8, a: 8, b: 3 });
        self.output
            .instructions
            .push(Instruction::ShiftRightAlgebraicImmediate {
                a: 10,
        ...
        self.output
            .instructions
            .push(Instruction::AddCarrying { d: 7, a: 12, b: 7 });
        self.output
            .instructions
            .push(Instruction::ClearLeftImmediate {
                a: 7,
        ...
        self.output
            .instructions
            .push(Instruction::AddExtended { d: 8, a: 10, b: 8 });
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 9, b: 7 });
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWordUnsigned { d: 8, a: 12, b: 4 });
        self.output
            .instructions
            .push(Instruction::load_immediate(7, 32767));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 5,
            a: 5,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 9, a: 10, b: 4 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 11, a: 12, b: 4 });
        self.output
            .instructions
            .push(Instruction::Add { d: 10, a: 8, b: 9 });
        self.output
            .instructions
            .push(Instruction::AddCarrying { d: 0, a: 11, b: 0 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 9, a: 12, b: 3 });
        self.output.instructions.push(Instruction::RotateAndMask {
            a: 8,
            s: 0,
            shift: 16,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 10, b: 9 });
        self.output
            .instructions
            .push(Instruction::AddExtended { d: 0, a: 0, b: 3 });
        self.output
            .instructions
            .push(Instruction::RotateAndMaskInsert {
                a: 8,
        ...
        self.output
            .instructions
            .push(Instruction::And { a: 22, s: 8, b: 7 });
        self.output
            .instructions
            .push(Instruction::And { a: 23, s: 0, b: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(4, -13));
        self.emit_branch_to(labels[&136]); // b
        ...
        self.output
            .instructions
            .push(Instruction::move_register(8, 24));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 1,
            immediate: 20,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 7, b: 6 });
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 2047));
        self.output.instructions.push(Instruction::StoreWord {
            s: 6,
            a: 3,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 7, b: 0 });
        self.output
            .instructions
            .push(Instruction::ClearLeftImmediate {
                a: 7,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(25, 8));
        self.output.instructions.push(Instruction::StoreWord {
            s: 0,
            a: 4,
            offset: 132,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate { a: 8, immediate: 2 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 3,
            immediate: 4,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(5, 8192));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 3, a: 7, b: 0 });
        self.output.instructions.push(Instruction::XorImmediate {
            a: 0,
            s: 25,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 4, a: 7, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 5, b: 0 });
        self.output
            .instructions
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "VerifyFAT".to_string(),
        });
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 24, b: 3 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate { a: 8, immediate: 1 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 3, a: 4, b: 3 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 4, a: 4, b: 0 });
        self.output.instructions.push(Instruction::StoreWord {
            s: 3,
            a: 7,
            offset: 132,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 22, a: 3, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 0, b: 3 });
        self.output.instructions.push(Instruction::LoadByteZero {
            d: 0,
            a: 8,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 4, a: 22, b: 5 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 4,
            a: 4,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::StoreHalfwordIndexed { s: 4, a: 22, b: 5 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 5, a: 4, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(7, 5));
        ...
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 0, a: 22, b: 4 });
        self.output
            .instructions
            .push(Instruction::LoadHalfwordZeroIndexed { d: 9, a: 5, b: 4 });
        self.output
            .instructions
            .push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::StoreHalfwordIndexed { s: 0, a: 5, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWordImmediate { a: 9, immediate: 5 });
        self.emit_branch_conditional_to(12, 0, labels[&363]); // blt
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 9, b: 6 });
        ...
        self.output
            .instructions
            .push(Instruction::Nor { a: 0, s: 0, b: 0 });
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 3, b: 0 });
        self.output.instructions.push(Instruction::StoreHalfword {
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 4, a: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 3, a: 3, b: 6 });
        self.record_relocation(RelocationKind::Rel24, "memcpy");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "memcpy".to_string(),
        });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 8192));
        self.output.instructions.push(Instruction::StoreWord {
            s: 0,
            a: 27,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 0, s: 31, b: 29 });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(5, 28));
        self.output.instructions.push(Instruction::LoadWord {
            d: 4,
            a: 4,
            offset: 136,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(22, 3));
        self.output
            .instructions
            .push(Instruction::move_register(3, 26));
        self.output
