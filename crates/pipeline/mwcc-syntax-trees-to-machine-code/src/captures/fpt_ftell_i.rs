...
impl Generator {
    pub(super) fn try_fpt_ftell_i(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 3, offset: 52 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 6, a: 7, b: 0 });
        self.output.instructions.push(Instruction::Add { d: 4, a: 4, b: 6 });
        self.emit_branch_conditional_to(12, 0, labels[&28]); // blt
        self.output.instructions.push(Instruction::AddImmediate { d: 8, a: 5, immediate: -2 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 4, a: 8, b: 4 });
        ...
        self.output.instructions.push(Instruction::SubtractFromRecord { d: 0, a: 8, b: 6 });
