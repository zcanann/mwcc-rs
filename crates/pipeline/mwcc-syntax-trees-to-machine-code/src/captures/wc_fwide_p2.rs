//! wc_fwide_p2: an exact-match whole-function capture (fire 476).
...
const WC_FWIDE_P2_AST_HASH: u64 = 0xcbc4111d5ee13552;

impl Generator {
    pub(super) fn try_wc_fwide_p2(&mut self, function: &Function) -> Compilation<bool> {
