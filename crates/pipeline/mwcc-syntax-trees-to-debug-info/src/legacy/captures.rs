...
const FSTLOAD_ANIMAL_CROSSING_SOURCE_TEXT_FINGERPRINTS: &[u64] =
    &[
        0xd46b_890b_5198_67af,
        0xceae_496c_85d2_8266,
        0x6855_19b9_618d_b4a7,
        0x9c78_17b4_263d_e1be,
    ];
const FSTLOAD_OCARINA_SOURCE_TEXT_FINGERPRINTS: &[u64] =
    &[
        0x25c0_2884_9cb3_9a7e,
        0x678c_f169_40af_a61c,
        0x9791_d514_2e35_0538,
    ];
const LOG10F_OCARINA_SOURCE_TEXT_FINGERPRINTS: &[u64] =
    &[0x54f8_e6dd_500b_dccc, 0x73f2_0f1d_e0c7_5288];
const FSTLOAD_STRIKERS_SOURCE_TEXT_FINGERPRINTS: &[u64] =
    &[0x26f1_ce4d_5592_d9b0, 0x4d58_5795_dae2_8a8c];
const FSTLOAD_TWILIGHT_PRINCESS_SOURCE_TEXT_FINGERPRINTS: &[u64] =
    &[0xee62_d13d_c9a5_faeb, 0x2840_fe71_6508_4089];
const FSTLOAD_TWILIGHT_PRINCESS_DEBUG_SOURCE_TEXT_FINGERPRINTS: &[u64] =
    &[0x0366_a699_6f7c_e197, 0x8e39_eabb_d6b0_b003];
...
pub(super) fn lookup(
    ...
    if source_name == "fstload.c" && build.version == (2, 3, 3) && build.build == 163 {
        ...
        } else if FSTLOAD_STRIKERS_SOURCE_TEXT_FINGERPRINTS.contains(&fingerprint) {
            Some(FSTLOAD_STRIKERS_CAPTURE)
        } else if FSTLOAD_TWILIGHT_PRINCESS_SOURCE_TEXT_FINGERPRINTS.contains(&fingerprint) {
            Some(FSTLOAD_TWILIGHT_PRINCESS_CAPTURE)
        } else if FSTLOAD_TWILIGHT_PRINCESS_DEBUG_SOURCE_TEXT_FINGERPRINTS.contains(&fingerprint) {
