//! trg_cosf: an exact-match whole-function capture (fire 711).
...
const TRG_COSF_AST_HASH: u64 = 0x2b462f886d304d58;

impl Generator {
    pub(super) fn try_trg_cosf(&mut self, function: &Function) -> Compilation<bool> {
        if function.name != "cosf"
        ...
        if hash != TRG_COSF_AST_HASH && hash != 0xf6cd202cad967bd9 {
            eprintln!("trg_cosf hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            ...
            0xa5533c97b3cd5d53 => 0, // melee
            _ => {
                eprintln!("trg_cosf context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        self.output
            .instructions
            .push(Instruction::RoundToSingle { d: 5, b: 1 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplySingle { d: 2, a: 0, c: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatAddSingle { d: 0, a: 1, b: 2 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractSingle { d: 0, a: 2, b: 1 });
        self.output
            .instructions
            .push(Instruction::ConvertToIntegerWordZero { d: 0, b: 0 });
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractSingle { d: 0, a: 5, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatSingleIndexed { d: 1, a: 4, b: 0 });
        self.output.instructions.push(Instruction::LoadFloatSingle {
            d: 0,
            a: 3,
            offset: 4,
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplySingle { d: 5, a: 31, c: 31 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatSingleIndexed { d: 0, a: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplyAddSingle {
                d: 3,
        ...
        self.output
            .instructions
            .push(Instruction::FloatNegativeMultiplyAddSingle {
                d: 1,
                a: 5,
                c: 2,
                b: 1,
