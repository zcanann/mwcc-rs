...
impl Generator {
    pub(super) fn try_suac_impl64_bfbb(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![876, 228, 380, 876, 452, 876, 876, 876, 532, 876, 876, 876, 876, 876, 876, 876, 532],
            anonymous_offset: 72, // measured: table @151 (f513 refctx probe)
        });
        let mut labels: std::collections::HashMap<usize, mwcc_vreg::Label> = std::collections::HashMap::new();
        for target in [29, 31, 39, 49, 70, 81, 93, 99, 111, 117, 128, 131, 136, 149, 160, 163, 172, 176, 178, 181, 188, 206, 219, 225, 232, 235] {
