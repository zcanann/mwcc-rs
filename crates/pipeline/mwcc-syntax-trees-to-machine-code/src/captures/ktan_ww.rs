//! ktan_ww: an exact-match whole-function capture (fire 451).
...
const KTAN_WW_AST_HASH: u64 = 0xd7fee68c5a702bb7;

const CONTEXT_WW: u64 = 0xbceeda89e0a55f64;
const CONTEXT_BFBB: u64 = 0xb61776ae26f47f0e;
const CONTEXT_PIKMIN2: u64 = 0xb4626ed660a00a79;

impl Generator {
    pub(super) fn try_ktan_ww(&mut self, function: &Function) -> Compilation<bool> {
