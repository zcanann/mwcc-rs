...
impl Generator {
    pub(super) fn try_mtc_logf(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractSingle { d: 6, a: 1, b: 0 });
        self.output
            .instructions
            .push(Instruction::LoadFloatSingleIndexed { d: 0, a: 3, b: 5 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplySingle { d: 6, a: 6, c: 0 });
        self.output.instructions.push(Instruction::LoadFloatSingle {
            d: 0,
            a: 1,
            offset: 20,
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplySingle { d: 2, a: 6, c: 6 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatSingleIndexed { d: 1, a: 3, b: 5 });
        self.output
            .instructions
            .push(Instruction::FloatSubtractSingle { d: 3, a: 3, b: 4 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplySingle { d: 0, a: 2, c: 0 });
        self.output
            .instructions
            .push(Instruction::FloatMultiplyAddSingle {
                d: 1,
        ...
        self.output
            .instructions
            .push(Instruction::FloatAddSingle { d: 0, a: 6, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::RoundToSingle { d: 1, b: 1 });
        self.emit_branch_to(labels[&85]); // b
