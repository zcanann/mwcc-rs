//! fp_fseek_impl: an exact-match whole-function capture (fire 458).
...
const FP_FSEEK_IMPL_AST_HASH: u64 = 0xdd117f7033c5d054;

impl Generator {
    pub(super) fn try_fp_fseek_impl(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != FP_FSEEK_IMPL_AST_HASH {
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0x28b5678e43be7203 => 0, // marioparty4 (dev loop)
            _ => return Ok(false),
        };
        ...
        for target in [
            15, 19, 35, 44, 47, 51, 56, 65, 68, 80, 87, 92, 105, 109, 131, 136, 137,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 0, b: 3 });
