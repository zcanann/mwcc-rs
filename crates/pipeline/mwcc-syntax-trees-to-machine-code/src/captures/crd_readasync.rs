...
impl Generator {
    pub(super) fn try_crd_readasync(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.symbol_order = ["_savegpr_27", "__CARDSeek", "__CARDGetDirBlock", "__CARDAccess", "__CARDIsPublic", "__CARDPutControlBlock", "DCInvalidateRange", "__CARDDefaultApiCallback", "ReadCallback", "__CARDRead", "_restgpr_27"].into_iter().map(String::from).collect();
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediateRecord { a: 0, s: 6, clear: 23 });
        self.output.instructions.push(Instruction::move_register(8, 6));
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediateRecord { a: 0, s: 31, clear: 23 });
        ...
        self.output.instructions.push(Instruction::move_register(5, 8));
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "DCInvalidateRange".to_string() });
        ...
        self.output.instructions.push(Instruction::move_register(0, 27));
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 1, offset: 8 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 3, offset: 208 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 1, offset: 8 });
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 29, offset: 8 });
        self.output.instructions.push(Instruction::LoadWord { d: 6, a: 3, offset: 12 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 6, immediate: -1 });
        self.output.instructions.push(Instruction::And { a: 8, s: 4, b: 0 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 5, a: 8, b: 6 });
        self.output.instructions.push(Instruction::CompareWord { a: 31, b: 5 });
        ...
        self.output.instructions.push(Instruction::Add { d: 4, a: 8, b: 0 });
