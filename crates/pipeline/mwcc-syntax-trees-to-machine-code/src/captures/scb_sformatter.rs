...
impl Generator {
    pub(super) fn try_scb_sformatter(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            ...
            227, 229, 230, 243, 255, 268, 269, 279, 283, 285, 287, 289, 291, 293, 294, 296, 315,
            318, 321, 323, 324, 325, 327, 332, 337, 347, 349, 352, 365, 371, 374, 377, 392, 395,
            397, 400, 401, 422, 424, 434, 442, 453, 459, 468, 470, 473, 497, 508, 515, 517, 519,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromZeroExtended { d: 0, a: 23 });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(0, 23));
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromZeroExtended { d: 23, a: 23 });
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByteRecord { a: 17, s: 0 });
