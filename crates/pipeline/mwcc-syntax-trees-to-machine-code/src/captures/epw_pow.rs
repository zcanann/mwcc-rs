...
impl Generator {
    pub(super) fn try_epw_pow(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            29, 37, 45, 49, 57, 72, 81, 92, 99, 101, 106, 108, 117, 119, 125, 133, 146, 153, 163,
            168, 170, 179, 193, 195, 201, 203, 211, 213, 219, 221, 246, 256, 267, 273, 276, 368,
            373, 398, 407, 420, 428, 454, 458, 508, 511, 513,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 0, s: 26, b: 4 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 25,
            a: 1,
            offset: 12,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 27, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(0, 17216));
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 26, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::ShiftRightWord { a: 3, s: 4, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::ShiftRightAlgebraicWord { a: 3, s: 26, b: 0 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 0, s: 3, b: 0 });
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 0, s: 0, b: 25 });
        ...
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 0, s: 0, b: 30 });
        ...
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 3, s: 0, b: 30 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 16864));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 27, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 27, b: 3 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(7, -53));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 4));
        self.output
            .instructions
            .push(Instruction::ClearLeftImmediate {
                a: 6,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 4, b: 7 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 7,
            a: 7,
            immediate: -1023,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 12));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 3,
            immediate: -18822,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 5, a: 4, b: 8 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 5,
            a: 31,
            immediate: 32,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 7, a: 5, b: 8 });
        self.output
            .instructions
            .push(Instruction::FloatNegativeMultiplySubtractDouble {
                d: 31,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 2, a: 9, b: 8 });
        self.output
            .instructions
