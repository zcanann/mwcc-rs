...
impl Generator {
    pub(super) fn try_sfp_num2dec_i(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [23, 38, 40, 43, 64, 70, 72, 77, 81, 84, 93, 99, 101, 106, 110, 112, 113, 138, 141, 158, 168, 173, 179, 184] {
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 11, a: 1, immediate: 152 });
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "isfinite".to_string() });
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "fpclassify".to_string() });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 1, offset: 124 });
        self.load_double_constant(1, 0x4330000080000000);
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::LoadFloatDouble { d: 0, a: 1, offset: 120 });
        self.output.instructions.push(Instruction::FloatSubtractDouble { d: 31, a: 0, b: 1 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 28, a: 1, offset: 76 });
        ...
        self.output.instructions.push(Instruction::load_immediate(0, 1));
        self.output.instructions.push(Instruction::StoreHalfword { s: 28, a: 1, offset: 78 });
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 1, offset: 80 });
        self.output.instructions.push(Instruction::StoreByte { s: 28, a: 1, offset: 81 });
        self.emit_branch_to(labels[&179]); // b
        self.bind_label(labels[&138]);
        self.output.instructions.push(Instruction::StoreByte { s: 28, a: 1, offset: 80 });
        self.output.instructions.push(Instruction::AddImmediate { d: 29, a: 1, immediate: 76 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 8, a: 1, offset: 80 });
        self.output.instructions.push(Instruction::move_register(3, 27));
        self.output.instructions.push(Instruction::load_immediate(5, 0));
        self.output.instructions.push(Instruction::load_immediate(6, 10));
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 7, a: 1, offset: 80 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 3, a: 1, offset: 80 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 1, immediate: 76 });
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 1, immediate: 81 });
        ...
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 1, offset: 78 });
        self.bind_label(labels[&179]);
        self.output.instructions.push(Instruction::move_register(3, 30));
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 1, immediate: 76 });
