...
impl Generator {
    pub(super) fn try_als_link_new_block(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 4, immediate: 31 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 1, offset: 36 });
        self.output.instructions.push(Instruction::load_immediate_shifted(0, 1));
        ...
        self.output.instructions.push(Instruction::AndContiguousMask { a: 30, s: 4, begin: 0, end: 28 });
        ...
        self.output.instructions.push(Instruction::load_immediate_shifted(30, 1));
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "__sys_alloc".to_string() });
        ...
        self.output.instructions.push(Instruction::BranchAndLink { target: "Block_construct".to_string() });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 3, offset: 4 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 29, offset: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 3, offset: 0 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 29, offset: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 31, offset: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 31, offset: 4 });
