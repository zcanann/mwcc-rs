//! uc2_write: an exact-match whole-function capture (fire 491).
...
const UC2_WRITE_AST_HASH: u64 = 0xe4ca81f01902c9ea;

impl Generator {
    pub(super) fn try_uc2_write(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.record_relocation(RelocationKind::EmbSda21, "MSL_ConsoleIo_804D7080");
