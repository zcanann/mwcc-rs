//! afp_num2dec_pik: an exact-match whole-function capture (fire 679).
...
const AFP_NUM2DEC_PIK_AST_HASH: u64 = 0xfc940f712c96df20;

impl Generator {
    pub(super) fn try_afp_num2dec_pik(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != AFP_NUM2DEC_PIK_AST_HASH {
            eprintln!("afp_num2dec_pik hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0xe4f69f920b359fc6 => 79, // pikmin: pool @106 (ours @27 unbumped)
            _ => {
                eprintln!("afp_num2dec_pik context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        for target in [
            14, 25, 35, 40, 42, 44, 49, 51, 53, 54, 66, 71, 73, 75, 80, 82, 84, 85, 89, 91, 99,
            119, 123, 125, 128, 131, 135, 137, 140, 143, 145, 151, 153, 163, 167, 188, 200, 203,
            209, 215, 217, 223, 224,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 5));
        self.output.instructions.push(Instruction::LoadWord {
            d: 5,
            a: 1,
            offset: 8,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(4, 17180));
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 5, a: 5, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyHighWord { d: 0, a: 4, b: 5 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::AddRecord { d: 4, a: 0, b: 3 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 31, a: 31, c: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatDivideDouble { d: 31, a: 31, b: 1 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 31, a: 31, c: 1 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 3,
            a: 3,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(5, 26214));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(8, 17200));
        ...
        self.output
            .instructions
            .push(Instruction::move_register(11, 31));
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 6, b: 11 });
        self.output.instructions.push(Instruction::StoreByte {
            s: 0,
            a: 30,
            offset: 4,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 3, a: 11, b: 3 });
        self.output
            .instructions
            .push(Instruction::Add { d: 4, a: 4, b: 11 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 10,
            a: 11,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::ConvertToIntegerWordZero { d: 0, b: 31 });
        self.output
            .instructions
            .push(Instruction::StoreFloatDouble {
                s: 0,
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 31, a: 31, b: 0 });
        self.emit_branch_to(labels[&200]); // b
        self.bind_label(labels[&188]);
        self.output
            .instructions
            .push(Instruction::MultiplyHighWord { d: 0, a: 7, b: 12 });
        self.output
            .instructions
            .push(Instruction::ShiftRightAlgebraicImmediate {
                a: 5,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 6, a: 6, b: 12 });
        self.output
            .instructions
            .push(Instruction::Add { d: 12, a: 0, b: 5 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 6,
            immediate: 48,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(5, 36));
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromRecord { d: 5, a: 0, b: 5 });
