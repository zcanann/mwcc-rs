...
impl Generator {
    pub(super) fn try_cst_setasync(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.frame_size = 16;
        self.non_leaf = true;
        self.output.symbol_order = ["__CARDGetControlBlock", "__CARDGetDirBlock", "__CARDAccess", "__CARDPutControlBlock", "UpdateIconOffsets", "OSGetTime", "__div2i", "__CARDUpdateDir"].into_iter().map(String::from).collect();
        ...
        self.output.instructions.push(Instruction::OrRecord { a: 31, s: 4, b: 4 });
        ...
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 31, immediate: 127 });
        self.emit_branch_conditional_to(4, 0, labels[&27]); // bge
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 28, offset: 48 });
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 0, a: 3, immediate: 1 });
        ...
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 3, immediate: 512 });
        self.emit_branch_conditional_to(4, 0, labels[&27]); // bge
        self.bind_label(labels[&20]);
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 28, offset: 56 });
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 0, a: 3, immediate: 1 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 65535 });
        self.emit_branch_conditional_to(12, 2, labels[&29]); // beq
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 3, clear: 19 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 8128 });
        ...
        self.output.instructions.push(Instruction::ShiftLeftImmediate { a: 0, s: 31, shift: 6 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 28, offset: 46 });
        self.output.instructions.push(Instruction::move_register(3, 31));
        self.output.instructions.push(Instruction::move_register(4, 28));
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 31, offset: 7 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 28, offset: 48 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 31, offset: 44 });
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 0, a: 28, offset: 52 });
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 31, offset: 48 });
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 0, a: 28, offset: 54 });
        self.output.instructions.push(Instruction::StoreHalfword { s: 0, a: 31, offset: 50 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 28, offset: 56 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 31, offset: 44 });
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 0, a: 3, immediate: 1 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 65535 });
        self.emit_branch_conditional_to(4, 2, labels[&68]); // bne
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 0, a: 31, offset: 50 });
