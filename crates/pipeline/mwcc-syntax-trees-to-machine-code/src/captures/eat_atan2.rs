//! eat_atan2: an exact-match whole-function capture (fire 719).
...
const EAT_ATAN2_AST_HASH: u64 = 0xfdd3dfcd95cb8c62;

impl Generator {
    pub(super) fn try_eat_atan2(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != EAT_ATAN2_AST_HASH {
            eprintln!("eat_atan2 hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0x5e6a029e5ad01cbc => 54, // marioparty4
            _ => {
                eprintln!("eat_atan2 context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        for target in [
            25, 29, 34, 45, 49, 51, 53, 59, 61, 74, 77, 79, 81, 83, 85, 92, 95, 97, 99, 101, 103,
            110, 112, 119, 126, 132, 138, 141, 143, 148, 154, 159,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 0, a: 8 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 4,
            a: 1,
            offset: 16,
        ...
        self.output
            .instructions
            .push(Instruction::Or { a: 0, s: 8, b: 0 });
        self.output
            .instructions
            .push(Instruction::StoreFloatDouble {
                s: 1,
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 0, a: 9 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 0, s: 6, b: 8 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 6, b: 7 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 1, a: 2, b: 1 });
        self.output
            .instructions
