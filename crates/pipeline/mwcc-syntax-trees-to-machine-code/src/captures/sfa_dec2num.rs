...
impl Generator {
    pub(super) fn try_sfa_dec2num(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            17, 18, 20, 27, 30, 36, 37, 39, 46, 47, 49, 60, 68, 75, 79, 86, 89, 92, 99, 101, 105,
            113, 115, 147, 175, 176, 181, 200, 209, 215, 243, 244, 249, 263, 265, 267, 282, 293,
            307, 312, 314, 316, 321, 323, 325, 326, 336, 342, 347, 356, 360, 367, 372, 378, 386,
            389, 397, 399, 404, 414, 420, 426, 430, 434, 442, 447, 449, 451, 456, 461, 477, 479,
            484, 494, 500, 506, 510, 514, 522, 527, 529, 531, 536, 553, 558, 560, 562, 567, 569,
            571, 572, 576, 583, 619, 624, 626, 628, 633, 635, 637, 638, 642, 645, 653, 655, 660,
            670, 676, 682, 686, 690, 698, 703, 706, 708, 713, 740, 748, 750, 755, 765, 771, 777,
            781, 785, 793, 798, 800, 802, 807, 811, 822, 852, 860, 862, 867, 877, 883, 889, 893,
            897, 905, 910, 913, 915, 920, 947, 955, 957, 962, 972, 978, 984, 988, 992, 1000, 1005,
            1007, 1009, 1014, 1017, 1023, 1024,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 32752));
        self.output.instructions.push(Instruction::StoreWord {
            s: 4,
            a: 1,
            offset: 44,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(28, 14));
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 3, a: 27, b: 0 });
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 0, a: 26, b: 3 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::CountLeadingZeros { a: 0, s: 25 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 29,
            a: 29,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 29, b: 28 });
        ...
        self.output
            .instructions
            .push(Instruction::move_register(25, 26));
        self.output.instructions.push(Instruction::StoreWord {
            s: 0,
            a: 1,
            offset: 404,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 26, b: 0 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 10,
            a: 27,
            offset: 16,
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 26, b: 0 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 8,
            a: 27,
            offset: 24,
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 3, a: 28 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(27, 32752));
        self.record_relocation(RelocationKind::Addr16Lo, "__float_huge");
        self.output.instructions.push(Instruction::AddImmediate {
            d: 28,
            a: 3,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 0, b: 27 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatNegate { d: 2, b: 0 });
        self.record_relocation(RelocationKind::Rel24, "nextafter");
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "nextafter".to_string(),
        });
