//! sca_parse_format: an exact-match whole-function capture (fire 691).
...
const SCA_PARSE_FORMAT_AST_HASH: u64 = 0x6420a2be38a53205;

impl Generator {
    pub(super) fn try_sca_parse_format(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != SCA_PARSE_FORMAT_AST_HASH {
            eprintln!("sca_parse_format hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            ...
            _ => {
                eprintln!("sca_parse_format context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        self.output
            ...
            .push(mwcc_machine_code::AnonymousRodata {
                ...
                anonymous_offset: -1, // real @4 against the running counter 5
            });
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                600, 1244, 600, 1244, 1244, 1244, 1244, 1244, 1244, 1244, 1244, 1244, 1244, 1244,
                1244, 1244, 1244, 1244, 1244, 576, 1244, 1244, 840, 1244, 1244, 1244, 1244, 1244,
                600, 1244, 680, 576, 600, 600, 600, 1244, 576, 1244, 1244, 1244, 1244, 1252, 576,
                660, 1244, 1244, 724, 1244, 576, 1244, 1244, 576,
            ],
            anonymous_offset: 115, // real table @120 (counter @5 at dispatch)
        });
        let mut labels: std::collections::HashMap<usize, mwcc_vreg::Label> =
            std::collections::HashMap::new();
        for target in [
            42, 48, 56, 92, 94, 101, 104, 115, 126, 129, 130, 134, 157, 160, 176, 187, 191, 195,
            216, 220, 228, 235, 237, 255, 262, 268, 270, 274, 279, 284, 311, 313, 334,
        ] {
        ...
        self.record_target(
            ...
            mwcc_machine_code::RelocationTarget::AnonymousRodata,
        );
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 5, s: 5 });
        self.output.instructions.push(Instruction::StoreWord {
            s: 30,
            a: 1,
            offset: 56,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 0, a: 7, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 5, b: 0 });
        self.output
            .instructions
            .push(Instruction::LoadByteZeroWithUpdate {
                d: 5,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(6, 2));
        self.output.instructions.push(Instruction::StoreByte {
            s: 6,
            a: 1,
            offset: 10,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 0, a: 5, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 120));
        self.output.instructions.push(Instruction::StoreByte {
            s: 5,
            a: 1,
            offset: 10,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(5, 255));
        self.output
            .instructions
            .push(Instruction::MoveToCountRegister { s: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(5, 193));
        self.output
            .instructions
            .push(Instruction::load_immediate(0, 254));
        self.output.instructions.push(Instruction::StoreByte {
            s: 5,
            a: 1,
            offset: 17,
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 10, s: 10 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 10,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 6, a: 9, b: 7 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 5, s: 8, b: 5 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 5, a: 9, b: 7 });
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByteRecord { a: 12, s: 12 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 5, a: 7, b: 6 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 0, s: 8, b: 0 });
        self.output
            .instructions
            .push(Instruction::Or { a: 0, s: 5, b: 0 });
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 0, a: 7, b: 6 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 10, b: 12 });
