...
impl Generator {
    pub(super) fn try_sldp_strtold(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            65, 78, 81, 87, 90, 99, 102, 110, 125, 129, 132, 141, 144, 147, 148, 159, 169, 179,
            181, 192, 202, 210, 214, 216, 220, 226, 228, 235, 237, 245, 255, 263, 267, 269, 273,
            278, 287, 295, 299, 300, 306, 308, 316, 318, 330, 338, 352, 356, 362, 364, 366, 377,
            379, 397, 399, 408, 409, 418, 426, 428, 436, 443, 449, 450, 459, 463, 467, 479, 481,
            492, 504, 506, 514, 526, 528, 539, 541, 549, 556, 565, 577, 580, 586, 589, 609, 620,
            622, 640, 642, 653, 656, 660, 661, 672, 686, 695, 703, 713, 716, 720, 721, 732, 746,
            755, 759, 763, 776, 778, 784, 792, 802, 810, 823, 825, 833, 841, 850, 857, 863, 867,
            878, 883, 884, 890, 899, 904, 906, 914, 920, 923, 937, 946, 953, 955, 965, 973, 1005,
            1014, 1020, 1022, 1023,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(16, 4));
        self.record_target(
        ...
        self.output
            .instructions
            .push(Instruction::move_register(17, 5));
        self.output.instructions.push(Instruction::LoadWord {
            d: 21,
            a: 23,
            offset: 8,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(18, 7));
        self.output.instructions.push(Instruction::LoadWord {
            d: 4,
            a: 23,
            offset: 12,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(12, 16));
        self.output.instructions.push(Instruction::LoadWord {
            d: 5,
            a: 23,
            offset: 16,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(20, 0));
        self.output.instructions.push(Instruction::StoreWord {
            s: 4,
            a: 1,
            offset: 56,
        ...
        self.output
            .instructions
            .push(Instruction::move_register(3, 17));
        self.output.instructions.push(Instruction::StoreWord {
            s: 21,
            a: 1,
            offset: 52,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(14, 1));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(19, 1));
        self.output.instructions.push(Instruction::LoadWord {
            d: 5,
            a: 6,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 19, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(20, 1));
        self.output.instructions.push(Instruction::StoreWord {
            s: 3,
            a: 1,
            offset: 16,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 3, a: 15, b: 0 });
        self.output
            .instructions
            .push(Instruction::RotateAndMaskRecord {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 20, b: 19 });
        self.output
            .instructions
            .push(Instruction::StoreFloatDouble {
                s: 1,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 4, b: 21 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 28, a: 4, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 28,
            a: 28,
            immediate: -48,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 2));
        self.output.instructions.push(Instruction::StoreByte {
            s: 0,
            a: 1,
            offset: 25,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 4));
        self.emit_branch_to(labels[&850]); // b
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 0, b: 25 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 23,
            a: 23,
            immediate: 1,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 6, a: 26, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 3, a: 3, b: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::Or { a: 0, s: 6, b: 3 });
        self.output
            .instructions
            .push(Instruction::ClearLeftImmediate {
                a: 5,
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 5, a: 26, b: 0 });
        self.output
            .instructions
            .push(Instruction::load_immediate(5, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 32));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 64));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 128));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 256));
        self.emit_branch_to(labels[&850]); // b
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 4, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 3,
            immediate: -48,
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 22, s: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 28, a: 28 });
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 0, a: 22 });
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 22, s: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 0, b: 25 });
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 22, b: 5 });
        self.output
            .instructions
            .push(Instruction::ExtendSignHalfword { a: 22, s: 0 });
        self.load_double_constant(1, 0x0000000000000000);
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 0, b: 24 });
        self.output.instructions.push(Instruction::StoreHalfword {
            s: 4,
            a: 1,
            offset: 24,
