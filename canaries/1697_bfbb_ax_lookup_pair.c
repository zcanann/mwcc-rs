...
// Original tables and first two lookup terms; mixerCtrl remains u16.
...
u32 ax_lookup_pair(u16 mixerCtrl) { return __AXMainMixCycles[mixerCtrl & 15] + __AXAuxMixCycles[(mixerCtrl >> 4) & 31]; }
