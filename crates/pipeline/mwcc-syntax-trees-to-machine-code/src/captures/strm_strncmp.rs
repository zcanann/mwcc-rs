//! strm_strncmp: an exact-match whole-function capture (fire 472).
...
const STRM_STRNCMP_AST_HASH: u64 = 0xb0162f8ee8012ae2;

impl Generator {
    pub(super) fn try_strm_strncmp(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadByteZeroWithUpdate { d: 5, a: 4, offset: 1 });
