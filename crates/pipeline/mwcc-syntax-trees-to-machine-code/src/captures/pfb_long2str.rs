...
impl Generator {
    pub(super) fn try_pfb_long2str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            16, 18, 45, 53, 58, 59, 75, 85, 88, 96, 103, 105, 107, 119, 124, 130, 134,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::DivideWordUnsigned { d: 9, a: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 9, a: 9, b: 0 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 10, a: 9, b: 3 });
        self.output
            .instructions
