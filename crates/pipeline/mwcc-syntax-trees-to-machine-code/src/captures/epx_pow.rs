...
impl Generator {
    pub(super) fn try_epx_pow(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            27, 35, 43, 47, 55, 70, 79, 90, 97, 99, 104, 106, 115, 117, 123, 131, 144, 150, 160,
            165, 167, 176, 190, 192, 198, 200, 208, 210, 216, 218, 243, 253, 264, 270, 273, 365,
            370, 395, 404, 417, 425, 451, 455, 505, 508, 510,
        ] {
