//! abexs_exit: an exact-match whole-function capture (fire 484).
...
const ABEXS_EXIT_AST_HASH: u64 = 0x3b6acd99f0b3dee1;

impl Generator {
    pub(super) fn try_abexs_exit(&mut self, function: &Function) -> Compilation<bool> {
