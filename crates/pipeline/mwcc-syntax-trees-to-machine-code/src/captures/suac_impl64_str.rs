...
impl Generator {
    pub(super) fn try_suac_impl64_str(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_table = Some(mwcc_machine_code::JumpTable {
            entries: vec![920, 224, 384, 920, 456, 920, 920, 920, 536, 920, 920, 920, 920, 920, 920, 920, 536],
            anonymous_offset: 82, // measured: table @186 (f512 refctx probe)
        });
        let mut labels: std::collections::HashMap<usize, mwcc_vreg::Label> = std::collections::HashMap::new();
        for target in [28, 30, 38, 48, 71, 82, 94, 100, 112, 118, 129, 132, 137, 150, 163, 166, 172, 175, 178, 182, 184, 188, 191, 192, 199, 217, 230, 236, 242, 243] {
