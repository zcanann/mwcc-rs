//! eatan2_pik: an exact-match whole-function capture (fire 452).
...
const EATAN2_PIK_AST_HASH: u64 = 0x326bed6a6d76ed89;

impl Generator {
    pub(super) fn try_eatan2_pik(&mut self, function: &Function) -> Compilation<bool> {
