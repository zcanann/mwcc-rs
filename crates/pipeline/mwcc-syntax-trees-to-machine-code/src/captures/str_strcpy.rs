//! str_strcpy: an exact-match whole-function capture (fire 469).
...
const STR_STRCPY_AST_HASH: u64 = 0xc8748f2aee637891;

impl Generator {
    pub(super) fn try_str_strcpy(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 8, b: 0 });
        self.output
            .instructions
            .push(Instruction::AndRecord { a: 6, s: 6, b: 5 });
        self.emit_branch_conditional_to(4, 2, labels[&35]); // bne
        self.output.instructions.push(Instruction::AddImmediate {
            d: 7,
            a: 7,
