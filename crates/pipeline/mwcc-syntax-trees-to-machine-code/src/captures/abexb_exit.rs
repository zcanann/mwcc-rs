//! abexb_exit: an exact-match whole-function capture (fire 484).
...
const ABEXB_EXIT_AST_HASH: u64 = 0x798e051b53b5c935;

impl Generator {
    pub(super) fn try_abexb_exit(&mut self, function: &Function) -> Compilation<bool> {
