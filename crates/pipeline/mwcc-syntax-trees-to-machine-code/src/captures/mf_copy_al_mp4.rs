...
impl Generator {
    pub(super) fn try_mf_copy_al_mp4(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MF_COPY_AL_MP4_AST_HASH {
            return Ok(false);
        }
        ...
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 6, s: 5, shift: 27, begin: 5, end: 31 });
        self.output.instructions.push(Instruction::AddImmediate { d: 7, a: 4, immediate: -3 });
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 3, immediate: -3 });
        self.emit_branch_conditional_to(12, 2, labels[&32]); // beq
        self.bind_label(labels[&14]);
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 7, offset: 4 });
        self.output.instructions.push(Instruction::AddImmediateCarryingRecord { d: 6, a: 6, immediate: -1 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 7, offset: 8 });
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 4, offset: 4 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 7, offset: 12 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 4, offset: 8 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 7, offset: 16 });
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 4, offset: 12 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 7, offset: 20 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 4, offset: 16 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 7, offset: 24 });
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 4, offset: 20 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 7, offset: 28 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 4, offset: 24 });
        self.output.instructions.push(Instruction::LoadWordWithUpdate { d: 0, a: 7, offset: 32 });
        self.output.instructions.push(Instruction::StoreWord { s: 3, a: 4, offset: 28 });
        self.output.instructions.push(Instruction::StoreWordWithUpdate { s: 0, a: 4, offset: 32 });
        ...
        self.output.instructions.push(Instruction::LoadWordWithUpdate { d: 0, a: 7, offset: 4 });
        self.output.instructions.push(Instruction::AddImmediateCarryingRecord { d: 3, a: 3, immediate: -1 });
        self.output.instructions.push(Instruction::StoreWordWithUpdate { s: 0, a: 4, offset: 4 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 6, a: 7, immediate: 3 });
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 4, immediate: 3 });
        ...
        self.output.instructions.push(Instruction::LoadByteZeroWithUpdate { d: 0, a: 6, offset: 1 });
