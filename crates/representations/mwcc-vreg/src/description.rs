...
pub fn for_each_register(instruction: &mut Instruction, mut visit: impl FnMut(RegisterRole, Class, &mut u8)) {
    ...
    match instruction {
        ...
        Add { d, a, b } | SubtractFrom { d, a, b } | SubtractFromCarrying { d, a, b } | AddExtended { d, a, b }
        | MultiplyLow { d, a, b } | DivideWord { d, a, b } | DivideWordUnsigned { d, a, b } => {
            visit(D, G, d);
            visit(U, G, a);
            visit(U, G, b);
        }
        ...
        Nor { a, s, b } | AndComplement { a, s, b } | OrComplement { a, s, b } | Or { a, s, b } | And { a, s, b }
        ...
        CountLeadingZeros { a, s } | ExtendSignByte { a, s } | ExtendSignHalfword { a, s }
        | OrImmediate { a, s, .. } | ShiftLeftImmediate { a, s, .. } | ShiftRightAlgebraicImmediate { a, s, .. }
        | ShiftRightLogicalImmediate { a, s, .. } | XorImmediate { a, s, .. } | XorImmediateShifted { a, s, .. }
        | ClearLeftImmediate { a, s, .. } | AndContiguousMask { a, s, .. } | RotateAndMask { a, s, .. } => {
            visit(D, G, a);
            visit(U, G, s);
        }
