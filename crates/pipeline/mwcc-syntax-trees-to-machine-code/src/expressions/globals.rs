...
impl Generator {
    ...
    pub(crate) fn global_load_instruction(&self, global_type: Type, d: u8, a: u8) -> Compilation<Instruction> {
    ...
    pub(crate) fn emit_global_load_absolute(&mut self, name: &str, global_type: Type, destination: u8) -> Compilation<()> {
