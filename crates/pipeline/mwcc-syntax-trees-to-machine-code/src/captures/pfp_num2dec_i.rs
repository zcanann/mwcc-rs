//! pfp_num2dec_i: an exact-match whole-function capture (fire 687).
...
const PFP_NUM2DEC_I_AST_HASH: u64 = 0xa495593445b8fdc6;

impl Generator {
    pub(super) fn try_pfp_num2dec_i(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != PFP_NUM2DEC_I_AST_HASH {
            eprintln!("pfp_num2dec_i hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0xecff4eb19d59de49 => 249, // pikmin2
            _ => {
                eprintln!("pfp_num2dec_i context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        for target in [21, 31, 36, 38, 40, 45, 47, 49, 50, 68, 73, 75, 77, 82, 84, 86, 87, 91, 93, 97, 112, 118, 120, 125, 129, 132, 141, 147, 149, 154, 158, 160, 161, 186, 189, 206, 216, 221, 227, 232] {
        ...
        self.output.instructions.push(Instruction::SubtractFromImmediate { d: 26, a: 7, immediate: 53 });
