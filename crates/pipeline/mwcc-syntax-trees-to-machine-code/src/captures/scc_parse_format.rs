...
impl Generator {
    pub(super) fn try_scc_parse_format(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.jump_tables.push(mwcc_machine_code::JumpTable {
            entries: vec![
                624, 1268, 624, 1268, 1268, 1268, 1268, 1268, 1268, 1268, 1268, 1268, 1268, 1268,
                1268, 1268, 1268, 1268, 1268, 600, 1268, 1268, 864, 1268, 1268, 1268, 1268, 1268,
                624, 1268, 704, 600, 624, 624, 624, 1268, 600, 1268, 1268, 1268, 1268, 1276, 600,
                684, 1268, 1268, 748, 1268, 600, 1268, 1268, 600,
            ],
        ...
        for target in [
            49, 55, 61, 98, 100, 107, 110, 121, 132, 135, 136, 140, 163, 166, 182, 193, 197, 201,
            222, 226, 234, 241, 243, 261, 268, 274, 276, 280, 285, 290, 317, 319, 340,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 30, s: 30 });
        self.output.instructions.push(Instruction::StoreWord {
            s: 28,
            a: 1,
            offset: 48,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 30, b: 0 });
        self.output
            .instructions
            .push(Instruction::LoadByteZeroWithUpdate {
                d: 30,
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByte { a: 8, s: 8 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 8,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 4, a: 7, b: 5 });
        self.output
            .instructions
            .push(Instruction::ShiftLeftWord { a: 3, s: 6, b: 3 });
        self.output
            .instructions
            .push(Instruction::CompareWordImmediate {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 3, a: 7, b: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::ExtendSignByteRecord { a: 10, s: 10 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 3, a: 5, b: 4 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 0, a: 5, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 8, b: 10 });
