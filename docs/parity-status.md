...
Latest targeted checkpoint: 2026-07-23 23:49 UTC at compiler commit `066c51df`
...
Post-holdout compiler work through commit `066c51df` has not been run over a
...
relocation-aware parity from 28/109 to 32/109 functions and from 996/15,340 to
1,376/15,340 reference code bytes. The paired gain was +4/-0 functions and +380
exact bytes: `ftCommon_ClampAirDrift`, `ftCommon_FallBasic`, and
`ftCommon_CalcHitlag`, and `ftCommon_8007DB58`. This is evidence of local forward
