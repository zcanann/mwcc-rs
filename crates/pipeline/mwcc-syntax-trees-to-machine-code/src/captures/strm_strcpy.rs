//! strm_strcpy: an exact-match whole-function capture (fire 472).
...
const STRM_STRCPY_AST_HASH: u64 = 0x2b67154b4067d4bd;

impl Generator {
    pub(super) fn try_strm_strcpy(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::move_register(8, 3));
        ...
        self.output.instructions.push(Instruction::AndRecord { a: 7, s: 7, b: 5 });
        self.emit_branch_conditional_to(4, 2, labels[&35]); // bne
        self.output.instructions.push(Instruction::AddImmediate { d: 8, a: 8, immediate: -4 });
        self.bind_label(labels[&29]);
        self.output.instructions.push(Instruction::StoreWordWithUpdate { s: 6, a: 8, offset: 4 });
        self.output.instructions.push(Instruction::LoadWordWithUpdate { d: 6, a: 4, offset: 4 });
        self.output.instructions.push(Instruction::Add { d: 7, a: 6, b: 0 });
        self.output.instructions.push(Instruction::AndRecord { a: 7, s: 7, b: 5 });
