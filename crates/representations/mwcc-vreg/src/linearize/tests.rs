    ...
    vec![
        (
            ...
            vec![
                ...
                DagNode::new("fadd_g", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[1, 10])
                    .writes(&[11]),
                DagNode::new("st_g", STORE).kind(St).reads(&[11]),
                DagNode::new("lfd_c2", LOAD).writes(&[20]),
                DagNode::new("fadd_h", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[2, 20])
                    .writes(&[21]),
                DagNode::new("st_h", STORE).kind(St).reads(&[21]),
        ...
        (
            ...
            vec![
                DagNode::new("lfd_c1", LOAD).writes(&[10]),
                DagNode::new("fadd_g1", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[1, 10])
                    .writes(&[11]),
                DagNode::new("lfd_c2", LOAD).writes(&[12]),
                DagNode::new("fadd_g2", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[11, 12])
                    .writes(&[13]),
        ...
        (
            ...
            vec![
                ...
                DagNode::new("fmadd1", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[1, 10, 11])
                    .writes(&[12]),
                DagNode::new("fmul", FARITH)
                    .gate(FMUL_D)
                    .hazard(HAZARD_FPU)
                    .reads(&[1, 12])
                    .writes(&[13]),
        ...
        (
            ...
            vec![
                ...
                DagNode::new("fmadd_a", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[2, 10, 11])
                    .writes(&[20]),
                DagNode::new("fmadd_b", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[2, 12, 13])
                    .writes(&[21]),
                DagNode::new("fmadd_c", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[2, 20, 14])
                    .writes(&[22]),
                DagNode::new("fmul_d", FARITH)
                    .gate(FMUL_D)
                    .hazard(HAZARD_FPU)
                    .reads(&[2, 21])
                    .writes(&[23]),
                DagNode::new("fmadd_f", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[1, 22, 23])
                    .writes(&[24]),
            ],
    ...
    vec![
        ...
        (
            ...
            vec![
                ...
                DagNode::new("lfd_c25", LOAD).writes(&[11]),
                DagNode::new("lfd_c15", LOAD).writes(&[12]),
                DagNode::new("fnmsub1", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[1, 10, 11])
                    .writes(&[13]),
                DagNode::new("fnmsub2", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[1, 13, 12])
                    .writes(&[14]),
                DagNode::new("fmul", FARITH)
        ...
        (
            ...
            vec![
                DagNode::new("lfd_c25", LOAD).writes(&[10]),
                DagNode::new("lfd_c15", LOAD).writes(&[11]),
                DagNode::new("fmul_zw", FARITH)
                    .gate(FMUL_D)
                    .hazard(HAZARD_FPU)
                    .reads(&[1, 2])
                    .writes(&[20]),
                DagNode::new("fmadd", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[10, 1, 11])
                    .writes(&[21]),
                DagNode::new("fmul_root", FARITH)
                    .gate(FMUL_D)
                    .hazard(HAZARD_FPU)
                    .reads(&[21, 20])
                    .writes(&[22]),
        ...
        (
            ...
            vec![
                ...
                DagNode::new("fmadd3", FARITH)
                    ...
                    .reads(&[20, 23, 13])
                    .writes(&[24]),
                DagNode::new("fmadd4", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[20, 24, 14])
                    .writes(&[25]),
                DagNode::new("fmadd5", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[20, 25, 15])
                    .writes(&[26]),
                DagNode::new("fmadd_root", FARITH)
        ...
        (
            ...
            vec![
                ...
                DagNode::new("lfd_c15", LOAD).writes(&[11]),
                DagNode::new("fmsub1", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[10, 2, 20])
                    .writes(&[21]),
                DagNode::new("fmsub2", FARITH)
                    .hazard(HAZARD_FPU)
                    .reads(&[5, 21, 2])
                    .writes(&[22]),
                DagNode::new("fnmsub", FARITH)
...
fn float_registers_frontier_d5() {
    ...
    let nodes = vec![
        ...
        DagNode::new("chain1", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[42, 40, 43])
            .writes(&[48]),
        DagNode::new("chain2", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[40, 48, 44])
            .writes(&[49]),
        DagNode::new("chain3", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[40, 49, 45])
            .writes(&[50]),
        DagNode::new("chain4", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[40, 50, 46])
            .writes(&[51]),
        DagNode::new("chain5", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[40, 51, 47])
            .writes(&[52]),
        DagNode::new("sink", 1)
    ...
    assert_eq!(
        registers, expected,
        "the d5 register frontier is not yet fitted"
    );
}
...
fn float_registers_frontier_kcos_else() {
    ...
    let nodes = vec![
        ...
        DagNode::new("fmul_xy", FARITH)
            .gate(4)
            .hazard(HAZARD_FPU)
            .reads(&[9, 3])
            .writes(&[14]),
        DagNode::new("fmsub_hz", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[12, 1, 7])
            .writes(&[15]),
        DagNode::new("fmsub_in", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[1, 2, 14])
            .writes(&[16]),
        DagNode::new("fsub_a", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[13, 7])
            .writes(&[17]),
        DagNode::new("fsub_s2", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[15, 16])
            .writes(&[18]),
        DagNode::new("fsub_rt", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[17, 18])
            .writes(&[19])
            .emission_ordered(),
...
fn float_registers_frontier_t5_table() {
    ...
    let nodes = vec![
        ...
        DagNode::new("even1", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[11, 12, 13])
            .writes(&[17]),
        DagNode::new("odd1", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[11, 14, 15])
            .writes(&[18]),
        DagNode::new("even2", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[11, 17, 16])
            .writes(&[19]),
        DagNode::new("mul_odd", FARITH)
            .gate(FMUL_D)
            .hazard(HAZARD_FPU)
            .reads(&[11, 18])
            .writes(&[20]),
        DagNode::new("root", FARITH)
            .hazard(HAZARD_FPU)
            .reads(&[10, 19, 20])
            .writes(&[21]),
    ];
    ...
    shapes.push((
        ...
        vec![
            ...
            DagNode::new("even2", FARITH)
                ...
                .reads(&[11, 17, 16])
                .writes(&[21]),
            DagNode::new("odd2", FARITH)
                .hazard(HAZARD_FPU)
                .reads(&[11, 20, 18])
                .writes(&[22]),
            DagNode::new("even3", FARITH)
                .hazard(HAZARD_FPU)
                .reads(&[11, 21, 19])
                .writes(&[23]),
            DagNode::new("mul_odd", FARITH)
...
fn float_registers() {
    ...
    println!(
        "float registers BEST {best_model:?}: {best_score}/{}",
        shapes.len()
    );
...
fn chain_order_diagnostic() {
    ...
    for (name, nodes, params, expected) in &shapes {
        ...
        let passing: Vec<String> = permutations(&sinks)
            .into_iter()
            .filter(|sequence| {
                assign_registers_sequenced(nodes, &order, params, sequence) == *expected
            })
...
fn register_fitter() {
    ...
    for r0_rule in [
        R0Rule::FinalOfLastChain,
        R0Rule::FinalPlusTwoOpChain,
        R0Rule::WholeLastChain,
    ] {
        for reuse in [
            ReuseRule::LowestFree,
            ReuseRule::LowestFreeStable,
            ReuseRule::OwnSourceFirst,
        ] {
    ...
    for (name, nodes, params, expected) in &round3 {
        ...
        if got != *expected {
            println!(
                "  r3 FAIL {name}: order {order_labels:?}\n     got {got:?}\n    want {expected:?}"
            );
        }
    }
    for (name, nodes, params, expected) in &round2 {
        ...
        if got != *expected {
            println!(
                "  r2 FAIL {name}: order {order_labels:?}\n     got {got:?}\n    want {expected:?}"
            );
        }
    }
    for (name, nodes, params, expected) in &shapes {
                ...
                for weight_before_kind in [true, false] {
                    for kind_rank in [
                        ...
                        for strategy in [
                            Strategy::GlobalKey,
                            Strategy::ChainRobin {
                                lead: LeadRule::Heaviest,
                                offer_non_load_first: false,
                            },
                            Strategy::ChainRobin {
                                lead: LeadRule::Heaviest,
                                offer_non_load_first: true,
                            },
                            Strategy::ChainRobin {
                                lead: LeadRule::LoadFreeFirst,
                                offer_non_load_first: false,
                            },
                            Strategy::ChainRobin {
                                lead: LeadRule::LoadFreeFirst,
...
fn mult_vs_shift_starts_the_mulli_chain() {
    ...
    let nodes = [
        DagNode::new("addi_g", ALU).reads(&[1]).writes(&[10]),
        DagNode::new("slwi_g", ALU).reads(&[10]).writes(&[11]),
        DagNode::new("stw_g", STORE)
            .kind(OpKind::Store)
            .reads(&[11]),
        DagNode::new("addi_h", ALU).reads(&[2]).writes(&[20]),
        DagNode::new("mulli_h", MUL).reads(&[20]).writes(&[21]),
        DagNode::new("stw_h", STORE)
            .kind(OpKind::Store)
            .reads(&[21]),
    ];
    assert_eq!(
        labels(&nodes),
        ["addi_h", "addi_g", "mulli_h", "slwi_g", "stw_g", "stw_h"]
    );
}
...
fn three_deep_vs_shallow_reorders_the_stores() {
    ...
    assert_eq!(
        labels(&nodes),
        ["addi_g", "addi_h", "slwi_g", "stw_h", "addi3_g", "stw_g"]
    );
}
...
fn load_vs_mult_prioritizes_the_deeper_alu_chain() {
    ...
    assert_eq!(
        labels(&nodes),
        ["addi_h", "lwz", "mulli_h", "addi5_g", "stw_g", "stw_h"]
    );
}
...
fn float_chains_load_both_constants_first() {
    ...
    let nodes = [
        ...
        DagNode::new("stfd_g", STORE)
            .kind(OpKind::Store)
            .reads(&[11]),
        DagNode::new("lfd_c2", LOAD).writes(&[20]),
        DagNode::new("fadd", FP).reads(&[2, 20]).writes(&[21]),
        DagNode::new("stfd_h", STORE)
            .kind(OpKind::Store)
            .reads(&[21]),
    ];
    assert_eq!(
        labels(&nodes),
        ["lfd_c1", "lfd_c2", "fmul", "fadd", "stfd_g", "stfd_h"]
    );
}
    ...
    pub const FIXTURES: &[Fixture] = &[
        Fixture {
            ...
            values: &[
                ...
                v(Mask, 2, 8, 4),
                v(Computed, 6, 7, 3),
                v(LoadSurviving, 4, 13, 5),
                v(LoadSurviving, 5, 14, 6),
            ],
        },
        Fixture {
            name: "V1b",
            values: &[
                ...
                v(Mask, 2, 8, 5),
                v(Computed, 6, 7, 4),
                v(LoadSurviving, 4, 15, 6),
                v(LoadDiscarded, 5, 10, 3),
                v(Shift, 8, 13, 4),
            ],
        },
        Fixture {
        ...
        Fixture {
            ...
            values: &[
                ...
                v(Mask, 2, 8, 4),
                v(Computed, 6, 7, 3),
                v(LoadSurviving, 4, 16, 5),
                v(LoadSurviving, 5, 17, 6),
                v(Shift, 8, 13, 3),
            ],
        },
        Fixture {
        ...
        Fixture {
            ...
            values: &[
                ...
                v(Mask, 2, 8, 4),
                v(Computed, 6, 7, 3),
                v(LoadDiscarded, 4, 9, 6),
                v(LoadDiscarded, 5, 10, 5),
            ],
        },
        Fixture {
            name: "D5",
            values: &[
                ...
                v(Mask, 2, 8, 4),
                v(Computed, 6, 7, 3),
                v(LoadSurviving, 4, 17, 5),
                v(LoadSurviving, 5, 12, 6),
                v(Shift, 8, 15, 3),
            ],
        },
        ...
        Fixture {
            ...
            values: &[
                ...
                v(Mask, 2, 8, 4),
                v(Computed, 6, 7, 3),
                v(LoadDiscarded, 4, 10, 6),
                v(LoadDiscarded, 5, 9, 5),
            ],
        },
        ...
        Fixture {
            ...
            values: &[
                ...
                v(Mask, 19, 20, 3),
                v(Computed, 5, 18, 4),
                v(LoadSurviving, 3, 27, 5),
                v(LoadSurviving, 4, 28, 6),
                v(Shift, 8, 26, 7),
            ],
        },
        ...
        Fixture {
            ...
            values: &[
                ...
                v(Mask, 69, 70, 3),
                v(Scrutinee, 5, 68, 7),
                v(LoadSurviving, 2, 77, 5),
                v(LoadSurviving, 3, 78, 6),
                v(ArmShift, 28, 42, 4),
                v(ArmShift, 53, 76, 4),
            ],
        },
...
fn int_allocator_deep_fit() {
    ...
    for permutation in &all {
        for &key in &KEYS {
            let score = FIXTURES
                .iter()
                .filter(|f| matches(f, permutation, key))
                .count();
            if score > best.0 {
...
fn legacy_allocator_reuses_forbidden_dying_input_in_return_mode() {
    ...
    let registers = assign_registers_legacy(&nodes, &[0, 1, 3, 2, 4], &[(1, 3), (2, 4)]);
