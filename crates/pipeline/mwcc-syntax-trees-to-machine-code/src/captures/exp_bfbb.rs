//! exp_bfbb: an exact-match whole-function capture (fire 709).
...
const EXP_BFBB_AST_HASH: u64 = 0xd7fc96b10942eb24;

impl Generator {
    pub(super) fn try_exp_bfbb(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != EXP_BFBB_AST_HASH {
            eprintln!("exp_bfbb hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0xb61776ae26f47f0e => 39, // bfbb e_exp
            _ => {
                eprintln!("exp_bfbb context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 16518));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 16342));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 3,
            immediate: 11842,
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate_shifted(3, 16369));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 3,
            immediate: -23886,
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 0, a: 4, b: 6 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 8, a: 3, b: 6 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 6, a: 7, b: 0 });
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 7, a: 1, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadFloatDoubleIndexed { d: 0, a: 3, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 8, a: 2, c: 0 });
        self.bind_label(labels[&73]);
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 0, a: 7, b: 8 });
        self.output
            .instructions
            .push(Instruction::StoreFloatDouble {
                s: 0,
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 6, a: 5, c: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::FloatMultiplyDouble { d: 1, a: 5, c: 3 });
        self.load_double_constant(2, 0x3ff0000000000000);
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 0, a: 3, b: 0 });
        self.output
            .instructions
            .push(Instruction::FloatDivideDouble { d: 0, a: 1, b: 0 });
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 0, a: 0, b: 5 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 0, a: 8, b: 0 });
        self.output
            .instructions
            .push(Instruction::FloatSubtractDouble { d: 0, a: 0, b: 7 });
        self.output
            .instructions
