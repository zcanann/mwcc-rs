...
impl Generator {
    pub(super) fn try_alm_dealloc_var(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            39, 58, 63, 70, 71, 92, 99, 102, 107, 112, 119, 122, 129, 140, 146, 150, 156, 161,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 8, b: 6 });
        self.output
            .instructions
            .push(Instruction::AndContiguousMask {
                a: 4,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 5, a: 4, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 8, a: 4, b: 0 });
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 9, a: 4, b: 0 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 5,
            a: 9,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 7, a: 8, b: 9 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 5,
            a: 7,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 8, b: 5 });
        self.output
            .instructions
            .push(Instruction::AndContiguousMask {
                a: 5,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 8, b: 5 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 5,
            a: 6,
            immediate: -4,
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 6, a: 7, b: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 5, b: 9 });
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 5, a: 4, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 7, a: 4, b: 0 });
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 9, a: 4, b: 0 });
        self.output.instructions.push(Instruction::LoadWord {
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 9, b: 10 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 7,
            a: 8,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 10, b: 6 });
        self.output
            .instructions
            .push(Instruction::AndContiguousMask {
                a: 5,
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 7, a: 9, b: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 5, a: 9, b: 7 });
        self.output.instructions.push(Instruction::RotateAndMask {
            a: 5,
            s: 5,
            shift: 0,
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 5, a: 9, b: 7 });
