...
impl Generator {
    pub(super) fn try_sca_sformatter(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            15, 21, 28, 29, 48, 68, 71, 86, 87, 98, 111, 114, 120, 123, 135, 138, 144, 147, 149,
            150, 163, 175, 188, 190, 192, 197, 198, 207, 211, 213, 215, 217, 219, 221, 222, 224,
            226, 228, 229, 242, 254, 267, 268, 278, 282, 284, 286, 288, 290, 292, 293, 295, 314,
            317, 320, 322, 323, 324, 326, 331, 336, 345, 348, 351, 366, 372, 375, 378, 393, 396,
            398, 401, 402, 423, 425, 435, 443, 453, 459, 468, 470, 473, 497, 508, 515, 517, 519,
            523, 526, 550, 561, 562, 572, 574, 584, 588, 590, 592, 594, 596, 599, 602, 614, 615,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(16, 6));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 0, a: 18, b: 17 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 0, a: 17, b: 0 });
        self.output
            .instructions
            .push(Instruction::RotateAndMaskRecord {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 17, b: 0 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(21, 0));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(17, 10));
        self.emit_branch_to(labels[&150]); // b
        self.bind_label(labels[&149]);
        self.output
            .instructions
            .push(Instruction::load_immediate(17, 0));
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromZeroExtended { d: 0, a: 22 });
        self.emit_branch_to(labels[&190]); // b
        self.bind_label(labels[&188]);
        self.output
            .instructions
            .push(Instruction::move_register(20, 24));
        self.output
            .instructions
            .push(Instruction::move_register(0, 22));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(17, 8));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(17, 16));
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFromZeroExtended { d: 22, a: 22 });
        ...
        self.output
            .instructions
            .push(Instruction::RoundToSingle { d: 0, b: 1 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::move_register(3, 21));
        self.output.instructions.push(Instruction::AddImmediate {
            d: 4,
            a: 1,
            immediate: 8,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 0, a: 17, b: 4 });
        self.output
            .instructions
            .push(Instruction::RotateAndMaskRecord {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 4, a: 17, b: 4 });
        self.output
            .instructions
