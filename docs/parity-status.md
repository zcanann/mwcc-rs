...
Latest targeted checkpoint: 2026-07-24 00:08 UTC at compiler commit `a00eda14`
...
Post-holdout compiler work through commit `a00eda14` has not been run over a
...
relocation-aware parity from 28/109 to 34/109 functions and from 996/15,340 to
1,588/15,340 reference code bytes. The paired gain was +6/-0 functions and +592
exact bytes: `ftCommon_ClampAirDrift`, `ftCommon_FallBasic`, and
`ftCommon_CalcHitlag`, `ftCommon_8007DB58`, `ftCommon_SetAccessory`, and
`ftCommon_8007FF74`. This is evidence of local forward movement, not a
