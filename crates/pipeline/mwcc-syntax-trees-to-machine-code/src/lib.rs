...
fn lower_function_body(
    ...
    generator.normalize_structured_shared_member_argument_copies(function);
    ...
    generator.schedule_later_fill_entry();
    ...
    generator.normalize_guarded_bitfield_storage_cache_timer();
    ...
    generator.schedule_guarded_indexed_member_setter();
    generator.schedule_wide_guarded_zero_member_reset(function);
