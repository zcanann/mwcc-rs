...
pub fn for_each_register(instruction: &mut Instruction, mut visit: impl FnMut(RegisterRole, Class, &mut u8)) {
    ...
    match instruction {
        ...
        Nor { a, s, b } | Nand { a, s, b } | Eqv { a, s, b } | AndComplement { a, s, b } | OrComplement { a, s, b } | Or { a, s, b } | And { a, s, b }
        ...
        | OrImmediate { a, s, .. } | OrImmediateShifted { a, s, .. } | ShiftLeftImmediate { a, s, .. } | ShiftRightAlgebraicImmediate { a, s, .. }
