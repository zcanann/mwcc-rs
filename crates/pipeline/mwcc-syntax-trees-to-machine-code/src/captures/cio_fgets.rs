...
impl Generator {
    pub(super) fn try_cio_fgets(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [14, 18, 25, 35, 43, 45, 52, 58, 66, 69, 81, 88, 95, 97, 103, 110, 114, 120, 125] {
        ...
        self.output.instructions.push(Instruction::AddImmediateCarryingRecord { d: 29, a: 4, immediate: -1 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 30, offset: 40 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 30, offset: 36 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 3, immediate: 1 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 30, offset: 36 });
        self.output.instructions.push(Instruction::LoadByteZero { d: 3, a: 3, offset: 0 });
        self.emit_branch_to(labels[&103]); // b
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 4, a: 30, offset: 8 });
        ...
        self.output.instructions.push(Instruction::load_immediate(3, 1));
        self.output.instructions.push(Instruction::load_immediate(0, 0));
        self.output.instructions.push(Instruction::StoreByte { s: 3, a: 30, offset: 10 });
        self.output.instructions.push(Instruction::load_immediate(3, -1));
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 30, offset: 40 });
        self.emit_branch_to(labels[&103]); // b
        self.bind_label(labels[&58]);
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 3, immediate: 3 });
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 4, a: 30, offset: 8 });
        self.emit_branch_conditional_to(4, 2, labels[&66]); // bne
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 30, offset: 48 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 30, offset: 40 });
        self.bind_label(labels[&66]);
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 3, immediate: 12 });
        self.output.instructions.push(Instruction::LoadByteZeroIndexed { d: 3, a: 30, b: 0 });
        self.emit_branch_to(labels[&103]); // b
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 30, offset: 40 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 3, a: 30, offset: 8 });
        self.output.instructions.push(Instruction::load_immediate(4, 0));
        ...
        self.output.instructions.push(Instruction::StoreByte { s: 3, a: 30, offset: 8 });
        self.output.instructions.push(Instruction::StoreByte { s: 0, a: 30, offset: 9 });
        ...
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 30, offset: 9 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 0, immediate: 0 });
        self.emit_branch_conditional_to(12, 2, labels[&110]); // beq
        self.output.instructions.push(Instruction::CompareLogicalWord { a: 31, b: 28 });
        ...
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 3, immediate: 10 });
        ...
        self.emit_branch_conditional_to(12, 2, labels[&120]); // beq
        self.output.instructions.push(Instruction::AddImmediateCarryingRecord { d: 29, a: 29, immediate: -1 });
