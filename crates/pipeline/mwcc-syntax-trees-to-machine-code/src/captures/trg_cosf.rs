...
impl Generator {
    pub(super) fn try_trg_cosf(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::LoadFloatSingleIndexed { d: 1, a: 4, b: 0 });
        self.output.instructions.push(Instruction::LoadFloatSingle { d: 0, a: 3, offset: 4 });
        self.output.instructions.push(Instruction::FloatNegativeMultiplySubtractSingle { d: 1, a: 31, c: 1, b: 0 });
        ...
        self.output.instructions.push(Instruction::FloatNegativeMultiplyAddSingle { d: 1, a: 5, c: 2, b: 1 });
