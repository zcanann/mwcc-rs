...
impl Generator {
    pub(super) fn try_sld_strtold(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [
            54, 66, 72, 81, 87, 102, 113, 124, 126, 138, 146, 158, 160, 171, 173, 191, 193, 202,
            203, 212, 220, 222, 230, 237, 243, 244, 253, 257, 267, 269, 280, 291, 293, 301, 313,
            315, 326, 328, 336, 343, 351, 357, 362, 365, 373, 378, 379, 385, 394, 399, 401, 408,
            414, 417, 431, 439, 442,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(24, 7));
        ...
        self.output
            .instructions
            .push(Instruction::move_register(19, 6));
        self.output.instructions.push(Instruction::LoadWord {
            d: 17,
            a: 4,
            offset: 4,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 4, b: 25 });
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 4096));
        self.emit_branch_to(labels[&351]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 2048));
        self.emit_branch_to(labels[&351]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(21, 1));
        self.output
            .instructions
            .push(Instruction::move_register(4, 3));
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 512));
        self.output
            .instructions
            .push(Instruction::load_immediate(4, 0));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(31, 1024));
        self.emit_branch_to(labels[&351]); // b
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 27, a: 4, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 27,
            a: 27,
            immediate: -48,
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 30, b: 22 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 30, b: 23 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 0,
            a: 3,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::Negate { d: 27, a: 27 });
