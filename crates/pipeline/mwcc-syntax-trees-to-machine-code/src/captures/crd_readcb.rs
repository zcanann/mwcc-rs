...
impl Generator {
    pub(super) fn try_crd_readcb(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::MultiplyImmediate { d: 4, a: 28, immediate: 272 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 30, a: 31, offset: 192 });
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 30, offset: 12 });
        ...
        self.output.instructions.push(Instruction::load_immediate(29, -14));
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 6, a: 30, offset: 8 });
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 5, immediate: -1 });
        self.output.instructions.push(Instruction::Nor { a: 3, s: 0, b: 0 });
        self.output.instructions.push(Instruction::Add { d: 0, a: 6, b: 5 });
        self.output.instructions.push(Instruction::And { a: 0, s: 3, b: 0 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 27, a: 6, b: 0 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 0, a: 27, b: 4 });
        ...
        self.output.instructions.push(Instruction::Add { d: 0, a: 0, b: 27 });
        ...
        self.output.instructions.push(Instruction::LoadHalfwordZero { d: 3, a: 30, offset: 16 });
        self.output.instructions.push(Instruction::CompareLogicalWordImmediate { a: 3, immediate: 5 });
        ...
        self.output.instructions.push(Instruction::load_immediate(29, -6));
        self.emit_branch_to(labels[&61]); // b
        ...
        self.output.instructions.push(Instruction::MultiplyLow { d: 4, a: 4, b: 3 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 7, a: 7, immediate: 0 });
        self.record_relocation(RelocationKind::Rel24, "__CARDRead");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__CARDRead".to_string() });
