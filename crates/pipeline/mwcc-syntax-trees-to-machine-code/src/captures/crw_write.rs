...
impl Generator {
    pub(super) fn try_crw_write(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.frame_size = 16;
        self.non_leaf = true;
        self.output.symbol_order = ["__CARDBlock", "BlockWriteCallback", "__CARDWritePage"].into_iter().map(String::from).collect();
        ...
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 0, s: 5, shift: 7 });
