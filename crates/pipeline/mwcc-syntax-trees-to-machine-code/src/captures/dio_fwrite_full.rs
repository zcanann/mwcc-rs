...
const DIO_FWRITE_FULL_AST_HASHES: &[u64] = &[DIO_FWRITE_FULL_AST_HASH, 0x83f6751c616a3fda, 0x34b44595e8dd2168];
...
impl Generator {
    pub(super) fn try_dio_fwrite_full(&mut self, function: &Function) -> Compilation<bool> {
        ...
        for target in [17, 25, 27, 30, 43, 44, 51, 62, 72, 82, 86, 91, 108, 117, 122, 133, 137, 156, 164, 170, 173] {
        ...
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 0, s: 4, shift: 27, begin: 29, end: 31 });
        self.emit_branch_conditional_to(4, 2, labels[&62]); // bne
        self.output.instructions.push(Instruction::LoadByteZero { d: 0, a: 27, offset: 4 });
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 0, s: 0, shift: 29, begin: 30, end: 30 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 4, a: 27, offset: 32 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 27, offset: 24 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 27, offset: 28 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 27, offset: 32 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 27, offset: 32 });
        ...
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 32 });
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 1, offset: 8 });
        self.output.instructions.push(Instruction::LoadWord { d: 0, a: 27, offset: 36 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 0, a: 3, b: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 36 });
        self.bind_label(labels[&108]);
        self.output.instructions.push(Instruction::LoadWord { d: 3, a: 27, offset: 36 });
        ...
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 3 });
        self.emit_branch_conditional_to(4, 2, labels[&117]); // bne
        self.output.instructions.push(Instruction::Add { d: 28, a: 28, b: 29 });
        ...
        self.output.instructions.push(Instruction::LoadWord { d: 31, a: 27, offset: 24 });
        self.output.instructions.push(Instruction::Add { d: 0, a: 30, b: 29 });
        self.output.instructions.push(Instruction::LoadWord { d: 25, a: 27, offset: 28 });
        self.output.instructions.push(Instruction::move_register(3, 27));
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 1, immediate: 8 });
        self.output.instructions.push(Instruction::StoreWord { s: 30, a: 27, offset: 24 });
        self.output.instructions.push(Instruction::StoreWord { s: 29, a: 27, offset: 28 });
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 32 });
        self.record_relocation(RelocationKind::Rel24, "__flush_buffer");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__flush_buffer".to_string() });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 3, immediate: 0 });
        ...
        self.output.instructions.push(Instruction::move_register(3, 27));
        self.output.instructions.push(Instruction::StoreWord { s: 31, a: 27, offset: 24 });
        self.output.instructions.push(Instruction::Add { d: 28, a: 28, b: 0 });
        self.output.instructions.push(Instruction::StoreWord { s: 25, a: 27, offset: 28 });
        self.record_relocation(RelocationKind::Rel24, "__prep_buffer");
        self.output.instructions.push(Instruction::BranchAndLink { target: "__prep_buffer".to_string() });
        self.output.instructions.push(Instruction::load_immediate(0, 0));
        self.output.instructions.push(Instruction::StoreWord { s: 0, a: 27, offset: 36 });
        ...
        self.output.instructions.push(Instruction::AddImmediate { d: 0, a: 26, immediate: -1 });
        self.output.instructions.push(Instruction::Add { d: 0, a: 28, b: 0 });
        self.output.instructions.push(Instruction::DivideWordUnsigned { d: 3, a: 0, b: 26 });
