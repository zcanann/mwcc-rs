//! str_strstr_ac: an exact-match whole-function capture (fire 472).
...
const STR_STRSTR_AC_AST_HASH: u64 = 0xcc40ac208accf379;

impl Generator {
    pub(super) fn try_str_strstr_ac(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != STR_STRSTR_AC_AST_HASH {
            return Ok(false);
        }
