...
void volatile_intrinsic(GXIndTexStageID ind_state, GXIndTexScale scale_s, GXIndTexScale scale_t)
{
...
void volatile_c(GXIndTexStageID ind_state, GXIndTexScale scale_s, GXIndTexScale scale_t)
{
    CHECK_GXBEGIN(249, "GXSetIndTexScale");
