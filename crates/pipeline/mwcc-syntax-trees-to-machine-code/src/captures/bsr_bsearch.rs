...
impl Generator {
    pub(super) fn try_bsr_bsearch(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output.instructions.push(Instruction::BranchAndLink {
            target: "_savegpr_24".to_string(),
        });
        self.output
            .instructions
            .push(Instruction::OrRecord { a: 24, s: 3, b: 3 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::move_register(12, 27));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 31, b: 30 });
        self.output
            .instructions
            .push(Instruction::move_register(12, 27));
        self.output
        ...
        self.output
            .instructions
            .push(Instruction::MultiplyLow { d: 0, a: 26, b: 29 });
        self.output
            .instructions
            .push(Instruction::Add { d: 28, a: 25, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 31, b: 30 });
