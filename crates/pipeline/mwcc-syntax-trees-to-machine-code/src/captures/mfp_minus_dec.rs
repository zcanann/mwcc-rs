//! mfp_minus_dec: an exact-match whole-function capture (fire 687).
...
const MFP_MINUS_DEC_AST_HASH: u64 = 0xd69a77c589d2a2f2;

impl Generator {
    pub(super) fn try_mfp_minus_dec(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MFP_MINUS_DEC_AST_HASH {
            eprintln!("mfp_minus_dec hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        let bump: u32 = match context {
            0x2f48e587b0c6ec95 => 0, // strikers ansi_fp (bump TBD)
            0x634c2c214dc5e7a9 => 0, // marioparty4 (bump TBD from refctx @N diff)
            _ => {
                eprintln!("mfp_minus_dec context candidate: {context:#x}");
                return Ok(false);
            }
        };
        ...
        for target in [
            31, 38, 40, 45, 55, 61, 67, 68, 77, 128, 129, 136, 140, 144, 154, 162, 167, 174, 181,
            182, 191, 242, 243, 250, 253, 255, 256, 274, 295, 296, 301, 304, 311, 315,
        ] {
        ...
        self.output
            .instructions
            .push(Instruction::move_register(8, 4));
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::move_register(8, 0));
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 8, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(8, 36));
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 7, a: 3, b: 4 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 4, b: 8 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 4, b: 8 });
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 7, b: 0 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 4, b: 7 });
        self.bind_label(labels[&55]);
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 7, a: 4, b: 6 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 9,
            a: 5,
            immediate: 5,
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 7, a: 0, b: 7 });
        self.output
            .instructions
            .push(Instruction::Add { d: 10, a: 9, b: 7 });
        self.output
            .instructions
            .push(Instruction::move_register(11, 10));
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 12, b: 6 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 8, a: 12, b: 6 });
        ...
        self.output
            .instructions
            .push(Instruction::MoveToCountRegister { s: 7 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 7, a: 8, b: 7 });
        self.output.instructions.push(Instruction::StoreByte {
            s: 7,
            a: 6,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 10, b: 9 });
        ...
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 9, a: 9, b: 11 });
        self.output
            .instructions
            .push(Instruction::CompareWord { a: 9, b: 8 });
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWordImmediate { a: 7, immediate: 5 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 7, a: 5, b: 7 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 5, a: 6, b: 7 });
        self.output
            .instructions
            .push(Instruction::MoveToCountRegister { s: 5 });
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 6, b: 7 });
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 9, b: 0 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 6,
            a: 5,
            immediate: -1,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 4, b: 6 });
        self.output.instructions.push(Instruction::LoadByteZero {
            d: 0,
            a: 6,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 4, b: 0 });
        self.output
            .instructions
            .push(Instruction::SubtractFrom { d: 0, a: 4, b: 5 });
        self.output
            .instructions
            .push(Instruction::MoveToCountRegister { s: 0 });
        self.output
