...
impl Generator {
    pub(super) fn try_alm_merge_next(&mut self, function: &Function) -> Compilation<bool> {
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 8, a: 3, b: 7 });
        self.output.instructions.push(Instruction::LoadWord {
            d: 6,
            a: 8,
            offset: 0,
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 6, a: 7, b: 5 });
        self.output
            .instructions
            .push(Instruction::AndContiguousMask {
                a: 0,
        ...
        self.output
            .instructions
            .push(Instruction::LoadWordIndexed { d: 0, a: 3, b: 6 });
        ...
        self.output
            .instructions
            .push(Instruction::StoreWordIndexed { s: 0, a: 3, b: 6 });
