//! p2_esqrt: an exact-match whole-function capture (fire 459).
...
const P2_ESQRT_AST_HASH: u64 = 0x137bd7fe99bade20;

impl Generator {
    pub(super) fn try_p2_esqrt(&mut self, function: &Function) -> Compilation<bool> {
        ...
        let bump: u32 = match context {
            0xb61776ae26f47f0e => 61, // bf_esqrt post-fold (f524)
            0xb4626ed660a00a79 => 61, // pikmin2 (measured)
            _ => return Ok(false),
        };
        ...
        for target in [12, 18, 25, 28, 32, 36, 38, 46, 55, 65, 71, 76, 80, 87, 95, 99, 101, 106, 119, 121, 128, 135] {
        ...
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 3, a: 3, immediate: -32752 });
        ...
        self.output.instructions.push(Instruction::FloatMultiplyAddDouble { d: 1, a: 1, c: 1, b: 1 });
        ...
        self.output.instructions.push(Instruction::OrRecord { a: 3, s: 0, b: 3 });
        ...
        self.output.instructions.push(Instruction::ShiftRightAlgebraicImmediateRecord { a: 3, s: 6, shift: 20 });
        self.emit_branch_conditional_to(4, 2, labels[&46]); // bne
        self.emit_branch_to(labels[&32]); // b
        self.bind_label(labels[&28]);
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 4, s: 0, shift: 11 });
        self.output.instructions.push(Instruction::ShiftLeftImmediate { a: 0, s: 0, shift: 21 });
        self.output.instructions.push(Instruction::Or { a: 6, s: 6, b: 4 });
        self.output.instructions.push(Instruction::AddImmediate { d: 3, a: 3, immediate: -21 });
        ...
        self.output.instructions.push(Instruction::RotateAndMaskRecord { a: 4, s: 6, shift: 0, begin: 11, end: 11 });
        self.emit_branch_conditional_to(12, 2, labels[&36]); // beq
        self.output.instructions.push(Instruction::SubtractFromImmediate { d: 4, a: 7, immediate: 32 });
        self.output.instructions.push(Instruction::AddImmediate { d: 5, a: 7, immediate: -1 });
        self.output.instructions.push(Instruction::ShiftRightWord { a: 4, s: 0, b: 4 });
        self.output.instructions.push(Instruction::ShiftLeftWord { a: 0, s: 0, b: 7 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 3, a: 5, b: 3 });
        self.output.instructions.push(Instruction::Or { a: 6, s: 6, b: 4 });
        self.bind_label(labels[&46]);
        self.output.instructions.push(Instruction::AddImmediate { d: 4, a: 3, immediate: -1023 });
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 5, s: 6, clear: 12 });
        self.output.instructions.push(Instruction::ClearLeftImmediateRecord { a: 4, s: 4, clear: 31 });
        self.output.instructions.push(Instruction::OrImmediateShifted { a: 5, s: 5, immediate: 16 });
        self.emit_branch_conditional_to(12, 2, labels[&55]); // beq
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 4, s: 0, shift: 31 });
        self.output.instructions.push(Instruction::Add { d: 0, a: 0, b: 0 });
        self.output.instructions.push(Instruction::Add { d: 4, a: 4, b: 5 });
        self.output.instructions.push(Instruction::Add { d: 5, a: 5, b: 4 });
        ...
        self.output.instructions.push(Instruction::load_immediate_shifted(6, 32));
        self.emit_branch_to(labels[&76]); // b
        self.bind_label(labels[&65]);
        self.output.instructions.push(Instruction::Add { d: 4, a: 11, b: 6 });
        self.output.instructions.push(Instruction::CompareWord { a: 4, b: 5 });
        self.emit_branch_conditional_to(12, 1, labels[&71]); // bgt
        self.output.instructions.push(Instruction::Add { d: 11, a: 4, b: 6 });
        self.output.instructions.push(Instruction::SubtractFrom { d: 5, a: 4, b: 5 });
        self.output.instructions.push(Instruction::Add { d: 12, a: 12, b: 6 });
        self.bind_label(labels[&71]);
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 4, s: 0, shift: 31 });
        self.output.instructions.push(Instruction::Add { d: 0, a: 0, b: 0 });
        self.output.instructions.push(Instruction::Add { d: 4, a: 4, b: 5 });
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 6, s: 6, shift: 1 });
        self.output.instructions.push(Instruction::Add { d: 5, a: 5, b: 4 });
        ...
        self.output.instructions.push(Instruction::CompareWord { a: 11, b: 5 });
        self.output.instructions.push(Instruction::move_register(7, 11));
        self.output.instructions.push(Instruction::Add { d: 8, a: 9, b: 6 });
        ...
        self.output.instructions.push(Instruction::AndContiguousMask { a: 4, s: 8, begin: 0, end: 0 });
        self.output.instructions.push(Instruction::Add { d: 9, a: 8, b: 6 });
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 4, a: 4, immediate: -32768 });
        ...
        self.output.instructions.push(Instruction::AndMaskRecord { a: 4, s: 9, begin: 0, end: 0 });
        self.emit_branch_conditional_to(4, 2, labels[&95]); // bne
        ...
        self.output.instructions.push(Instruction::Add { d: 10, a: 10, b: 6 });
        ...
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 0, a: 10, immediate: 1 });
        ...
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 10, clear: 31 });
        self.output.instructions.push(Instruction::Add { d: 10, a: 10, b: 0 });
        self.bind_label(labels[&121]);
        self.output.instructions.push(Instruction::ClearLeftImmediate { a: 0, s: 12, clear: 31 });
        self.output.instructions.push(Instruction::ShiftRightAlgebraicImmediate { a: 4, s: 12, shift: 1 });
        self.output.instructions.push(Instruction::CompareWordImmediate { a: 0, immediate: 1 });
        self.output.instructions.push(Instruction::ShiftRightLogicalImmediate { a: 5, s: 10, shift: 1 });
        self.output.instructions.push(Instruction::AddImmediateShifted { d: 4, a: 4, immediate: 16352 });
        self.emit_branch_conditional_to(4, 2, labels[&128]); // bne
        self.output.instructions.push(Instruction::OrImmediateShifted { a: 5, s: 5, immediate: 32768 });
