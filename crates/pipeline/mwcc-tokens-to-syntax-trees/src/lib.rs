...
pub fn parse_located_translation_unit_with_behavior(
    ...
    let mut parser = Parser {
        ...
        cxx_classes: std::sync::Arc::new(HashMap::new()),
        ...
        cxx_static_methods: std::sync::Arc::new(HashMap::new()),
        cxx_class_deletes: HashMap::new(),
        cxx_declared_function_names: std::collections::HashSet::new(),
        cxx_constructors: std::sync::Arc::new(HashMap::new()),
        cxx_free_functions: std::sync::Arc::new(HashMap::new()),
        cxx_instance_methods: std::sync::Arc::new(HashMap::new()),
...
blr\n\
    ...
    fn constructor_materializes_an_inline_virtual_destructor_and_weak_vtable() {
        ...
        materialize_cxx_rtti(&mut unit, false);
        assert!(unit
            .globals
            .iter()
            .find(|global| global.name == "__vt__7Derived")
