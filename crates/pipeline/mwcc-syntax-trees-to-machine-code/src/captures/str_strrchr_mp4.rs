//! str_strrchr_mp4: an exact-match whole-function capture (fire 473).
...
const STR_STRRCHR_MP4_AST_HASH: u64 = 0x3a078d2ea295abb3;

impl Generator {
    pub(super) fn try_str_strrchr_mp4(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != STR_STRRCHR_MP4_AST_HASH {
            return Ok(false);
        }
