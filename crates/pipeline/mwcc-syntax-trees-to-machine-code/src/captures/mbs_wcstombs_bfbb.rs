//! mbs_wcstombs_bfbb: an exact-match whole-function capture (fire 516).
...
impl Generator {
    pub(super) fn try_mbs_wcstombs_bfbb(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MBS_WCSTOMBS_BFBB_AST_HASH {
            eprintln!("mbs_wcstombs_bfbb hash candidate: {hash:#x}");
            return Ok(false);
        }
        ...
        self.output
            .instructions
            .push(Instruction::StoreByteIndexed { s: 0, a: 28, b: 31 });
        self.emit_branch_to(labels[&66]); // b
        ...
        self.output
            .instructions
            .push(Instruction::load_immediate(27, 3));
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 5, a: 5, b: 27 });
        ...
        self.output
            .instructions
            .push(Instruction::LoadByteZeroIndexed { d: 0, a: 4, b: 27 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 0, a: 31, b: 27 });
        self.output
            .instructions
        ...
        self.output
            .instructions
            .push(Instruction::Add { d: 3, a: 28, b: 31 });
        self.output.instructions.push(Instruction::AddImmediate {
            d: 4,
            a: 1,
            immediate: 12,
        ...
        self.output
            .instructions
            .push(Instruction::CompareLogicalWord { a: 31, b: 29 });
        self.output
            .instructions
