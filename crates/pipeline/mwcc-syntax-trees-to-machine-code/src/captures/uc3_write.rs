...
const UC3_WRITE_AST_HASH: u64 = 1; // DISARMED f494: TU incomplete — needs the MATERIALIZED __init_uart_console (prototype-then-call shape); real hash 0x461381432294b28b
