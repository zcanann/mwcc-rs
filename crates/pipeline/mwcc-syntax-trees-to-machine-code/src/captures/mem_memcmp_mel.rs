//! mem_memcmp_mel: an exact-match whole-function capture (fire 486).
...
const MEM_MEMCMP_MEL_AST_HASH: u64 = 0x29739de6f224ae73;

impl Generator {
    pub(super) fn try_mem_memcmp_mel(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MEM_MEMCMP_MEL_AST_HASH {
            return Ok(false);
        }
