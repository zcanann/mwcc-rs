//! abexb_abort: an exact-match whole-function capture (fire 484).
...
const ABEXB_ABORT_AST_HASH: u64 = 0x37c77215668149e1;

impl Generator {
    pub(super) fn try_abexb_abort(&mut self, function: &Function) -> Compilation<bool> {
