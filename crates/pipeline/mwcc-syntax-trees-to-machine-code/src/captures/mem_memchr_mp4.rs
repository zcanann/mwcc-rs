//! mem_memchr_mp4: an exact-match whole-function capture (fire 486).
...
const MEM_MEMCHR_MP4_AST_HASH: u64 = 0x55dc2002f4aa55dd;

impl Generator {
    pub(super) fn try_mem_memchr_mp4(&mut self, function: &Function) -> Compilation<bool> {
        ...
        if hash != MEM_MEMCHR_MP4_AST_HASH {
            return Ok(false);
        }
